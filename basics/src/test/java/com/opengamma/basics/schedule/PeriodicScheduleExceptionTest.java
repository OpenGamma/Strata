...
/**
 * Test {@link PeriodicScheduleException}.
 */
@Test
public class PeriodicScheduleExceptionTest {
  ...
  public void test_of_ints() {
    ...
    PeriodicScheduleException test = new PeriodicScheduleException(defn , "Hello {}", "World");
