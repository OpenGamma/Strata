...
public final class ValueStep
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(getPeriodIndex(), other.getPeriodIndex()) &&
  ...
  public int hashCode() {
    ...
    hash += hash * 31 + JodaBeanUtils.hashCode(getPeriodIndex());
  ...
  public String toString() {
    ...
    buf.append("periodIndex").append('=').append(getPeriodIndex()).append(',').append(' ');
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -980601967:  // periodIndex
          return ((ValueStep) bean).getPeriodIndex();
        case 3076014:  // date
          return ((ValueStep) bean).getDate();
        case 111972721:  // value
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<ValueStep> {
    ...
    private Builder(ValueStep beanToCopy) {
      this.periodIndex = beanToCopy.getPeriodIndex();
