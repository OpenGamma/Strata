...
public class DeliverableSwapFutureFnTest {
  ...
  SecurityMaster _securityMaster = new InMemorySecurityMaster();
  
  private static final ZonedDateTime VALUATION_TIME = DateUtils.getUTCDate(2014, 1, 22);
  
  private static final Environment ENV = new SimpleEnvironment(VALUATION_TIME, _interestRateMockSources.createMarketDataSource(LocalDate.of(2014, 2, 18)));
    ...
    FunctionModelConfig config =
        config(
            ...
            implementations(DeliverableSwapFutureFn.class, DefaultDeliverableSwapFutureFn.class,
                            DeliverableSwapFutureCalculatorFactory.class, DeliverableSwapFutureDiscountingCalculatorFactory.class,
  ...
  private InterestRateSwapSecurity createUnderlyingSwap() {
    ...
    PayReceiveType floatPayersOrRec = fixedLeg.getPayReceiveType() == PayReceiveType.PAY ? PayReceiveType.RECEIVE : PayReceiveType.PAY;       
    ...
    InterestRateSwapSecurity irs = new InterestRateSwapSecurity(externalSwapBundleId, swapId, LocalDate.of(2014, 6, 18), LocalDate.of(2016, 6, 18), legs);        
                    
    SecurityMasterUtils.addOrUpdateSecurity(_securityMaster, irs);        
    return irs;
  }
  ...
  private DeliverableSwapFutureTrade createDeliverableSwapFutureTrade() {
    ...
    Expiry expiry = new Expiry(ZonedDateTime.of(LocalDateTime.of(LocalDate.of(2014, 6, 15), LocalTime.of(0, 0)), ZoneId.systemDefault()));
    ...
    DeliverableSwapFutureSecurity dsf = new DeliverableSwapFutureSecurity(expiry, 
                                                                          ...
                                                                          1000,
                                                                          "DSF", 
                                                                          _underlyingSwap.getExternalIdBundle().getExternalIds().first(), 
                                                                          1);
    ...
    SecurityMasterUtils.addOrUpdateSecurity(_securityMaster, dsf);  
  ...
  private HistoricalTimeSeriesSource mockHistoricalTimeSeriesSource() {
    ...
    HistoricalTimeSeries deliverableSwapFuturePrices = new SimpleHistoricalTimeSeries(UniqueId.of("Blah", "1"), ImmutableLocalDateDoubleTimeSeries.of(VALUATION_TIME.toLocalDate(), 0.975));
  ...
  public void testBucketedZeroDelta() {
    Result<BucketedCurveSensitivities> bucketedZeroDelta = _deliverableSwapFutureFn.calculateBucketedZeroIRDelta(ENV, _deliverableSwapFutureTrade);    
