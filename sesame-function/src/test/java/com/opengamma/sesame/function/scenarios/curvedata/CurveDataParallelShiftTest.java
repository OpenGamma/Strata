...
public class CurveDataParallelShiftTest {
  ...
  public void absolute() {
    CurveDataParallelShift shift = CurveDataParallelShift.absolute(0.1, CurveSpecificationMatcher.named(CurveTestUtils.CURVE_NAME));
  ...
  public void relative() {
    CurveDataParallelShift shift = CurveDataParallelShift.relative(0.1, CurveSpecificationMatcher.named(CurveTestUtils.CURVE_NAME));
    Map<ExternalIdBundle, Double> shiftedValues = shift.apply(CurveTestUtils.CURVE_SPEC, CurveTestUtils.VALUE_MAP);
