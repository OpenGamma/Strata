...
public class BondFutureFnTest {
  ...
  private static final Environment ENV = new SimpleEnvironment(VALUATION_TIME, BondMockSources.createMarketDataSource());
  
  private BondFutureFn _bondFutureFn;
  
  private BondSecurity _bond = BondMockSources.createBondSecurity();
  
  private BondFutureTrade _bondFuture = BondMockSources.createBondFutureTrade();
  ...
  public void setUp() {
    FunctionModelConfig config = config(
      ...
      implementations(BondFutureFn.class, DefaultBondFutureFn.class,
    ...
    _bondFutureFn = FunctionModel.build(BondFutureFn.class, config, ComponentMap.of(components));
  }
  ...
  public void testPresentValue() {
    Result<MultipleCurrencyAmount> pvComputed = _bondFutureFn.calculatePV(ENV, _bondFuture);
