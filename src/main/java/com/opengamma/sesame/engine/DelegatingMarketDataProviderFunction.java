 ...
 */
/* package */ class DelegatingMarketDataProviderFunction implements MarketDataProviderFunction {

  private MarketDataProviderFunction _delegate;
   ...
   */
  /* package */ void setDelegate(MarketDataProviderFunction delegate) {
