...
public final class CycleArguments {
  ...
  public CycleArguments(ZonedDateTime valuationTime, MarketDataFactory marketDataFactory) {
    this(valuationTime, marketDataFactory, Collections.<Pair<Integer, Integer>>emptySet());
  }
