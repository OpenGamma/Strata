...
public final class Results {
  ...
  /* package */ static Builder builder(List<?> inputs, List<String> columnNames) {
    return new Builder(inputs, columnNames);
  }
  ...
  public static final class Row {
    ...
    private Row(Object input, List<Item> items) {
      _input = input;
      _items = items;
    }
  ...
  public final static class Item {
    ...
    public Item(Object output, CallGraph callGraph) {
      _output = output;
  ...
  /* package */ static final class Builder {
    ...
    public Builder(List<?> inputs, List<String> columnNames) {
      _inputs = inputs;
      _columnNames = columnNames;
    }

    /* package */ void add(int rowIndex, int columnIndex, Object result, CallGraph callGraph) {
      _table.put(rowIndex, columnIndex, new Item(result, callGraph));
    }
    ...
    /* package */ Results build() {
      ...
      for (Map<Integer, Item> row : rowMap.values()) {
        rows.add(new Row(_inputs.get(index++), Lists.newArrayList(row.values())));
      }
