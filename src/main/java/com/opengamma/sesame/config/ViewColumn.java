...
public final class ViewColumn implements ImmutableBean {
  ...
  // TODO default value requirement name for types that don't specify one?

  @PropertyDefinition(validate = "notEmpty")
  private final String _name;

  @PropertyDefinition(validate = "notNull")
  private final ImmutableMap<Class<?>, ColumnRequirement> _requirements;
  ...
  private ViewColumn(
      String name,
      Map<Class<?>, ColumnRequirement> requirements) {
   ...
   */
  public ImmutableMap<Class<?>, ColumnRequirement> getRequirements() {
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableMap<Class<?>, ColumnRequirement>> _requirements = DirectMetaProperty.ofImmutable(
        this, "requirements", ViewColumn.class, (Class) ImmutableMap.class);
    /**
     * The meta-properties.
     */
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<ImmutableMap<Class<?>, ColumnRequirement>> requirements() {
      return _requirements;
    }
  ...
  public static final class Builder extends BasicImmutableBeanBuilder<ViewColumn> {
    ...
    private Map<Class<?>, ColumnRequirement> _requirements = new HashMap<Class<?>, ColumnRequirement>();
    ...
    private Builder(ViewColumn beanToCopy) {
      ...
      this._requirements = new HashMap<Class<?>, ColumnRequirement>(beanToCopy.getRequirements());
    }
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case 3373707:  // name
          ...
          break;
        case -1619874672:  // requirements
          this._requirements = (Map<Class<?>, ColumnRequirement>) newValue;
          break;
        default:
     ...
     * @return this, for chaining, not null
     */
    public Builder requirements(Map<Class<?>, ColumnRequirement> requirements) {
      JodaBeanUtils.notNull(requirements, "requirements");
