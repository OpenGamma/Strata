...
/**
 * An extension to LiveDataResultMapper adding in methods
 ...
 */
public interface MutableLiveDataResultMapper extends LiveDataResultMapper {
  ...
  /**
   * Create an immutable version of this LiveDataResultMapper, containing
   * only the results for the supplied set of tickers.
   *
   * @param tickers  the set of tickers to be included in the snapshot, not null
   * @return an ImmutableLiveDataResultMapper containing the results for
   * the requested set of tickers, not null
   */
  ImmutableLiveDataResultMapper createSnapshot(Set<ExternalIdBundle> tickers);

  /**
   * Create an immutable version of this LiveDataResultMapper, containing
   * all the results.
   *
   * @return an ImmutableLiveDataResultMapper containing all the results
   * from this LiveDataResultMapper, not null
   */
  ImmutableLiveDataResultMapper createSnapshot();
   ...
   */
  void addMissing(ExternalIdBundle ticker, String userMessage, Object... args);
   ...
   * calls to {@link #containsKey(ExternalIdBundle)} with the same
   * ticker will return true.
   *
   * @param ticker  the ticker to mark as pending, not null
   */
  void addPending(ExternalIdBundle ticker);
    ...
    */
  void addPermissionDenied(ExternalIdBundle ticker, String userMessage, Object... args);
}
