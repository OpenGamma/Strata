...
public final class SimpleFunctionArguments implements FunctionArguments, ImmutableBean {
  ...
  public SimpleFunctionArguments mergeWith(SimpleFunctionArguments other) {
    Set<String> propertyNames = Sets.union(_arguments.keySet(), other._arguments.keySet());
    Map<String, Object> args = new HashMap<>();

    for (String propertyName : propertyNames) {
      Object thisArg = _arguments.get(propertyName);
      Object otherArg = other._arguments.get(propertyName);

      if (thisArg != null) {
        args.put(propertyName, thisArg);
      } else {
        args.put(propertyName, otherArg);
      }
    }
    return new SimpleFunctionArguments(args);
  }
