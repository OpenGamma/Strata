...
public final class SimpleFunctionModelConfig implements FunctionModelConfig, ImmutableBean {
  ...
  // private as clients should be calling getFunctionImplementation, only
  // required for the Joda beans internals
  private ImmutableMap<Class<?>, Class<?>> getImplementationOverrides() {
    return _implementationOverrides;
  }

  // private as clients should be calling getFunctionArguments, only
  // required for the Joda beans internals
  ...
  private SimpleFunctionModelConfig(
    ...
    this._implementationOverrides = ImmutableMap.copyOf(implementationOverrides);
