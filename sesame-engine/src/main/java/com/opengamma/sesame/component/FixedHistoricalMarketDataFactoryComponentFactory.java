...
public class FixedHistoricalMarketDataFactoryComponentFactory extends AbstractComponentFactory {
  ...
  public void init(ComponentRepository repo, LinkedHashMap<String, String> configuration) throws Exception {
    FixedHistoricalMarketDataFactory factory =
        new FixedHistoricalMarketDataFactory(_historicalTimeSeriesSource, _dataSource, _dataProvider);
    repo.registerComponent(FixedHistoricalMarketDataFactory.class, _classifier, factory);
  }
