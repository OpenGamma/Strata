  ...
  private static Trade createBasisLibor3mVsLibor6mWithSpreadSwap() {
    ...
    SwapLeg receiveLeg = RateCalculationSwapLeg.builder()
        ...
        .paymentSchedule(PaymentSchedule.builder()
            ...
            .build())
        .notionalSchedule(notional)
        .calculation(IborRateCalculation.builder().index(IborIndices.USD_LIBOR_3M).spread(ValueSchedule.of(0.001)).build())
        .build();
  ...
  private static Trade createXCcyGbpLibor3mVsUsdLibor3mSwap() {
    SwapLeg payLeg = RateCalculationSwapLeg.builder()
        ...
        .accrualSchedule(PeriodicSchedule.builder()
            ...
            .frequency(Frequency.P3M)
            .businessDayAdjustment(BusinessDayAdjustment.of(BusinessDayConventions.MODIFIED_FOLLOWING, HolidayCalendars.GBLO))
            .build())
        .paymentSchedule(PaymentSchedule.builder()
            .paymentFrequency(Frequency.P3M)
            .paymentOffset(DaysAdjustment.NONE)
