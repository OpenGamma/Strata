...
/**
 * Test for multi-currency curve calibration based on overnight-indexed swaps with 3 curves (1 in USD and 2 in EUR). 
 * <p>
 * The curves are
 *  - Discounting and SOFR forward in USD
 *  - Discounting in EUR
 *  - ESTR forward in EUR
 * <p>
 ...
 */
public class CalibrationXCcyOisCheckExample {

  /**
   * The valuation date.
   */
  private static final LocalDate VAL_DATE = LocalDate.of(2022, 5, 30);
  /**
   ...
   */
  private static final CurveGroupName CURVE_GROUP_NAME = CurveGroupName.of("USD-DSCSOFR-EUR-DSC-ESTR");
  /**
