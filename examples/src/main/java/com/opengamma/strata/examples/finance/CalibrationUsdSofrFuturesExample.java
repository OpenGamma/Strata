...
/**
 * Test for curve calibration with SOFR futures in USD.
 * <p>
 * Curve configuration and market data loaded from csv files.
 * Tests that the trades used for calibration have a PV of 0.
 */
public class CalibrationUsdSofrFuturesExample {

  /**
   * The valuation date.
   */
  private static final LocalDate VAL_DATE = LocalDate.of(2020, 9, 7);
   ...
   */
  private static final CurveGroupName CURVE_GROUP_NAME = CurveGroupName.of("USD-DSCSO");
  ...
  private static final ResourceLocator GROUPS_RESOURCE =
      ResourceLocator.ofFile(new File(PATH_CONFIG + "curves/USD-DSCSOFUT/USD-DSCSOFUT-group.csv"));
  /**
   * The location of the curve calibration settings file.
   */
  private static final ResourceLocator SETTINGS_RESOURCE =
      ResourceLocator.ofFile(new File(PATH_CONFIG + "curves/USD-DSCSOFUT/USD-DSCSOFUT-settings.csv"));
  /**
   * The location of the curve calibration nodes file.
   */
  private static final ResourceLocator CALIBRATION_RESOURCE =
      ResourceLocator.ofFile(new File(PATH_CONFIG + "curves/USD-DSCSOFUT/USD-DSCSOFUT-nodes.csv"));
  /**
   * The location of the market quotes file.
   */
  private static final ResourceLocator QUOTES_RESOURCE =
      ResourceLocator.ofFile(new File(PATH_CONFIG + "quotes/quotes-2020-09-07.csv"));
