...
public class CalibrationUsdCpiExample {
   ...
   */
  private static final CurveGroupName CURVE_GROUP_NAME = CurveGroupName.of("USD-DSCON-CPI");
  ...
  private static final ResourceLocator SETTINGS_RESOURCE =
      ResourceLocator.ofFile(new File(PATH_CONFIG + "curves/settings-usd-cpi.csv"));
  /**
   * The location of the curve calibration nodes file.
   */
  private static final ResourceLocator CALIBRATION_RESOURCE =
      ResourceLocator.ofFile(new File(PATH_CONFIG + "curves/calibrations-cpi.csv"));
  /**
  ...
  private static final ResourceLocator FIXING_RESOURCE =
      ResourceLocator.ofFile(new File(PATH_CONFIG + "fixings/us-cpi-u.csv"));
