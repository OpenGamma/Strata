...
public final class ReportCalculationResults implements ImmutableBean {
  ...
  public static ReportCalculationResults of(
    ...
    return of(valuationDate, targets, columns, calculationResults, ReferenceData.standard());
  }
  ...
  public static ReportCalculationResults of(
    ...
    return new ReportCalculationResults(
        valuationDate, ImmutableList.copyOf(targets), columns, calculationResults, refData);
  }
