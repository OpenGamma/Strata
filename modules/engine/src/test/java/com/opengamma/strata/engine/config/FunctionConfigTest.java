...
public class FunctionConfigTest {
  ...
  public void createFunctionWithNoArgsConstructor() {
    ...
    EngineFunction<TestTarget, ?> function = config.createFunction();
  ...
  public void createFunctionWithConstructorArgsPassedIn() {
    ...
    EngineFunction<TestTarget, ?> function = config.createFunction(ImmutableMap.of("count", 2, "str", "Foo"));
    Object result = function.execute(new TestTarget("Bar"), MARKET_DATA);
    assertThat(result).isEqualTo("FooBarFooBar");
  }
  ...
  public void createFunctionWithMixedConstructorArgs() {
    FunctionConfig<TestTarget> config =
        FunctionConfig.builder(TestFunctionWithParams.class)
            .addArgument("count", 2)
            .build();
    EngineFunction<TestTarget, ?> function = config.createFunction(ImmutableMap.of("str", "Foo"));
    Object result = function.execute(new TestTarget("Bar"), MARKET_DATA);
    assertThat(result).isEqualTo("FooBarFooBar");
  }
  ...
  public static final class TestFunctionNoParams implements EngineFunction<TestTarget, String> {
  ...
  public static final class TestFunctionWithParams implements EngineFunction<TestTarget, String> {
  ...
  public static final class TestFunctionNoPublicConstructor implements EngineFunction<TestTarget, String> {
  ...
  public static final class TestFunctionMultiplePublicConstructors implements EngineFunction<TestTarget, String> {
