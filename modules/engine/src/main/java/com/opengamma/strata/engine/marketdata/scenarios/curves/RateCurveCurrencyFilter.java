...
public final class RateCurveCurrencyFilter implements MarketDataFilter<YieldCurve, RateCurveId>, ImmutableBean {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code CurveCurrencyFilter}.
  ...
  public String toString() {
    ...
    buf.append("CurveCurrencyFilter{");
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code CurveCurrencyFilter}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<RateCurveCurrencyFilter> {
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(64);
      buf.append("CurveCurrencyFilter.Builder{");
