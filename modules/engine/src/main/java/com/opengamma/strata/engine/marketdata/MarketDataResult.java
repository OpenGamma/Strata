 ...
 */
@BeanDefinition
public final class MarketDataResult implements ImmutableBean {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code MarketDataResult}.
   * @return the meta-bean, not null
   */
  public static MarketDataResult.Meta meta() {
    return MarketDataResult.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(MarketDataResult.Meta.INSTANCE);
  }
   ...
   */
  public static MarketDataResult.Builder builder() {
    return new MarketDataResult.Builder();
  }

  private MarketDataResult(
  ...
  @Override
  public MarketDataResult.Meta metaBean() {
    return MarketDataResult.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      MarketDataResult other = (MarketDataResult) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<BaseMarketData> marketData = DirectMetaProperty.ofImmutable(
        this, "marketData", MarketDataResult.class, BaseMarketData.class);
    /**
    ...
    private final MetaProperty<Map<MarketDataId<?>, Result<?>>> singleValueFailures = DirectMetaProperty.ofImmutable(
        this, "singleValueFailures", MarketDataResult.class, (Class) Map.class);
    /**
    ...
    private final MetaProperty<Map<MarketDataId<?>, Result<?>>> timeSeriesFailures = DirectMetaProperty.ofImmutable(
        this, "timeSeriesFailures", MarketDataResult.class, (Class) Map.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public MarketDataResult.Builder builder() {
      return new MarketDataResult.Builder();
    }

    @Override
    public Class<? extends MarketDataResult> beanType() {
      return MarketDataResult.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1116764678:  // marketData
          return ((MarketDataResult) bean).getMarketData();
        case -1633495726:  // singleValueFailures
          return ((MarketDataResult) bean).getSingleValueFailures();
        case -1580093459:  // timeSeriesFailures
          return ((MarketDataResult) bean).getTimeSeriesFailures();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code MarketDataResult}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<MarketDataResult> {
     ...
     */
    private Builder(MarketDataResult beanToCopy) {
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("MarketDataResult.Builder{");
