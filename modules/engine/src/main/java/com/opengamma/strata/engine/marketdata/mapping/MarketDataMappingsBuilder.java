...
public class MarketDataMappingsBuilder {
  ...
  private ObservablesMapping observablesMapping = ObservablesMapping.of(MarketDataVendor.NONE);
   ...
   * @return this builder
   */
  public MarketDataMappingsBuilder observables(MarketDataVendor vendor) {
    observablesMapping = ObservablesMapping.of(vendor);
    return this;
  }
  ...
  public MarketDataMappings build() {
    return MarketDataMappings.of(observablesMapping, mappings);
  }
}
