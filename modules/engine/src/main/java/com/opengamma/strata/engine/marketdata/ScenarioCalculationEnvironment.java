...
public class ScenarioCalculationEnvironment implements ImmutableBean {
   ...
   */
  public static ScenarioCalculationEnvironment of(MarketEnvironment marketData) {
  ...
  public ScenarioCalculationEnvironmentBuilder toBuilder() {
    return new ScenarioCalculationEnvironmentBuilder(scenarioCount, valuationDates, values, timeSeries, globalValues);
  }
