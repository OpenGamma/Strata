 ...
 */
@BeanDefinition
public final class BaseMarketDataResult implements ImmutableBean {

  /** The market data that was successfully built. */
  @PropertyDefinition(validate = "notNull")
  private final BaseMarketData marketData;
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code BaseMarketDataResult}.
   * @return the meta-bean, not null
   */
  public static BaseMarketDataResult.Meta meta() {
    return BaseMarketDataResult.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(BaseMarketDataResult.Meta.INSTANCE);
  }
   ...
   */
  public static BaseMarketDataResult.Builder builder() {
    return new BaseMarketDataResult.Builder();
  }

  private BaseMarketDataResult(
  ...
  @Override
  public BaseMarketDataResult.Meta metaBean() {
    return BaseMarketDataResult.Meta.INSTANCE;
  }
   ...
   */
  public BaseMarketData getMarketData() {
    return marketData;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      BaseMarketDataResult other = (BaseMarketDataResult) obj;
  ...
  public String toString() {
    ...
    buf.append("BaseMarketDataResult{");
  ...
  public static final class Meta extends DirectMetaBean {
     ...
     */
    private final MetaProperty<BaseMarketData> marketData = DirectMetaProperty.ofImmutable(
        this, "marketData", BaseMarketDataResult.class, BaseMarketData.class);
    /**
    ...
    private final MetaProperty<Map<MarketDataId<?>, Result<?>>> singleValueFailures = DirectMetaProperty.ofImmutable(
        this, "singleValueFailures", BaseMarketDataResult.class, (Class) Map.class);
    /**
    ...
    private final MetaProperty<Map<MarketDataId<?>, Result<?>>> timeSeriesFailures = DirectMetaProperty.ofImmutable(
        this, "timeSeriesFailures", BaseMarketDataResult.class, (Class) Map.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BaseMarketDataResult.Builder builder() {
      return new BaseMarketDataResult.Builder();
    }

    @Override
    public Class<? extends BaseMarketDataResult> beanType() {
      return BaseMarketDataResult.class;
    }
     ...
     */
    public MetaProperty<BaseMarketData> marketData() {
      return marketData;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1116764678:  // marketData
          return ((BaseMarketDataResult) bean).getMarketData();
        case -1633495726:  // singleValueFailures
          return ((BaseMarketDataResult) bean).getSingleValueFailures();
        case -1580093459:  // timeSeriesFailures
          return ((BaseMarketDataResult) bean).getTimeSeriesFailures();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code BaseMarketDataResult}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<BaseMarketDataResult> {

    private BaseMarketData marketData;
     ...
     */
    private Builder(BaseMarketDataResult beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case 1116764678:  // marketData
          this.marketData = (BaseMarketData) newValue;
          break;
        case -1633495726:  // singleValueFailures
    ...
    @Override
    public BaseMarketDataResult build() {
      return new BaseMarketDataResult(
          marketData,
          singleValueFailures,
          timeSeriesFailures);
    }
     ...
     */
    public Builder marketData(BaseMarketData marketData) {
      JodaBeanUtils.notNull(marketData, "marketData");
      this.marketData = marketData;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("BaseMarketDataResult.Builder{");
