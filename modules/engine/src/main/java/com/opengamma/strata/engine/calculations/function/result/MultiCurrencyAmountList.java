 ...
 */
@BeanDefinition
public final class MultiCurrencyAmountList
    implements CurrencyConvertible<CurrencyAmountList>, ScenarioResult<MultiCurrencyAmount>, ImmutableBean {
  ...
  @Override
  public Iterator<MultiCurrencyAmount> iterator() {
