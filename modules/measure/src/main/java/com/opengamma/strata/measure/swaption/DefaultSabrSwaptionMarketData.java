...
/**
 * The default sabr market data for swaptions.
 * <p>
 * This uses a {@link SwaptionMarketDataLookup} to provide a view on {@link MarketData}.
 */
@BeanDefinition(style = "light")
final class DefaultSabrSwaptionMarketData
    implements SabrSwaptionMarketData, ImmutableBean, Serializable {
   ...
   */
  public static DefaultSabrSwaptionMarketData of(
      SabrSwaptionMarketDataLookup lookup,
      MarketData marketData) {

    return new DefaultSabrSwaptionMarketData(lookup, marketData);
  }

  @ImmutableConstructor
  private DefaultSabrSwaptionMarketData(
      SabrSwaptionMarketDataLookup lookup,
      MarketData marketData) {
  ...
  //-------------------------------------------------------------------------
  @Override
  public SabrSwaptionMarketData withMarketData(MarketData marketData) {
    return DefaultSabrSwaptionMarketData.of(lookup, marketData);
  }

  //-------------------------------------------------------------------------
  @Override
  public SabrSwaptionVolatilities volatilities(IborIndex index) {
    return lookup.volatilities(index, marketData);
  }

  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code DefaultSabrSwaptionMarketData}.
   */
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      DefaultSabrSwaptionMarketData other = (DefaultSabrSwaptionMarketData) obj;
  ...
  public String toString() {
    ...
    buf.append("DefaultSabrSwaptionMarketData{");
