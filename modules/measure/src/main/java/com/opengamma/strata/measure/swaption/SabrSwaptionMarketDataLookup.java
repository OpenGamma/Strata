...
/**
 * The lookup that provides access to swaption SABR volatilities in market data.
 * <p>
 ...
 */
public interface SabrSwaptionMarketDataLookup extends CalculationParameter {
   ...
   */
  public static SabrSwaptionMarketDataLookup of(IborIndex index, SabrSwaptionVolatilitiesId volatilityId) {
    return DefaultSabrSwaptionMarketDataLookup.of(ImmutableMap.of(index, volatilityId));
  }
   ...
   */
  public static SabrSwaptionMarketDataLookup of(Map<IborIndex, SabrSwaptionVolatilitiesId> volatilityIds) {
    return DefaultSabrSwaptionMarketDataLookup.of(volatilityIds);
  }
   ...
   */
  public default SabrSwaptionScenarioMarketData marketDataView(ScenarioMarketData marketData) {
    return DefaultSabrSwaptionScenarioMarketData.of(this, marketData);
  }
   ...
   * @return the filtered market data
   */
  public default SabrSwaptionMarketData marketDataView(MarketData marketData) {
    return DefaultSabrSwaptionMarketData.of(this, marketData);
  }
   ...
   * <p>
   * This provides {@link SabrSwaptionVolatilities} suitable for pricing a swaption.
   * Although this method can be used directly, it is typically invoked indirectly
   * via {@link SabrSwaptionMarketData}:
   * <pre>
   ...
   */
  public abstract SabrSwaptionVolatilities volatilities(IborIndex index, MarketData marketData);
