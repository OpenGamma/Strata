 ...
 */
public interface SabrSwaptionMarketData {
   ...
   */
  public abstract SabrSwaptionMarketData withMarketData(MarketData marketData);
   ...
   */
  public abstract SabrSwaptionVolatilities volatilities(IborIndex index);
