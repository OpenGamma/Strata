...
final class DefaultLegalEntityDiscountingScenarioMarketData
    implements LegalEntityDiscountingScenarioMarketData, ImmutableBean {
   ...
   */
  private static MetaBean META_BEAN = LightMetaBean.of(DefaultLegalEntityDiscountingScenarioMarketData.class);
