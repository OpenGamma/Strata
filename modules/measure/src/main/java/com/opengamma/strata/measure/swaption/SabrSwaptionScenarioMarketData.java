 ...
 */
public interface SabrSwaptionScenarioMarketData {
   ...
   */
  public abstract SabrSwaptionMarketDataLookup getLookup();
   ...
   */
  public abstract SabrSwaptionScenarioMarketData withMarketData(ScenarioMarketData marketData);
   ...
   */
  public abstract SabrSwaptionMarketData scenario(int scenarioIndex);
