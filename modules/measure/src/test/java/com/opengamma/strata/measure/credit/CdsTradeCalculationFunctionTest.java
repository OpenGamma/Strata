...
/**
 * Test {@link CdsTradeCalculationFunction}.
 */
@Test
public class CdsTradeCalculationFunctionTest {

  private static final CdsTrade TRADE = CreditDataSet.CDS_TRADE;
  private static final ResolvedCdsTrade RTRADE = CreditDataSet.RESOLVED_CDS_TRADE;
  private static final CdsTradeCalculationFunction FUNCTION = new CdsTradeCalculationFunction();
  private static final CreditRatesProvider RATES_PROVIDER =
      CreditDataSet.CDS_LOOKUP.marketDataView(CreditDataSet.MARKET_DATA.scenario(0)).creditRatesProvider();
  private static final IsdaCdsTradePricer PRICER = new IsdaCdsTradePricer(AccrualOnDefaultFormula.CORRECT);
  ...
  public void test_requirementsAndCurrency() {
    ...
    assertThat(reqs.getValueRequirements()).isEqualTo(
        ImmutableSet.of(CreditDataSet.CDS_CREDIT_CURVE_ID, CreditDataSet.USD_DSC_CURVE_ID, CreditDataSet.CDS_RECOVERY_CURVE_ID));
  ...
  public void test_simpleMeasures() {
    ...
    assertThat(FUNCTION.calculate(TRADE, measures, CreditDataSet.CDS_PARAMS, CreditDataSet.MARKET_DATA, CreditDataSet.REF_DATA))
