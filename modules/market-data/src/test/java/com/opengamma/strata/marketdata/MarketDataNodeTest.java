...
public class MarketDataNodeTest {
  ...
  public void withLeavesRemoved() {
    ...
    Assertions.assertThat(expectedReqs1).isEqualTo(reqs1);
    ...
    Assertions.assertThat(expectedReqs2).isEqualTo(reqs2);
    ...
    Assertions.assertThat(expectedReqs3).isEqualTo(reqs3);
  }
