...
import com.opengamma.strata.marketdata.builders.DiscountingCurveMarketDataBuilder;
...
import com.opengamma.strata.marketdata.builders.RateIndexCurveMarketDataBuilder;
...
public class DefaultMarketDataFactoryTest {
  ...
  public void nonObservableScenarioDataWithMissingBuilder() {
    ...
    TestHelper.assertThrows(
        () -> marketData.getValues(id1),
        IllegalArgumentException.class,
        "No values available for.*");
    TestHelper.assertThrows(
        () -> marketData.getValues(id2),
        IllegalArgumentException.class,
        "No values available for.*");
  }
