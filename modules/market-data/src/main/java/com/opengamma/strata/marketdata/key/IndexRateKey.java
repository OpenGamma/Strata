...
public final class IndexRateKey implements ObservableKey, ImmutableBean {
  ...
  /** The ID corresponding to this key. */
  private final IndexRateId rateId;
  ...
  private IndexRateKey(Index index, FieldName fieldName) {
    this.index = ArgChecker.notNull(index, "index");
    this.fieldName = ArgChecker.notNull(fieldName, "fieldName");
    rateId = IndexRateId.of(index, fieldName);
  }
  ...
  @Override
  public ObservableId toObservableId(MarketDataVendor marketDataVendor) {
    return rateId;
  }
