...
public interface ObservableKey
   ...
   */
  public abstract ObservableId toObservableId(MarketDataFeed marketDataFeed);

  @Override
  public default MarketDataId<Double> toMarketDataId(MarketDataFeed marketDataFeed) {
