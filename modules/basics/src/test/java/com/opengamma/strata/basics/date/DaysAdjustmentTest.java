...
public class DaysAdjustmentTest {
  ...
  private static final HolidayCalendar HOLCAL_WED_THU = ImmutableHolidayCalendar.of("WedThu", ImmutableList.of(), WEDNESDAY,
      THURSDAY);
  ...
  private static final BusinessDayAdjustment BDA_FOLLOW_WED_THU = BusinessDayAdjustment.of(BusinessDayConventions.FOLLOWING,
      HOLCAL_WED_THU);
