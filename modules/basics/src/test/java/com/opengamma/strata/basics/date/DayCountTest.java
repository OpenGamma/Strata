...
public class DayCountTest {
  ...
  @Test(dataProvider = "yearFraction")
  public void test_relativeYearFraction(DayCount dayCount, int y1, int m1, int d1, int y2, int m2, int d2, Double value) {
    double expected = (value == SIMPLE_30_360 ? calc360(y1, m1, d1, y2, m2, d2) : value);
    LocalDate date1 = LocalDate.of(y1, m1, d1);
    LocalDate date2 = LocalDate.of(y2, m2, d2);
  ...
  @Test(dataProvider = "yearFraction")
  public void test_relativeYearFraction_reverse(DayCount dayCount, int y1, int m1, int d1, int y2, int m2, int d2, Double value) {
    double expected = (value == SIMPLE_30_360 ? calc360(y1, m1, d1, y2, m2, d2) : value);
    LocalDate date1 = LocalDate.of(y1, m1, d1);
    LocalDate date2 = LocalDate.of(y2, m2, d2);
  ...
  public void test_yearFraction_30U360_notEom(int y1, int m1, int d1, int y2, int m2, int d2, Double valueNotEOM, Double valueEOM) {
  ...
  @Test(dataProvider = "30U360")
  public void test_yearFraction_30U360_eom(int y1, int m1, int d1, int y2, int m2, int d2, Double valueNotEOM, Double valueEOM) {
  ...
  @Test(dataProvider = "30U360")
  public void test_yearFraction_30360ISDA(int y1, int m1, int d1, int y2, int m2, int d2, Double valueNotEOM, Double valueEOM) {
    double expected = (valueNotEOM == SIMPLE_30_360 ? calc360(y1, m1, d1, y2, m2, d2) : valueNotEOM);
    LocalDate date1 = LocalDate.of(y1, m1, d1);
    LocalDate date2 = LocalDate.of(y2, m2, d2);
    ScheduleInfo info = new Info(true);
  ...
  @Test(dataProvider = "30U360")
  public void test_yearFraction_30U360EOM(int y1, int m1, int d1, int y2, int m2, int d2, Double valueNotEOM, Double valueEOM) {
    double expected = (valueEOM == SIMPLE_30_360 ? calc360(y1, m1, d1, y2, m2, d2) : valueEOM);
    LocalDate date1 = LocalDate.of(y1, m1, d1);
    LocalDate date2 = LocalDate.of(y2, m2, d2);
    ScheduleInfo info = new Info(true);
  ...
  public void test_yearFraction_30E360ISDA_notMaturity(int y1, int m1, int d1, int y2, int m2, int d2, Double valueNotMaturity, Double valueMaturity) {
  ...
  @Test(dataProvider = "30E360ISDA")
  public void test_yearFraction_30E360ISDA_maturity(int y1, int m1, int d1, int y2, int m2, int d2, Double valueNotMaturity, Double valueMaturity) {
  ...
  public void test_yearFraction_ACTACTAFB(int y1, int m1, int d1, int y2, int m2, int d2, double expected) {
    LocalDate date1 = LocalDate.of(y1, m1, d1);
    LocalDate date2 = LocalDate.of(y2, m2, d2);
  ...
  public void test_yearFraction_ACT365L(int y1, int m1, int d1, int y2, int m2, int d2, Frequency freq, int y3, int m3, int d3, double expected) {
    LocalDate date1 = LocalDate.of(y1, m1, d1);
    LocalDate date2 = LocalDate.of(y2, m2, d2);
