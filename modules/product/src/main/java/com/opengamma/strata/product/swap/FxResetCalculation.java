...
public final class FxResetCalculation
  ...
  // build the FxReset
  private FxReset buildFxReset(SchedulePeriod period, DateAdjuster fixingDateAdjuster, ReferenceData refData) {
    LocalDate fixingDate = fixingDateAdjuster.adjust(fixingRelativeTo.selectBaseDate(period));
    return FxReset.of(FxIndexObservation.of(index, fixingDate, refData), referenceCurrency);
  }
