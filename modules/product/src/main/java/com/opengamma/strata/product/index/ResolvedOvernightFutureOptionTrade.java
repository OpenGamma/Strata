 ...
 * <p>
 * This is the resolved form of {@link OvernightFutureOptionTrade} and is the primary input to the pricers.
 * Applications will typically create a {@code ResolvedOvernightFutureOptionTrade} from a {@code OvernightFutureOptionTrade}
 * using {@link OvernightFutureOptionTrade#resolve(ReferenceData)}.
 * <p>
 * A {@code ResolvedOvernightFutureOptionTrade} is bound to data that changes over time, such as holiday calendars.
...
public final class ResolvedOvernightFutureOptionTrade
   ...
   */
  @PropertyDefinition(validate = "notNull", overrideGet = true)
  private final ResolvedOvernightFutureOption product;
  /**
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code ResolvedOvernightFutureOptionTrade}.
   * @return the meta-bean, not null
   */
  public static ResolvedOvernightFutureOptionTrade.Meta meta() {
    return ResolvedOvernightFutureOptionTrade.Meta.INSTANCE;
  }

  static {
    MetaBean.register(ResolvedOvernightFutureOptionTrade.Meta.INSTANCE);
  }
   ...
   */
  public static ResolvedOvernightFutureOptionTrade.Builder builder() {
    return new ResolvedOvernightFutureOptionTrade.Builder();
  }
  ...
  @Override
  public ResolvedOvernightFutureOptionTrade.Meta metaBean() {
    return ResolvedOvernightFutureOptionTrade.Meta.INSTANCE;
  }
   ...
   */
  @Override
  public ResolvedOvernightFutureOption getProduct() {
    return product;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ResolvedOvernightFutureOptionTrade other = (ResolvedOvernightFutureOptionTrade) obj;
  ...
  public String toString() {
    ...
    buf.append("ResolvedOvernightFutureOptionTrade{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PortfolioItemInfo> info = DirectMetaProperty.ofImmutable(
        this, "info", ResolvedOvernightFutureOptionTrade.class, PortfolioItemInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<ResolvedOvernightFutureOption> product = DirectMetaProperty.ofImmutable(
        this, "product", ResolvedOvernightFutureOptionTrade.class, ResolvedOvernightFutureOption.class);
    /**
     * The meta-property for the {@code quantity} property.
     */
    private final MetaProperty<Double> quantity = DirectMetaProperty.ofImmutable(
        this, "quantity", ResolvedOvernightFutureOptionTrade.class, Double.TYPE);
    /**
    ...
    private final MetaProperty<TradedPrice> tradedPrice = DirectMetaProperty.ofImmutable(
        this, "tradedPrice", ResolvedOvernightFutureOptionTrade.class, TradedPrice.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public ResolvedOvernightFutureOptionTrade.Builder builder() {
      return new ResolvedOvernightFutureOptionTrade.Builder();
    }

    @Override
    public Class<? extends ResolvedOvernightFutureOptionTrade> beanType() {
      return ResolvedOvernightFutureOptionTrade.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<ResolvedOvernightFutureOption> product() {
      return product;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3237038:  // info
          return ((ResolvedOvernightFutureOptionTrade) bean).getInfo();
        case -309474065:  // product
          return ((ResolvedOvernightFutureOptionTrade) bean).getProduct();
        case -1285004149:  // quantity
          return ((ResolvedOvernightFutureOptionTrade) bean).getQuantity();
        case -1873824343:  // tradedPrice
          return ((ResolvedOvernightFutureOptionTrade) bean).tradedPrice;
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code ResolvedOvernightFutureOptionTrade}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<ResolvedOvernightFutureOptionTrade> {

    private PortfolioItemInfo info;
    private ResolvedOvernightFutureOption product;
     ...
     */
    private Builder(ResolvedOvernightFutureOptionTrade beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case 3237038:  // info
          ...
          break;
        case -309474065:  // product
          this.product = (ResolvedOvernightFutureOption) newValue;
          break;
        case -1285004149:  // quantity
    ...
    @Override
    public ResolvedOvernightFutureOptionTrade build() {
      return new ResolvedOvernightFutureOptionTrade(
          info,
          product,
          quantity,
          tradedPrice);
     ...
     * @return this, for chaining, not null
     */
    public Builder product(ResolvedOvernightFutureOption product) {
      JodaBeanUtils.notNull(product, "product");
      this.product = product;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(160);
      buf.append("ResolvedOvernightFutureOptionTrade.Builder{");
      buf.append("info").append('=').append(JodaBeanUtils.toString(info)).append(',').append(' ');
      buf.append("product").append('=').append(JodaBeanUtils.toString(product)).append(',').append(' ');
      buf.append("quantity").append('=').append(JodaBeanUtils.toString(quantity)).append(',').append(' ');
      buf.append("tradedPrice").append('=').append(JodaBeanUtils.toString(tradedPrice));
