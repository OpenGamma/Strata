...
/**
 * A template for creating an Overnight Future trade using a relative definition of time.
 * <p>
...
final class RelativeOvernightFutureTemplate
   ...
   * @return the template
   */
  public static RelativeOvernightFutureTemplate of(
      Period minimumPeriod,
      int sequenceNumber,
      OvernightFutureContractSpec contractSpec) {

    return new RelativeOvernightFutureTemplate(minimumPeriod, sequenceNumber, contractSpec);
  }
  ...
  public LocalDate calculateReferenceDateFromTradeDate(LocalDate tradeDate, ReferenceData refData) {
    return contractSpec.calculateReferenceDate(tradeDate, minimumPeriod, sequenceNumber, refData);
  }

  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code RelativeOvernightFutureTemplate}.
   * @return the meta-bean, not null
   */
  public static RelativeOvernightFutureTemplate.Meta meta() {
    return RelativeOvernightFutureTemplate.Meta.INSTANCE;
  }

  static {
    MetaBean.register(RelativeOvernightFutureTemplate.Meta.INSTANCE);
  }
  ...
  private RelativeOvernightFutureTemplate(
      Period minimumPeriod,
      int sequenceNumber,
      OvernightFutureContractSpec contractSpec) {
  ...
  @Override
  public RelativeOvernightFutureTemplate.Meta metaBean() {
    return RelativeOvernightFutureTemplate.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      RelativeOvernightFutureTemplate other = (RelativeOvernightFutureTemplate) obj;
  ...
  public String toString() {
    ...
    buf.append("RelativeOvernightFutureTemplate{");
  ...
  static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Period> minimumPeriod = DirectMetaProperty.ofImmutable(
        this, "minimumPeriod", RelativeOvernightFutureTemplate.class, Period.class);
    /**
    ...
    private final MetaProperty<Integer> sequenceNumber = DirectMetaProperty.ofImmutable(
        this, "sequenceNumber", RelativeOvernightFutureTemplate.class, Integer.TYPE);
    /**
    ...
    private final MetaProperty<OvernightFutureContractSpec> contractSpec = DirectMetaProperty.ofImmutable(
        this, "contractSpec", RelativeOvernightFutureTemplate.class, OvernightFutureContractSpec.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends RelativeOvernightFutureTemplate> builder() {
      return new RelativeOvernightFutureTemplate.Builder();
    }

    @Override
    public Class<? extends RelativeOvernightFutureTemplate> beanType() {
      return RelativeOvernightFutureTemplate.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -1855508625:  // minimumPeriod
          return ((RelativeOvernightFutureTemplate) bean).getMinimumPeriod();
        case -1353995670:  // sequenceNumber
          return ((RelativeOvernightFutureTemplate) bean).getSequenceNumber();
        case -1402362899:  // contractSpec
          return ((RelativeOvernightFutureTemplate) bean).getContractSpec();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code RelativeOvernightFutureTemplate}.
   */
  private static final class Builder extends DirectPrivateBeanBuilder<RelativeOvernightFutureTemplate> {
    ...
    @Override
    public RelativeOvernightFutureTemplate build() {
      return new RelativeOvernightFutureTemplate(
          minimumPeriod,
          sequenceNumber,
          contractSpec);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("RelativeOvernightFutureTemplate.Builder{");
      buf.append("minimumPeriod").append('=').append(JodaBeanUtils.toString(minimumPeriod)).append(',').append(' ');
      buf.append("sequenceNumber").append('=').append(JodaBeanUtils.toString(sequenceNumber)).append(',').append(' ');
      buf.append("contractSpec").append('=').append(JodaBeanUtils.toString(contractSpec));
      buf.append('}');
