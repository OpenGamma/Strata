...
public final class FxNdfTrade
    implements ProductTrade<FxNdf>, Resolvable<ResolvedFxNdfTrade>, ImmutableBean, Serializable {
   ...
   * @return the trade
   */
  public static FxNdfTrade of(TradeInfo tradeInfo, FxNdf product) {
    return new FxNdfTrade(tradeInfo, product);
  }
