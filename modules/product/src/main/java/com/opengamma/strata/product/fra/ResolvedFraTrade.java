...
public final class ResolvedFraTrade
    implements ResolvedTrade<ResolvedFra>, ImmutableBean, Serializable {
   ...
   */
  public static ResolvedFraTrade of(TradeInfo tradeInfo, ResolvedFra product) {
    return new ResolvedFraTrade(tradeInfo, product);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<TradeInfo> tradeInfo = DirectMetaProperty.ofImmutable(
        this, "tradeInfo", ResolvedFraTrade.class, TradeInfo.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 752580658:  // tradeInfo
          return ((ResolvedFraTrade) bean).getTradeInfo();
        case -309474065:  // product
