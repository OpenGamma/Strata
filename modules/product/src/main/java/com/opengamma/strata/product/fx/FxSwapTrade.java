...
public final class FxSwapTrade
    implements ProductTrade<FxSwap>, Resolvable<ResolvedFxSwapTrade>, ImmutableBean, Serializable {
   ...
   * @return the trade
   */
  public static FxSwapTrade of(TradeInfo tradeInfo, FxSwap product) {
    return new FxSwapTrade(tradeInfo, product);
  }
