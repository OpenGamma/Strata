 ...
 * The cap/floor leg involves a set of call/put options on successive Ibor index rates, i.e., Ibor caplets/floorlets.
 * The pay leg is any swap leg from a standard interest rate swap. The pay leg is absent
 * for typical Ibor cap/floor products, with the premium paid upfront instead, as defined in {@link IborCapFloorTrade}.
 */
...
public final class IborCapFloor
  ...
  * These periodic payments are not made for typical cap/floor products. Instead the premium is paid upfront. 
  ...
  public ExpandedIborCapFloor expand() {
    return ExpandedIborCapFloor.of(capFloorLeg.expand(), getPayLeg().isPresent() ? payLeg.expand() : null);
  }
