...
/**
 * An inflation rate swap leg defined using a parameterized schedule and calculation.
 * <p>
 * This defines a single swap leg paying a floating rate based on a price index.
 * <p>
 ...
 */
@BeanDefinition
public final class InflationRateSwapLeg
    implements ParameterizedSwapLeg<InflationRateCalculation>, ImmutableBean, Serializable {
  ...
  /**
   * The inflation rate accrual calculation.
   * <p>
   * This defines the detail of the inflation rate calculation, including the index and spread.
   */
  @PropertyDefinition(validate = "notNull", overrideGet = true)
  private final InflationRateCalculation calculation;
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code InflationRateSwapLeg}.
   * @return the meta-bean, not null
   */
  public static InflationRateSwapLeg.Meta meta() {
    return InflationRateSwapLeg.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(InflationRateSwapLeg.Meta.INSTANCE);
  }
   ...
   */
  public static InflationRateSwapLeg.Builder builder() {
    return new InflationRateSwapLeg.Builder();
  }

  private InflationRateSwapLeg(
      PayReceive payReceive,
      PeriodicSchedule accrualSchedule,
      PaymentSchedule paymentSchedule,
      NotionalSchedule notionalSchedule,
      InflationRateCalculation calculation) {
  ...
  @Override
  public InflationRateSwapLeg.Meta metaBean() {
    return InflationRateSwapLeg.Meta.INSTANCE;
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the inflation rate accrual calculation.
   * <p>
   * This defines the detail of the inflation rate calculation, including the index and spread.
   * @return the value of the property, not null
   */
  @Override
  public InflationRateCalculation getCalculation() {
    return calculation;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      InflationRateSwapLeg other = (InflationRateSwapLeg) obj;
  ...
  public String toString() {
    ...
    buf.append("InflationRateSwapLeg{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PayReceive> payReceive = DirectMetaProperty.ofImmutable(
        this, "payReceive", InflationRateSwapLeg.class, PayReceive.class);
    /**
    ...
    private final MetaProperty<PeriodicSchedule> accrualSchedule = DirectMetaProperty.ofImmutable(
        this, "accrualSchedule", InflationRateSwapLeg.class, PeriodicSchedule.class);
    /**
    ...
    private final MetaProperty<PaymentSchedule> paymentSchedule = DirectMetaProperty.ofImmutable(
        this, "paymentSchedule", InflationRateSwapLeg.class, PaymentSchedule.class);
    /**
    ...
    private final MetaProperty<NotionalSchedule> notionalSchedule = DirectMetaProperty.ofImmutable(
        this, "notionalSchedule", InflationRateSwapLeg.class, NotionalSchedule.class);
    /**
     * The meta-property for the {@code calculation} property.
     */
    private final MetaProperty<InflationRateCalculation> calculation = DirectMetaProperty.ofImmutable(
        this, "calculation", InflationRateSwapLeg.class, InflationRateCalculation.class);
    /**
     * The meta-property for the {@code type} property.
     */
    private final MetaProperty<SwapLegType> type = DirectMetaProperty.ofDerived(
        this, "type", InflationRateSwapLeg.class, SwapLegType.class);
    /**
     * The meta-property for the {@code startDate} property.
     */
    private final MetaProperty<AdjustableDate> startDate = DirectMetaProperty.ofDerived(
        this, "startDate", InflationRateSwapLeg.class, AdjustableDate.class);
    /**
     * The meta-property for the {@code endDate} property.
     */
    private final MetaProperty<AdjustableDate> endDate = DirectMetaProperty.ofDerived(
        this, "endDate", InflationRateSwapLeg.class, AdjustableDate.class);
    /**
     * The meta-property for the {@code currency} property.
     */
    private final MetaProperty<Currency> currency = DirectMetaProperty.ofDerived(
        this, "currency", InflationRateSwapLeg.class, Currency.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public InflationRateSwapLeg.Builder builder() {
      return new InflationRateSwapLeg.Builder();
    }

    @Override
    public Class<? extends InflationRateSwapLeg> beanType() {
      return InflationRateSwapLeg.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<InflationRateCalculation> calculation() {
      return calculation;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -885469925:  // payReceive
          return ((InflationRateSwapLeg) bean).getPayReceive();
        case 304659814:  // accrualSchedule
          return ((InflationRateSwapLeg) bean).getAccrualSchedule();
        case -1499086147:  // paymentSchedule
          return ((InflationRateSwapLeg) bean).getPaymentSchedule();
        case 1447860727:  // notionalSchedule
          return ((InflationRateSwapLeg) bean).getNotionalSchedule();
        case -934682935:  // calculation
          return ((InflationRateSwapLeg) bean).getCalculation();
        case 3575610:  // type
          return ((InflationRateSwapLeg) bean).getType();
        case -2129778896:  // startDate
          return ((InflationRateSwapLeg) bean).getStartDate();
        case -1607727319:  // endDate
          return ((InflationRateSwapLeg) bean).getEndDate();
        case 575402001:  // currency
          return ((InflationRateSwapLeg) bean).getCurrency();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code InflationRateSwapLeg}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<InflationRateSwapLeg> {

    private PayReceive payReceive;
    private PeriodicSchedule accrualSchedule;
    private PaymentSchedule paymentSchedule;
    private NotionalSchedule notionalSchedule;
    private InflationRateCalculation calculation;
     ...
     */
    private Builder(InflationRateSwapLeg beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case 1447860727:  // notionalSchedule
          ...
          break;
        case -934682935:  // calculation
          this.calculation = (InflationRateCalculation) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
    ...
    @Override
    public InflationRateSwapLeg build() {
      return new InflationRateSwapLeg(
          payReceive,
          accrualSchedule,
          paymentSchedule,
          notionalSchedule,
    ...
    /**
     * Sets the inflation rate accrual calculation.
     * <p>
     * This defines the detail of the inflation rate calculation, including the index and spread.
     * @param calculation  the new value, not null
     * @return this, for chaining, not null
     */
    public Builder calculation(InflationRateCalculation calculation) {
      JodaBeanUtils.notNull(calculation, "calculation");
      this.calculation = calculation;
      return this;
    }
    ...
    public String toString() {
      ...
      buf.append("InflationRateSwapLeg.Builder{");
