 ...
 * Thus one of the two fields must be null and the other not null.
 * <p>
 ...
 * <p>
 * An {@code IborCapletFloorletBinaryPeriod} is bound to data that changes over time, such as holiday calendars.
 * If the data changes, such as the addition of a new holiday, the resolved form will not be updated.
 * Care must be taken when placing the resolved form in a cache or persistence layer.
 */
@BeanDefinition
public final class IborCapletFloorletBinaryPeriod
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code IborCapletFloorletBinaryPeriod}.
   * @return the meta-bean, not null
   */
  public static IborCapletFloorletBinaryPeriod.Meta meta() {
    return IborCapletFloorletBinaryPeriod.Meta.INSTANCE;
  }

  static {
    MetaBean.register(IborCapletFloorletBinaryPeriod.Meta.INSTANCE);
  }
  ...
  public static IborCapletFloorletBinaryPeriod.Builder builder() {
    return new IborCapletFloorletBinaryPeriod.Builder();
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<LocalDate> startDate = DirectMetaProperty.ofImmutable(
        this, "startDate", IborCapletFloorletBinaryPeriod.class, LocalDate.class);
    /**
     * The meta-property for the {@code endDate} property.
     */
    private final MetaProperty<LocalDate> endDate = DirectMetaProperty.ofImmutable(
        this, "endDate", IborCapletFloorletBinaryPeriod.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<LocalDate> unadjustedStartDate = DirectMetaProperty.ofImmutable(
        this, "unadjustedStartDate", IborCapletFloorletBinaryPeriod.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<Double> floorlet = DirectMetaProperty.ofImmutable(
        this, "floorlet", IborCapletFloorletBinaryPeriod.class, Double.class);
    /**
    ...
    private final MetaProperty<IborRateComputation> iborRate = DirectMetaProperty.ofImmutable(
        this, "iborRate", IborCapletFloorletBinaryPeriod.class, IborRateComputation.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public IborCapletFloorletBinaryPeriod.Builder builder() {
      return new IborCapletFloorletBinaryPeriod.Builder();
    }

    @Override
    public Class<? extends IborCapletFloorletBinaryPeriod> beanType() {
      return IborCapletFloorletBinaryPeriod.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1607727319:  // endDate
          return ((IborCapletFloorletBinaryPeriod) bean).getEndDate();
        case 1457691881:  // unadjustedStartDate
          return ((IborCapletFloorletBinaryPeriod) bean).getUnadjustedStartDate();
        case 31758114:  // unadjustedEndDate
          return ((IborCapletFloorletBinaryPeriod) bean).getUnadjustedEndDate();
        case -1731780257:  // yearFraction
          return ((IborCapletFloorletBinaryPeriod) bean).getYearFraction();
        case -1540873516:  // paymentDate
          return ((IborCapletFloorletBinaryPeriod) bean).getPaymentDate();
        case -1367656183:  // caplet
          return ((IborCapletFloorletBinaryPeriod) bean).caplet;
        case 2022994575:  // floorlet
          return ((IborCapletFloorletBinaryPeriod) bean).floorlet;
        case -1621804100:  // iborRate
          return ((IborCapletFloorletBinaryPeriod) bean).getIborRate();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code IborCapletFloorletBinaryPeriod}.
   */
