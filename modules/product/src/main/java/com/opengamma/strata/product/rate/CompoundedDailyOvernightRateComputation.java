 ...
 */
@BeanDefinition
public final class CompoundedDailyOvernightRateComputation
   ...
   */
  public static CompoundedDailyOvernightRateComputation of(
      OvernightIndex index,
      LocalDate startDate,
      LocalDate endDate,
      ReferenceData refData) {

    return CompoundedDailyOvernightRateComputation.builder()
        .index(index)
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code CompoundedDailyOvernightRateComputation}.
   * @return the meta-bean, not null
   */
  public static CompoundedDailyOvernightRateComputation.Meta meta() {
    return CompoundedDailyOvernightRateComputation.Meta.INSTANCE;
  }

  static {
    MetaBean.register(CompoundedDailyOvernightRateComputation.Meta.INSTANCE);
  }
   ...
   */
  public static CompoundedDailyOvernightRateComputation.Builder builder() {
    return new CompoundedDailyOvernightRateComputation.Builder();
  }

  private CompoundedDailyOvernightRateComputation(
      OvernightIndex index,
  ...
  @Override
  public CompoundedDailyOvernightRateComputation.Meta metaBean() {
    return CompoundedDailyOvernightRateComputation.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      CompoundedDailyOvernightRateComputation other = (CompoundedDailyOvernightRateComputation) obj;
  ...
  public String toString() {
    ...
    buf.append("CompoundedDailyOvernightRateComputation{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<OvernightIndex> index = DirectMetaProperty.ofImmutable(
        this, "index", CompoundedDailyOvernightRateComputation.class, OvernightIndex.class);
    /**
    ...
    private final MetaProperty<HolidayCalendar> fixingCalendar = DirectMetaProperty.ofImmutable(
        this, "fixingCalendar", CompoundedDailyOvernightRateComputation.class, HolidayCalendar.class);
    /**
     * The meta-property for the {@code startDate} property.
     */
    private final MetaProperty<LocalDate> startDate = DirectMetaProperty.ofImmutable(
        this, "startDate", CompoundedDailyOvernightRateComputation.class, LocalDate.class);
    /**
     * The meta-property for the {@code endDate} property.
     */
    private final MetaProperty<LocalDate> endDate = DirectMetaProperty.ofImmutable(
        this, "endDate", CompoundedDailyOvernightRateComputation.class, LocalDate.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public CompoundedDailyOvernightRateComputation.Builder builder() {
      return new CompoundedDailyOvernightRateComputation.Builder();
    }

    @Override
    public Class<? extends CompoundedDailyOvernightRateComputation> beanType() {
      return CompoundedDailyOvernightRateComputation.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 100346066:  // index
          return ((CompoundedDailyOvernightRateComputation) bean).getIndex();
        case 394230283:  // fixingCalendar
          return ((CompoundedDailyOvernightRateComputation) bean).getFixingCalendar();
        case -2129778896:  // startDate
          return ((CompoundedDailyOvernightRateComputation) bean).getStartDate();
        case -1607727319:  // endDate
          return ((CompoundedDailyOvernightRateComputation) bean).getEndDate();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code CompoundedDailyOvernightRateComputation}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<CompoundedDailyOvernightRateComputation> {
     ...
     */
    private Builder(CompoundedDailyOvernightRateComputation beanToCopy) {
    ...
    @Override
    public CompoundedDailyOvernightRateComputation build() {
      return new CompoundedDailyOvernightRateComputation(
          index,
          fixingCalendar,
          startDate,
          endDate);
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(160);
      buf.append("CompoundedDailyOvernightRateComputation.Builder{");
