 ...
 * <p>
 * An Overnight rate future option is a financial instrument that provides an option based on the value of
 * an Overnight rate future. The option is American, exercised at any point up to the exercise time.
...
public final class OvernightFutureOption
    implements SecuritizedProduct, Resolvable<ResolvedOvernightFutureOption>, ImmutableBean, Serializable {
   ...
   */
  @PropertyDefinition(validate = "notNull")
  private final OvernightFuture underlyingFuture;
  ...
  private void validate() {
    ArgChecker.inOrderOrEqual(expiryDate, underlyingFuture.getStartDate(), "expiryDate", "accrualStartDate");
    ArgChecker.isTrue(
  ...
  //-------------------------------------------------------------------------
  @Override
  public ResolvedOvernightFutureOption resolve(ReferenceData refData) {
    ResolvedOvernightFuture resolved = underlyingFuture.resolve(refData);
    return new ResolvedOvernightFutureOption(securityId, putCall, strikePrice, getExpiry(), premiumStyle, rounding, resolved);
  }

  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code OvernightFutureOption}.
   * @return the meta-bean, not null
   */
  public static OvernightFutureOption.Meta meta() {
    return OvernightFutureOption.Meta.INSTANCE;
  }

  static {
    MetaBean.register(OvernightFutureOption.Meta.INSTANCE);
  }
   ...
   */
  public static OvernightFutureOption.Builder builder() {
    return new OvernightFutureOption.Builder();
  }
  ...
  @Override
  public OvernightFutureOption.Meta metaBean() {
    return OvernightFutureOption.Meta.INSTANCE;
  }
   ...
   * @return the value of the property, not null
   */
  public OvernightFuture getUnderlyingFuture() {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      OvernightFutureOption other = (OvernightFutureOption) obj;
  ...
  public String toString() {
    ...
    buf.append("OvernightFutureOption{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Double> strikePrice = DirectMetaProperty.ofImmutable(
        this, "strikePrice", OvernightFutureOption.class, Double.TYPE);
    /**
    ...
    private final MetaProperty<LocalDate> expiryDate = DirectMetaProperty.ofImmutable(
        this, "expiryDate", OvernightFutureOption.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<LocalTime> expiryTime = DirectMetaProperty.ofImmutable(
        this, "expiryTime", OvernightFutureOption.class, LocalTime.class);
    /**
    ...
    private final MetaProperty<ZoneId> expiryZone = DirectMetaProperty.ofImmutable(
        this, "expiryZone", OvernightFutureOption.class, ZoneId.class);
    /**
    ...
    private final MetaProperty<FutureOptionPremiumStyle> premiumStyle = DirectMetaProperty.ofImmutable(
        this, "premiumStyle", OvernightFutureOption.class, FutureOptionPremiumStyle.class);
    /**
    ...
    private final MetaProperty<Rounding> rounding = DirectMetaProperty.ofImmutable(
        this, "rounding", OvernightFutureOption.class, Rounding.class);
    /**
     * The meta-property for the {@code underlyingFuture} property.
     */
    private final MetaProperty<OvernightFuture> underlyingFuture = DirectMetaProperty.ofImmutable(
        this, "underlyingFuture", OvernightFutureOption.class, OvernightFuture.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public OvernightFutureOption.Builder builder() {
      return new OvernightFutureOption.Builder();
    }

    @Override
    public Class<? extends OvernightFutureOption> beanType() {
      return OvernightFutureOption.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<OvernightFuture> underlyingFuture() {
      return underlyingFuture;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1574023291:  // securityId
          return ((OvernightFutureOption) bean).getSecurityId();
        case -219971059:  // putCall
          return ((OvernightFutureOption) bean).getPutCall();
        case 50946231:  // strikePrice
          return ((OvernightFutureOption) bean).getStrikePrice();
        case -816738431:  // expiryDate
          return ((OvernightFutureOption) bean).getExpiryDate();
        case -816254304:  // expiryTime
          return ((OvernightFutureOption) bean).getExpiryTime();
        case -816069761:  // expiryZone
          return ((OvernightFutureOption) bean).getExpiryZone();
        case -1257652838:  // premiumStyle
          return ((OvernightFutureOption) bean).getPremiumStyle();
        case -142444:  // rounding
          return ((OvernightFutureOption) bean).getRounding();
        case -165476480:  // underlyingFuture
          return ((OvernightFutureOption) bean).getUnderlyingFuture();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code OvernightFutureOption}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<OvernightFutureOption> {
    ...
    private OvernightFuture underlyingFuture;
     ...
     */
    private Builder(OvernightFutureOption beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case -142444:  // rounding
          ...
          break;
        case -165476480:  // underlyingFuture
          this.underlyingFuture = (OvernightFuture) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
    ...
    @Override
    public OvernightFutureOption build() {
     ...
     * @return this, for chaining, not null
     */
    public Builder underlyingFuture(OvernightFuture underlyingFuture) {
      JodaBeanUtils.notNull(underlyingFuture, "underlyingFuture");
      this.underlyingFuture = underlyingFuture;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(320);
      buf.append("OvernightFutureOption.Builder{");
      buf.append("securityId").append('=').append(JodaBeanUtils.toString(securityId)).append(',').append(' ');
      buf.append("putCall").append('=').append(JodaBeanUtils.toString(putCall)).append(',').append(' ');
      buf.append("strikePrice").append('=').append(JodaBeanUtils.toString(strikePrice)).append(',').append(' ');
      buf.append("expiryDate").append('=').append(JodaBeanUtils.toString(expiryDate)).append(',').append(' ');
