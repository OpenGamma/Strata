...
public final class SecurityPriceInfo
   ...
   */
  private final double multiplier;  // derived, not a property
   ...
   * @return the security price information
   */
  public static SecurityPriceInfo of(double tickSize, CurrencyAmount tickValue, int contractSize) {
  ...
  private SecurityPriceInfo(
    ...
    this.multiplier = (tickValue.getAmount() * contractSize) / tickSize;
  }
