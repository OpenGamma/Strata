 ...
 * This is coherent with the pricing of {@link FixedCouponBond}. The bond futures delivery is a bond for a amount
 * computed from the bond future price, the conversion factor and the accrued interest.
 */
