...
public final class IborAveragedRateObservation
   ...
   * @return the averaged rate observation
   */
  public static IborAveragedRateObservation of(List<IborAveragedFixing> fixings) {
    return new IborAveragedRateObservation(fixings);
  }

  //-------------------------------------------------------------------------
  @ImmutableConstructor
  private IborAveragedRateObservation(List<IborAveragedFixing> fixings) {
    fixings.stream()
