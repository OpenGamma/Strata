 ...
 * <p>
 * A standard immutable implementation of {@link OvernightSwapIndex} that defines the swap trade template,
 * including the swap convention and tenor.
 * <p>
 * In most cases, applications should refer to indices by name, using {@link OvernightSwapIndex#of(String)}.
 * The named index will typically be resolved to an instance of this class.
 * As such, it is recommended to use the {@code OvernightSwapIndex} interface in application
 * code rather than directly referring to this class.
 */
@BeanDefinition
public final class ImmutableOvernightSwapIndex
    implements OvernightSwapIndex, ImmutableBean, Serializable {
  ...
  /**
   * The template for creating Fixed-Overnight swap.
   */
  @PropertyDefinition(validate = "notNull", overrideGet = true)
   ...
   * @return the index
   */
  public static ImmutableOvernightSwapIndex of(
      String name,
      LocalTime fixingTime,
      ZoneId fixingZone,
      FixedOvernightSwapTemplate template) {

    return new ImmutableOvernightSwapIndex(name, true, fixingTime, fixingZone, template);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof ImmutableOvernightSwapIndex) {
      return name.equals(((ImmutableOvernightSwapIndex) obj).name);
    }
    return false;
  }
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code ImmutableOvernightSwapIndex}.
   * @return the meta-bean, not null
   */
  public static ImmutableOvernightSwapIndex.Meta meta() {
    return ImmutableOvernightSwapIndex.Meta.INSTANCE;
  }

  static {
    MetaBean.register(ImmutableOvernightSwapIndex.Meta.INSTANCE);
  }
   ...
   */
  public static ImmutableOvernightSwapIndex.Builder builder() {
    return new ImmutableOvernightSwapIndex.Builder();
  }

  private ImmutableOvernightSwapIndex(
      String name,
      boolean active,
      LocalTime fixingTime,
      ZoneId fixingZone,
  ...
  @Override
  public ImmutableOvernightSwapIndex.Meta metaBean() {
    return ImmutableOvernightSwapIndex.Meta.INSTANCE;
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<LocalTime> fixingTime = DirectMetaProperty.ofImmutable(
        this, "fixingTime", ImmutableOvernightSwapIndex.class, LocalTime.class);
    /**
    ...
    private final MetaProperty<ZoneId> fixingZone = DirectMetaProperty.ofImmutable(
        this, "fixingZone", ImmutableOvernightSwapIndex.class, ZoneId.class);
    /**
     * The meta-property for the {@code template} property.
     */
    private final MetaProperty<FixedOvernightSwapTemplate> template = DirectMetaProperty.ofImmutable(
        this, "template", ImmutableOvernightSwapIndex.class, FixedOvernightSwapTemplate.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public ImmutableOvernightSwapIndex.Builder builder() {
      return new ImmutableOvernightSwapIndex.Builder();
    }

    @Override
    public Class<? extends ImmutableOvernightSwapIndex> beanType() {
      return ImmutableOvernightSwapIndex.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3373707:  // name
          return ((ImmutableOvernightSwapIndex) bean).getName();
        case -1422950650:  // active
          return ((ImmutableOvernightSwapIndex) bean).isActive();
        case 1255686170:  // fixingTime
          return ((ImmutableOvernightSwapIndex) bean).getFixingTime();
        case 1255870713:  // fixingZone
          return ((ImmutableOvernightSwapIndex) bean).getFixingZone();
        case -1321546630:  // template
          return ((ImmutableOvernightSwapIndex) bean).getTemplate();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code ImmutableOvernightSwapIndex}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<ImmutableOvernightSwapIndex> {
     ...
     */
    private Builder(ImmutableOvernightSwapIndex beanToCopy) {
    ...
    @Override
    public ImmutableOvernightSwapIndex build() {
      return new ImmutableOvernightSwapIndex(
          name,
          active,
          fixingTime,
          fixingZone,
    ...
    /**
     * Sets the template for creating Fixed-Overnight swap.
    ...
    public String toString() {
      ...
      buf.append("ImmutableOvernightSwapIndex.Builder{");
