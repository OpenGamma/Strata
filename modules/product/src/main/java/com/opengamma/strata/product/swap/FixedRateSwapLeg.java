...
/**
 * A fixed rate swap leg defined using a parameterized schedule and calculation.
 * <p>
 * This defines a single swap leg paying a fixed rate.
 * <p>
...
public final class FixedRateSwapLeg
    implements ParameterizedSwapLeg<FixedRateCalculation>, ImmutableBean, Serializable {
  ...
  /**
   * The fixed rate accrual calculation.
   * <p>
   * This defines the detail of the fixed rate calculation, including how the rate changes over time.
   */
  @PropertyDefinition(validate = "notNull", overrideGet = true)
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the fixed rate accrual calculation.
   * <p>
   * This defines the detail of the fixed rate calculation, including how the rate changes over time.
   * @return the value of the property, not null
   */
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PeriodicSchedule> accrualSchedule = DirectMetaProperty.ofImmutable(
        this, "accrualSchedule", FixedRateSwapLeg.class, PeriodicSchedule.class);
    /**
    ...
    private final MetaProperty<PaymentSchedule> paymentSchedule = DirectMetaProperty.ofImmutable(
        this, "paymentSchedule", FixedRateSwapLeg.class, PaymentSchedule.class);
    /**
    ...
    private final MetaProperty<NotionalSchedule> notionalSchedule = DirectMetaProperty.ofImmutable(
        this, "notionalSchedule", FixedRateSwapLeg.class, NotionalSchedule.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case 304659814:  // accrualSchedule
          return ((FixedRateSwapLeg) bean).getAccrualSchedule();
        case -1499086147:  // paymentSchedule
          return ((FixedRateSwapLeg) bean).getPaymentSchedule();
        case 1447860727:  // notionalSchedule
          return ((FixedRateSwapLeg) bean).getNotionalSchedule();
        case -934682935:  // calculation
          return ((FixedRateSwapLeg) bean).getCalculation();
        case 3575610:  // type
          return ((FixedRateSwapLeg) bean).getType();
        case -2129778896:  // startDate
          return ((FixedRateSwapLeg) bean).getStartDate();
        case -1607727319:  // endDate
          return ((FixedRateSwapLeg) bean).getEndDate();
        case 575402001:  // currency
          return ((FixedRateSwapLeg) bean).getCurrency();
      }
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<FixedRateSwapLeg> {
    ...
    /**
     * Sets the fixed rate accrual calculation.
     * <p>
     * This defines the detail of the fixed rate calculation, including how the rate changes over time.
