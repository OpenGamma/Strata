 ...
 * <p>
 * This is the resolved form of {@link OvernightFutureOption} and is an input to the pricers.
 * Applications will typically create a {@code ResolvedOvernightFutureOption} from a {@code OvernightFutureOption}
 * using {@link OvernightFutureOption#resolve(ReferenceData)}.
 * <p>
 * A {@code ResolvedOvernightFutureOption} is bound to data that changes over time, such as holiday calendars.
...
public final class ResolvedOvernightFutureOption
   ...
   */
  @PropertyDefinition(validate = "notNull")
  private final ResolvedOvernightFuture underlyingFuture;
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code ResolvedOvernightFutureOption}.
   * @return the meta-bean, not null
   */
  public static ResolvedOvernightFutureOption.Meta meta() {
    return ResolvedOvernightFutureOption.Meta.INSTANCE;
  }

  static {
    MetaBean.register(ResolvedOvernightFutureOption.Meta.INSTANCE);
  }
   ...
   */
  public static ResolvedOvernightFutureOption.Builder builder() {
    return new ResolvedOvernightFutureOption.Builder();
  }
  ...
  @Override
  public ResolvedOvernightFutureOption.Meta metaBean() {
    return ResolvedOvernightFutureOption.Meta.INSTANCE;
  }
   ...
   * @return the value of the property, not null
   */
  public ResolvedOvernightFuture getUnderlyingFuture() {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ResolvedOvernightFutureOption other = (ResolvedOvernightFutureOption) obj;
  ...
  public String toString() {
    ...
    buf.append("ResolvedOvernightFutureOption{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<SecurityId> securityId = DirectMetaProperty.ofImmutable(
        this, "securityId", ResolvedOvernightFutureOption.class, SecurityId.class);
    /**
     * The meta-property for the {@code putCall} property.
     */
    private final MetaProperty<PutCall> putCall = DirectMetaProperty.ofImmutable(
        this, "putCall", ResolvedOvernightFutureOption.class, PutCall.class);
    /**
    ...
    private final MetaProperty<Double> strikePrice = DirectMetaProperty.ofImmutable(
        this, "strikePrice", ResolvedOvernightFutureOption.class, Double.TYPE);
    /**
     * The meta-property for the {@code expiry} property.
     */
    private final MetaProperty<ZonedDateTime> expiry = DirectMetaProperty.ofImmutable(
        this, "expiry", ResolvedOvernightFutureOption.class, ZonedDateTime.class);
    /**
    ...
    private final MetaProperty<FutureOptionPremiumStyle> premiumStyle = DirectMetaProperty.ofImmutable(
        this, "premiumStyle", ResolvedOvernightFutureOption.class, FutureOptionPremiumStyle.class);
    /**
    ...
    private final MetaProperty<Rounding> rounding = DirectMetaProperty.ofImmutable(
        this, "rounding", ResolvedOvernightFutureOption.class, Rounding.class);
    /**
     * The meta-property for the {@code underlyingFuture} property.
     */
    private final MetaProperty<ResolvedOvernightFuture> underlyingFuture = DirectMetaProperty.ofImmutable(
        this, "underlyingFuture", ResolvedOvernightFutureOption.class, ResolvedOvernightFuture.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public ResolvedOvernightFutureOption.Builder builder() {
      return new ResolvedOvernightFutureOption.Builder();
    }

    @Override
    public Class<? extends ResolvedOvernightFutureOption> beanType() {
      return ResolvedOvernightFutureOption.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<ResolvedOvernightFuture> underlyingFuture() {
      return underlyingFuture;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1574023291:  // securityId
          return ((ResolvedOvernightFutureOption) bean).getSecurityId();
        case -219971059:  // putCall
          return ((ResolvedOvernightFutureOption) bean).getPutCall();
        case 50946231:  // strikePrice
          return ((ResolvedOvernightFutureOption) bean).getStrikePrice();
        case -1289159373:  // expiry
          return ((ResolvedOvernightFutureOption) bean).getExpiry();
        case -1257652838:  // premiumStyle
          return ((ResolvedOvernightFutureOption) bean).getPremiumStyle();
        case -142444:  // rounding
          return ((ResolvedOvernightFutureOption) bean).getRounding();
        case -165476480:  // underlyingFuture
          return ((ResolvedOvernightFutureOption) bean).getUnderlyingFuture();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code ResolvedOvernightFutureOption}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<ResolvedOvernightFutureOption> {
    ...
    private ResolvedOvernightFuture underlyingFuture;
     ...
     */
    private Builder(ResolvedOvernightFutureOption beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case -142444:  // rounding
          ...
          break;
        case -165476480:  // underlyingFuture
          this.underlyingFuture = (ResolvedOvernightFuture) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
    ...
    @Override
    public ResolvedOvernightFutureOption build() {
      return new ResolvedOvernightFutureOption(
          securityId,
          putCall,
          strikePrice,
          expiry,
     ...
     * @return this, for chaining, not null
     */
    public Builder underlyingFuture(ResolvedOvernightFuture underlyingFuture) {
      JodaBeanUtils.notNull(underlyingFuture, "underlyingFuture");
      this.underlyingFuture = underlyingFuture;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(256);
      buf.append("ResolvedOvernightFutureOption.Builder{");
      buf.append("securityId").append('=').append(JodaBeanUtils.toString(securityId)).append(',').append(' ');
      buf.append("putCall").append('=').append(JodaBeanUtils.toString(putCall)).append(',').append(' ');
      buf.append("strikePrice").append('=').append(JodaBeanUtils.toString(strikePrice)).append(',').append(' ');
      buf.append("expiry").append('=').append(JodaBeanUtils.toString(expiry)).append(',').append(' ');
