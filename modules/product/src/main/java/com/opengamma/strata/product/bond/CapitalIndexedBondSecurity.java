...
public final class CapitalIndexedBondSecurity
  ...
  @Override
  public CapitalIndexedBondTrade createTrade(TradeInfo tradeInfo, long quantity, double tradePrice, ReferenceData refData) {
    return new CapitalIndexedBondTrade(tradeInfo, createProduct(refData), quantity, tradePrice);
  }
