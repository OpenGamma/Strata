...
final class StandardIborFutureContractSpecs {
   ...
   * The 'GBP-LIBOR-3M-IMM-ICE' contract.
   * <p>
   * The ICE "L" contract based on serial monthly IMM dates.
   */
  public static final IborFutureContractSpec GBP_LIBOR_3M_IMM_ICE_SERIAL =
      ImmutableIborFutureContractSpec.builder()
          .name("GBP-LIBOR-3M-IMM-ICE-SERIAL")
          .index(GBP_LIBOR_3M)
  ...
  public static final IborFutureContractSpec EUR_EURIBOR_3M_IMM_ICE_SERIAL =
      ImmutableIborFutureContractSpec.builder()
          .name("EUR-EURIBOR-3M-IMM-ICE-SERIAL")
          .index(EUR_EURIBOR_3M)
          .dateSequence(MONTHLY_IMM)
          .notional(1_000_000d)
          .build();
  ...
  public static final IborFutureContractSpec USD_LIBOR_3M_IMM_CME_SERIAL =
      ImmutableIborFutureContractSpec.builder()
          .name("USD-LIBOR-3M-IMM-CME-SERIAL")
          .index(USD_LIBOR_3M)
          .dateSequence(MONTHLY_IMM)
          .notional(1_000_000d)
          .build();
