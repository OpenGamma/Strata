 ...
 * <p>
 * This defines almost all the data necessary to create a overnight-overnight cross-currency {@link SwapTrade}.
 ...
 */
@BeanDefinition
public final class XCcyOvernightOvernightSwapTemplate
   ...
   */
  @PropertyDefinition(validate = "notNull")
  private final XCcyOvernightOvernightSwapConvention convention;
   ...
   * @return the template
   */
  public static XCcyOvernightOvernightSwapTemplate of(Period periodToStart, 
      Tenor tenor,
      XCcyOvernightOvernightSwapConvention convention) {
    
    return XCcyOvernightOvernightSwapTemplate.builder()
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code XCcyOvernightOvernightSwapTemplate}.
   * @return the meta-bean, not null
   */
  public static XCcyOvernightOvernightSwapTemplate.Meta meta() {
    return XCcyOvernightOvernightSwapTemplate.Meta.INSTANCE;
  }

  static {
    MetaBean.register(XCcyOvernightOvernightSwapTemplate.Meta.INSTANCE);
  }
   ...
   */
  public static XCcyOvernightOvernightSwapTemplate.Builder builder() {
    return new XCcyOvernightOvernightSwapTemplate.Builder();
  }

  private XCcyOvernightOvernightSwapTemplate(
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      XCcyOvernightOvernightSwapTemplate other = (XCcyOvernightOvernightSwapTemplate) obj;
  ...
  public String toString() {
    ...
    buf.append("XCcyOvernightOvernightSwapTemplate{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Period> periodToStart = DirectMetaProperty.ofImmutable(
        this, "periodToStart", XCcyOvernightOvernightSwapTemplate.class, Period.class);
    /**
     * The meta-property for the {@code tenor} property.
     */
    private final MetaProperty<Tenor> tenor = DirectMetaProperty.ofImmutable(
        this, "tenor", XCcyOvernightOvernightSwapTemplate.class, Tenor.class);
    /**
     * The meta-property for the {@code convention} property.
     */
    private final MetaProperty<XCcyOvernightOvernightSwapConvention> convention = DirectMetaProperty.ofImmutable(
        this, "convention", XCcyOvernightOvernightSwapTemplate.class, XCcyOvernightOvernightSwapConvention.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public XCcyOvernightOvernightSwapTemplate.Builder builder() {
      return new XCcyOvernightOvernightSwapTemplate.Builder();
    }

    @Override
    public Class<? extends XCcyOvernightOvernightSwapTemplate> beanType() {
      return XCcyOvernightOvernightSwapTemplate.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<XCcyOvernightOvernightSwapConvention> convention() {
      return convention;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -574688858:  // periodToStart
          return ((XCcyOvernightOvernightSwapTemplate) bean).getPeriodToStart();
        case 110246592:  // tenor
          return ((XCcyOvernightOvernightSwapTemplate) bean).getTenor();
        case 2039569265:  // convention
          return ((XCcyOvernightOvernightSwapTemplate) bean).getConvention();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code XCcyOvernightOvernightSwapTemplate}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<XCcyOvernightOvernightSwapTemplate> {

    private Period periodToStart;
    private Tenor tenor;
    private XCcyOvernightOvernightSwapConvention convention;
     ...
     */
    private Builder(XCcyOvernightOvernightSwapTemplate beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case 110246592:  // tenor
          ...
          break;
        case 2039569265:  // convention
          this.convention = (XCcyOvernightOvernightSwapConvention) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
    ...
    @Override
    public XCcyOvernightOvernightSwapTemplate build() {
      return new XCcyOvernightOvernightSwapTemplate(
          periodToStart,
          tenor,
          convention);
    }
     ...
     * @return this, for chaining, not null
     */
    public Builder convention(XCcyOvernightOvernightSwapConvention convention) {
      JodaBeanUtils.notNull(convention, "convention");
      this.convention = convention;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("XCcyOvernightOvernightSwapTemplate.Builder{");
      buf.append("periodToStart").append('=').append(JodaBeanUtils.toString(periodToStart)).append(',').append(' ');
      buf.append("tenor").append('=').append(JodaBeanUtils.toString(tenor)).append(',').append(' ');
      buf.append("convention").append('=').append(JodaBeanUtils.toString(convention));
      buf.append('}');
