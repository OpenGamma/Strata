...
public final class FxDigitalOption
        implements Product, Resolvable<ResolvedFxDigitalOption>, ImmutableBean, Serializable {
    ...
    //-------------------------------------------------------------------------
    @Override
    public ResolvedFxDigitalOption resolve(ReferenceData refData) {
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<FxSingle> underlying = DirectMetaProperty.ofImmutable(
        this, "underlying", FxDigitalOption.class, FxSingle.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1770633379:  // underlying
          return ((FxDigitalOption) bean).getUnderlying();
      }
