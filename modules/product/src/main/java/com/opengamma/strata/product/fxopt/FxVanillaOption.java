...
public final class FxVanillaOption
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<FxVanillaOption> {
     ...
     * <p>
     * At expiry, the long party will have the option to enter in this transaction; the short party will, at the option
     * of the long party, potentially enter into the inverse transaction.
     *
