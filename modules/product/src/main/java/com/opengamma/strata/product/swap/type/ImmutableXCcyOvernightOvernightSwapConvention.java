 ...
 * <p>
 * This defines the market convention for a overnight-overnight cross-currency swap without reset.
 ...
 */
@BeanDefinition
public final class ImmutableXCcyOvernightOvernightSwapConvention
    implements XCcyOvernightOvernightSwapConvention, ImmutableBean, Serializable {
   ...
   */
  public static ImmutableXCcyOvernightOvernightSwapConvention of(
      String name,
      OvernightRateSwapLegConvention spreadLeg,
      OvernightRateSwapLegConvention flatLeg,
      DaysAdjustment spotDateOffset) {

    return new ImmutableXCcyOvernightOvernightSwapConvention(name, spreadLeg, flatLeg, spotDateOffset);
  }
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code ImmutableXCcyOvernightOvernightSwapConvention}.
   * @return the meta-bean, not null
   */
  public static ImmutableXCcyOvernightOvernightSwapConvention.Meta meta() {
    return ImmutableXCcyOvernightOvernightSwapConvention.Meta.INSTANCE;
  }

  static {
    MetaBean.register(ImmutableXCcyOvernightOvernightSwapConvention.Meta.INSTANCE);
  }
   ...
   */
  public static ImmutableXCcyOvernightOvernightSwapConvention.Builder builder() {
    return new ImmutableXCcyOvernightOvernightSwapConvention.Builder();
  }

  private ImmutableXCcyOvernightOvernightSwapConvention(
      String name,
      OvernightRateSwapLegConvention spreadLeg,
      OvernightRateSwapLegConvention flatLeg,
      DaysAdjustment spotDateOffset) {
  ...
  @Override
  public ImmutableXCcyOvernightOvernightSwapConvention.Meta metaBean() {
    return ImmutableXCcyOvernightOvernightSwapConvention.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ImmutableXCcyOvernightOvernightSwapConvention other = (ImmutableXCcyOvernightOvernightSwapConvention) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<String> name = DirectMetaProperty.ofImmutable(
        this, "name", ImmutableXCcyOvernightOvernightSwapConvention.class, String.class);
    /**
    ...
    private final MetaProperty<OvernightRateSwapLegConvention> spreadLeg = DirectMetaProperty.ofImmutable(
        this, "spreadLeg", ImmutableXCcyOvernightOvernightSwapConvention.class, OvernightRateSwapLegConvention.class);
    /**
    ...
    private final MetaProperty<OvernightRateSwapLegConvention> flatLeg = DirectMetaProperty.ofImmutable(
        this, "flatLeg", ImmutableXCcyOvernightOvernightSwapConvention.class, OvernightRateSwapLegConvention.class);
    /**
    ...
    private final MetaProperty<DaysAdjustment> spotDateOffset = DirectMetaProperty.ofImmutable(
        this, "spotDateOffset", ImmutableXCcyOvernightOvernightSwapConvention.class, DaysAdjustment.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public ImmutableXCcyOvernightOvernightSwapConvention.Builder builder() {
      return new ImmutableXCcyOvernightOvernightSwapConvention.Builder();
    }

    @Override
    public Class<? extends ImmutableXCcyOvernightOvernightSwapConvention> beanType() {
      return ImmutableXCcyOvernightOvernightSwapConvention.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3373707:  // name
          return ((ImmutableXCcyOvernightOvernightSwapConvention) bean).getName();
        case 1302781851:  // spreadLeg
          return ((ImmutableXCcyOvernightOvernightSwapConvention) bean).getSpreadLeg();
        case -778843179:  // flatLeg
          return ((ImmutableXCcyOvernightOvernightSwapConvention) bean).getFlatLeg();
        case 746995843:  // spotDateOffset
          return ((ImmutableXCcyOvernightOvernightSwapConvention) bean).getSpotDateOffset();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code ImmutableXCcyOvernightOvernightSwapConvention}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<ImmutableXCcyOvernightOvernightSwapConvention> {
     ...
     */
    private Builder(ImmutableXCcyOvernightOvernightSwapConvention beanToCopy) {
    ...
    @Override
    public ImmutableXCcyOvernightOvernightSwapConvention build() {
      return new ImmutableXCcyOvernightOvernightSwapConvention(
          name,
          spreadLeg,
          flatLeg,
          spotDateOffset);
    ...
    public String toString() {
      ...
      buf.append("ImmutableXCcyOvernightOvernightSwapConvention.Builder{");
