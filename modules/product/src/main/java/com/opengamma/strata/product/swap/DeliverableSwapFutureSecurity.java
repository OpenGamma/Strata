...
public final class DeliverableSwapFutureSecurity
  ...
  public DeliverableSwapFuture createProduct(ReferenceData refData) {
    ...
    return new DeliverableSwapFuture(getSecurityId(), notional, lastTradeDate, deliveryDate, underlyingSwap);
  }
  ...
  public DeliverableSwapFutureTrade createTrade(
    ...
    return new DeliverableSwapFutureTrade(tradeInfo, createProduct(refData), quantity, tradePrice);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<LocalDate> lastTradeDate = DirectMetaProperty.ofImmutable(
        this, "lastTradeDate", DeliverableSwapFutureSecurity.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<Swap> underlyingSwap = DirectMetaProperty.ofImmutable(
        this, "underlyingSwap", DeliverableSwapFutureSecurity.class, Swap.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1041950404:  // lastTradeDate
          return ((DeliverableSwapFutureSecurity) bean).getLastTradeDate();
        case 1497421456:  // underlyingSwap
          return ((DeliverableSwapFutureSecurity) bean).getUnderlyingSwap();
        case 575402001:  // currency
