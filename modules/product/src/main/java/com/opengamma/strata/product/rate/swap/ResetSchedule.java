...
public final class ResetSchedule
   ...
   * 
   * @param accrualPeriod  a single period in the accrual schedule
   * @param rollConvention  the applicable roll convention
   * @return the reset schedule
   */
  public Schedule createSchedule(SchedulePeriod accrualPeriod, RollConvention rollConvention) {
    return accrualPeriod.subSchedule(resetFrequency, rollConvention, StubConvention.SHORT_FINAL, businessDayAdjustment);
  }
