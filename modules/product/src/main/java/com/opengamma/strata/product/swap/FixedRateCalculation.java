...
public final class FixedRateCalculation
  ...
  /**
   * The method of accruing fixed interest, defaulted to 'Compounded'.
   * <p>
   * Two methods of accrual are supported - compounding and blah.
   */
  @PropertyDefinition(validate = "notNull")
  ...
  private static void applyDefaults(Builder builder) {
    builder.accrualMethod(FixedAccrualMethod.COMPOUNDED);
  }
  ...
  public ImmutableList<RateAccrualPeriod> createAccrualPeriods(
    ...
    for (int i = 0; i < accrualSchedule.size(); i++) {
      ...
      double simpleRate = getAccrualMethod().simpleRate(resolvedRates.get(i), yearFraction);
      // handle stubs
      RateComputation rateComputation;
      if (scheduleInitialStub.isPresent() && scheduleInitialStub.get() == period) {
        rateComputation = initialStub.createRateComputation(simpleRate);
      } else if (scheduleFinalStub.isPresent() && scheduleFinalStub.get() == period) {
        rateComputation = finalStub.createRateComputation(simpleRate);
      } else {
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the method of accruing fixed interest, defaulted to 'Compounded'.
   * <p>
   * Two methods of accrual are supported - compounding and blah.
   * @return the value of the property, not null
   */
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<FixedAccrualMethod> accrualMethod = DirectMetaProperty.ofImmutable(
        this, "accrualMethod", FixedRateCalculation.class, FixedAccrualMethod.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1335729296:  // accrualMethod
          return ((FixedRateCalculation) bean).getAccrualMethod();
      }
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<FixedRateCalculation> {
    ...
    /**
     * Sets the method of accruing fixed interest, defaulted to 'Compounded'.
     * <p>
     * Two methods of accrual are supported - compounding and blah.
