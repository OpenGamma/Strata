...
public final class ResolvedIborFuture
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<LocalDate> lastTradeDate = DirectMetaProperty.ofImmutable(
        this, "lastTradeDate", ResolvedIborFuture.class, LocalDate.class);
    /**
     * The meta-property for the {@code index} property.
     */
    private final MetaProperty<IborIndex> index = DirectMetaProperty.ofImmutable(
        this, "index", ResolvedIborFuture.class, IborIndex.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1041950404:  // lastTradeDate
          return ((ResolvedIborFuture) bean).getLastTradeDate();
        case 100346066:  // index
          return ((ResolvedIborFuture) bean).getIndex();
        case -142444:  // rounding
