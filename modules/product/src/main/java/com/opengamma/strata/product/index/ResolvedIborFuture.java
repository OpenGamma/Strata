...
public final class ResolvedIborFuture
  ...
  private static void preBuild(Builder builder) {
    if (builder.observation != null) {
      if (builder.accrualFactor == 0d && builder.observation.getIndex().getTenor().isMonthBased()) {
        builder.accrualFactor(builder.observation.getIndex().getTenor().getPeriod().toTotalMonths() / 12d);
      }
      if (builder.currency == null) {
        builder.currency = builder.observation.getIndex().getCurrency();
      }
    }
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<IborRateObservation> observation = DirectMetaProperty.ofImmutable(
        this, "observation", ResolvedIborFuture.class, IborRateObservation.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case 122345516:  // observation
          return ((ResolvedIborFuture) bean).getObservation();
        case -142444:  // rounding
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<ResolvedIborFuture> {
    ...
    /**
     * Sets the Ibor index observation.
     * <p>
     * The future is based on this index.
     * It will be a well known market index such as 'USD-LIBOR-3M'.
