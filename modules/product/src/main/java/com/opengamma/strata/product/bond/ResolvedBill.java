...
public final class ResolvedBill
  ...
  public ValueDerivatives priceFromYieldAd(double yield, LocalDate settlementDate) {
    double accrualFactor = dayCount.relativeYearFraction(settlementDate, notional.getDate());
    return yieldConvention.priceFromYieldAd(yield, accrualFactor);
  }
  ...
  public ValueDerivatives yieldFromPriceAd(double price, LocalDate settlementDate) {
    double accrualFactor = dayCount.relativeYearFraction(settlementDate, notional.getDate());
    return yieldConvention.yieldFromPriceAd(price, accrualFactor);
  }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<ResolvedBill> {
     ...
     */
    private Builder(ResolvedBill beanToCopy) {
