 ...
 * <p>
 * A position in an underlying {@link Bill}.
 * <p>
...
public final class BillPosition
    implements
    SecuritizedProductPosition<Bill>, Resolvable<ResolvedBillTrade>, ImmutableBean, Serializable {
   ...
   * @return the position
   */
  public static BillPosition ofLongShort(
  ...
  public ResolvedBillTrade resolve(ReferenceData refData) {
    ...
    return new ResolvedBillTrade(info, resolved, getQuantity(), null);
  }
  ...
  @Override
  public BillPosition.Meta metaBean() {
    return BillPosition.Meta.INSTANCE;
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PositionInfo> info = DirectMetaProperty.ofImmutable(
        this, "info", BillPosition.class, PositionInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<Bill> product = DirectMetaProperty.ofImmutable(
        this, "product", BillPosition.class, Bill.class);
    /**
    ...
    private final MetaProperty<Double> longQuantity = DirectMetaProperty.ofImmutable(
        this, "longQuantity", BillPosition.class, Double.TYPE);
    /**
    ...
    private final MetaProperty<Double> shortQuantity = DirectMetaProperty.ofImmutable(
        this, "shortQuantity", BillPosition.class, Double.TYPE);
    /**
     * The meta-property for the {@code quantity} property.
     */
    private final MetaProperty<Double> quantity = DirectMetaProperty.ofDerived(
        this, "quantity", BillPosition.class, Double.TYPE);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BillPosition.Builder builder() {
      return new BillPosition.Builder();
    }

    @Override
    public Class<? extends BillPosition> beanType() {
      return BillPosition.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3237038:  // info
          return ((BillPosition) bean).getInfo();
        case -309474065:  // product
          return ((BillPosition) bean).getProduct();
        case 611668775:  // longQuantity
          return ((BillPosition) bean).getLongQuantity();
        case -2094395097:  // shortQuantity
          return ((BillPosition) bean).getShortQuantity();
        case -1285004149:  // quantity
          return ((BillPosition) bean).getQuantity();
      }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<BillPosition> {
     ...
     */
    private Builder(BillPosition beanToCopy) {
