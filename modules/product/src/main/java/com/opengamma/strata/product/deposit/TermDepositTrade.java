...
public final class TermDepositTrade
    implements ProductTrade<TermDeposit>, Resolvable<ResolvedTermDepositTrade>, ImmutableBean, Serializable {
   ...
   * @return the trade
   */
  public static TermDepositTrade of(TradeInfo tradeInfo, TermDeposit product) {
    return new TermDepositTrade(tradeInfo, product);
  }
