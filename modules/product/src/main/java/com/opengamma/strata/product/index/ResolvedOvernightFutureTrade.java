 ...
 * <p>
 * This is the resolved form of {@link OvernightFutureTrade} and is the primary input to the pricers.
 * Applications will typically create a {@code ResolvedOvernightFutureTrade} from a {@code OvernightFutureTrade}
 * using {@link OvernightFutureTrade#resolve(ReferenceData)}.
 * <p>
...
public final class ResolvedOvernightFutureTrade
   ...
   */
  @PropertyDefinition(validate = "notNull", overrideGet = true)
  private final ResolvedOvernightFuture product;
  /**
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PortfolioItemInfo> info = DirectMetaProperty.ofImmutable(
        this, "info", ResolvedOvernightFutureTrade.class, PortfolioItemInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<ResolvedOvernightFuture> product = DirectMetaProperty.ofImmutable(
        this, "product", ResolvedOvernightFutureTrade.class, ResolvedOvernightFuture.class);
    /**
     * The meta-property for the {@code quantity} property.
     */
    private final MetaProperty<Double> quantity = DirectMetaProperty.ofImmutable(
        this, "quantity", ResolvedOvernightFutureTrade.class, Double.TYPE);
    /**
    ...
    private final MetaProperty<TradedPrice> tradedPrice = DirectMetaProperty.ofImmutable(
        this, "tradedPrice", ResolvedOvernightFutureTrade.class, TradedPrice.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public ResolvedOvernightFutureTrade.Builder builder() {
      return new ResolvedOvernightFutureTrade.Builder();
    }

    @Override
    public Class<? extends ResolvedOvernightFutureTrade> beanType() {
      return ResolvedOvernightFutureTrade.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3237038:  // info
          return ((ResolvedOvernightFutureTrade) bean).getInfo();
        case -309474065:  // product
          return ((ResolvedOvernightFutureTrade) bean).getProduct();
        case -1285004149:  // quantity
          return ((ResolvedOvernightFutureTrade) bean).getQuantity();
        case -1873824343:  // tradedPrice
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<ResolvedOvernightFutureTrade> {

    private PortfolioItemInfo info;
    private ResolvedOvernightFuture product;
     ...
     */
    private Builder(ResolvedOvernightFutureTrade beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case 3237038:  // info
          ...
          break;
        case -309474065:  // product
          this.product = (ResolvedOvernightFuture) newValue;
          break;
        case -1285004149:  // quantity
    ...
    public ResolvedOvernightFutureTrade build() {
      return new ResolvedOvernightFutureTrade(
          info,
          product,
          quantity,
          tradedPrice);
