 ...
 */
@BeanDefinition
public final class OvernightCompoundedRateObservation
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code OvernightCompoundedRateObservation}.
   * @return the meta-bean, not null
   */
  public static OvernightCompoundedRateObservation.Meta meta() {
    return OvernightCompoundedRateObservation.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(OvernightCompoundedRateObservation.Meta.INSTANCE);
  }
   ...
   */
  public static OvernightCompoundedRateObservation.Builder builder() {
    return new OvernightCompoundedRateObservation.Builder();
  }
  ...
  @Override
  public OvernightCompoundedRateObservation.Meta metaBean() {
    return OvernightCompoundedRateObservation.Meta.INSTANCE;
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<LocalDate> startDate = DirectMetaProperty.ofImmutable(
        this, "startDate", OvernightCompoundedRateObservation.class, LocalDate.class);
    /**
     * The meta-property for the {@code endDate} property.
     */
    private final MetaProperty<LocalDate> endDate = DirectMetaProperty.ofImmutable(
        this, "endDate", OvernightCompoundedRateObservation.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<Integer> rateCutOffDays = DirectMetaProperty.ofImmutable(
        this, "rateCutOffDays", OvernightCompoundedRateObservation.class, Integer.TYPE);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public OvernightCompoundedRateObservation.Builder builder() {
      return new OvernightCompoundedRateObservation.Builder();
    }

    @Override
    public Class<? extends OvernightCompoundedRateObservation> beanType() {
      return OvernightCompoundedRateObservation.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1607727319:  // endDate
          return ((OvernightCompoundedRateObservation) bean).getEndDate();
        case -92095804:  // rateCutOffDays
          return ((OvernightCompoundedRateObservation) bean).getRateCutOffDays();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code OvernightCompoundedRateObservation}.
   */
