...
public final class ImmutableOvernightOvernightSwapConvention
  ...
  public static ImmutableOvernightOvernightSwapConvention of(
    ...
    DaysAdjustment spotOffset = DaysAdjustment.ofBusinessDays(
        spreadLeg.getIndex().getEffectiveDateOffset(), spreadLeg.getIndex().getFixingCalendar());
    return of(name, spreadLeg, flatLeg, spotOffset);
  }
