 ...
 * <p>
 * This defines almost all the data necessary to create a Overnight-Overnight single currency {@link SwapTrade}.
...
public final class OvernightOvernightSwapTemplate
   ...
   * @return the template
   */
  public static OvernightOvernightSwapTemplate of(Period periodToStart, Tenor tenor,
