 ...
 */
@BeanDefinition
public final class GenericFutureTrade
    implements SecurityTrade<GenericFuture>, ImmutableBean, Serializable {
  ...
  private final SecurityLink<GenericFuture> securityLink;
  /**
  ...
  //-------------------------------------------------------------------------
  @Override
  public GenericFutureTrade resolveLinks(LinkResolver resolver) {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code GenericFutureTrade}.
   * @return the meta-bean, not null
   */
  public static GenericFutureTrade.Meta meta() {
    return GenericFutureTrade.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(GenericFutureTrade.Meta.INSTANCE);
  }
   ...
   */
  public static GenericFutureTrade.Builder builder() {
    return new GenericFutureTrade.Builder();
  }

  private GenericFutureTrade(
      TradeInfo tradeInfo,
      SecurityLink<GenericFuture> securityLink,
      long quantity,
      double initialPrice) {
  ...
  @Override
  public GenericFutureTrade.Meta metaBean() {
    return GenericFutureTrade.Meta.INSTANCE;
  }
   ...
   */
  @Override
  public SecurityLink<GenericFuture> getSecurityLink() {
    return securityLink;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      GenericFutureTrade other = (GenericFutureTrade) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<TradeInfo> tradeInfo = DirectMetaProperty.ofImmutable(
        this, "tradeInfo", GenericFutureTrade.class, TradeInfo.class);
    /**
     * The meta-property for the {@code securityLink} property.
     */
    @SuppressWarnings({"unchecked", "rawtypes" })
    private final MetaProperty<SecurityLink<GenericFuture>> securityLink = DirectMetaProperty.ofImmutable(
        this, "securityLink", GenericFutureTrade.class, (Class) SecurityLink.class);
    /**
     * The meta-property for the {@code quantity} property.
     */
    private final MetaProperty<Long> quantity = DirectMetaProperty.ofImmutable(
        this, "quantity", GenericFutureTrade.class, Long.TYPE);
    /**
    ...
    private final MetaProperty<Double> initialPrice = DirectMetaProperty.ofImmutable(
        this, "initialPrice", GenericFutureTrade.class, Double.TYPE);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public GenericFutureTrade.Builder builder() {
      return new GenericFutureTrade.Builder();
    }

    @Override
    public Class<? extends GenericFutureTrade> beanType() {
      return GenericFutureTrade.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<SecurityLink<GenericFuture>> securityLink() {
      return securityLink;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 752580658:  // tradeInfo
          return ((GenericFutureTrade) bean).getTradeInfo();
        case 807992154:  // securityLink
          return ((GenericFutureTrade) bean).getSecurityLink();
        case -1285004149:  // quantity
          return ((GenericFutureTrade) bean).getQuantity();
        case -423406491:  // initialPrice
          return ((GenericFutureTrade) bean).getInitialPrice();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code GenericFutureTrade}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<GenericFutureTrade> {

    private TradeInfo tradeInfo;
    private SecurityLink<GenericFuture> securityLink;
     ...
     */
    private Builder(GenericFutureTrade beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case 752580658:  // tradeInfo
          ...
          break;
        case 807992154:  // securityLink
          this.securityLink = (SecurityLink<GenericFuture>) newValue;
          break;
        case -1285004149:  // quantity
    ...
    @Override
    public GenericFutureTrade build() {
      return new GenericFutureTrade(
          tradeInfo,
          securityLink,
          quantity,
          initialPrice);
     ...
     * @return this, for chaining, not null
     */
    public Builder securityLink(SecurityLink<GenericFuture> securityLink) {
      JodaBeanUtils.notNull(securityLink, "securityLink");
      this.securityLink = securityLink;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(160);
      buf.append("GenericFutureTrade.Builder{");
