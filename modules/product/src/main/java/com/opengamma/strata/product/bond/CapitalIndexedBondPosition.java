 ...
 * <p>
 * A position in an underlying {@link CapitalIndexedBond}.
 * <p>
...
public final class CapitalIndexedBondPosition
    implements
    SecuritizedProductPosition<CapitalIndexedBond>, Resolvable<ResolvedCapitalIndexedBondTrade>, ImmutableBean, Serializable {
   ...
   * @return the position
   */
  public static CapitalIndexedBondPosition ofLongShort(
  ...
  public ResolvedCapitalIndexedBondTrade resolve(ReferenceData refData) {
    ...
    return new ResolvedCapitalIndexedBondTrade(info, resolved, getQuantity(), null);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PositionInfo> info = DirectMetaProperty.ofImmutable(
        this, "info", CapitalIndexedBondPosition.class, PositionInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<CapitalIndexedBond> product = DirectMetaProperty.ofImmutable(
        this, "product", CapitalIndexedBondPosition.class, CapitalIndexedBond.class);
    /**
    ...
    private final MetaProperty<Double> longQuantity = DirectMetaProperty.ofImmutable(
        this, "longQuantity", CapitalIndexedBondPosition.class, Double.TYPE);
    /**
    ...
    private final MetaProperty<Double> shortQuantity = DirectMetaProperty.ofImmutable(
        this, "shortQuantity", CapitalIndexedBondPosition.class, Double.TYPE);
    /**
     * The meta-property for the {@code quantity} property.
     */
    private final MetaProperty<Double> quantity = DirectMetaProperty.ofDerived(
        this, "quantity", CapitalIndexedBondPosition.class, Double.TYPE);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public CapitalIndexedBondPosition.Builder builder() {
      return new CapitalIndexedBondPosition.Builder();
    }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<CapitalIndexedBondPosition> {
    ...
    public CapitalIndexedBondPosition build() {
      return new CapitalIndexedBondPosition(
          info,
          product,
          longQuantity,
          shortQuantity);
