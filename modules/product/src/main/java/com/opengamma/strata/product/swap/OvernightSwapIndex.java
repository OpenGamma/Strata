 ...
 * A swap index.
 * <p>
 * Swap rates for Fixed Overnight swaps. The index is typically used in cash settled swaptions and CMS.
 * <p>
 * The most common implementations are provided in {@link OvernightSwapIndices}.
 * <p>
 * All implementations of this interface must be immutable and thread-safe.
 */
public interface OvernightSwapIndex
    extends Index, Named {
   ...
   */
  @FromString
  public static OvernightSwapIndex of(String uniqueName) {
   ...
   */
  public static ExtendedEnum<OvernightSwapIndex> extendedEnum() {
    return OvernightSwapIndices.ENUM_LOOKUP;
  }
  ...
  /**
   * Gets the template for creating Fixed-Overnight swap.
   * 
   * @return the template
   */
  public abstract FixedOvernightSwapTemplate getTemplate();
