...
public final class ResolvedSwaptionTrade
   ...
   */
  public static ResolvedSwaptionTrade of(TradeInfo tradeInfo, ResolvedSwaption product, Payment premium) {
    return new ResolvedSwaptionTrade(tradeInfo, product, premium);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<TradeInfo> tradeInfo = DirectMetaProperty.ofImmutable(
        this, "tradeInfo", ResolvedSwaptionTrade.class, TradeInfo.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 752580658:  // tradeInfo
          return ((ResolvedSwaptionTrade) bean).getTradeInfo();
        case -309474065:  // product
