 ...
 * <p>
 * A position in an underlying {@link BondFutureOption}.
 * <p>
 ...
 * This is coherent with the pricing of {@link BondFutureOption}.
 */
@BeanDefinition(constructorScope = "package")
public final class BondFutureOptionPosition
    implements
    SecuritizedProductPosition<BondFutureOption>, Resolvable<ResolvedBondFutureOptionTrade>, ImmutableBean, Serializable {
   ...
   * @return the position
   */
  public static BondFutureOptionPosition ofLongShort(
  ...
  public BondFutureOptionPosition withInfo(PortfolioItemInfo info) {
    return new BondFutureOptionPosition(PositionInfo.empty().combinedWith(info), product, longQuantity, shortQuantity);
  }
  ...
  public ResolvedBondFutureOptionTrade resolve(ReferenceData refData) {
    ...
    return new ResolvedBondFutureOptionTrade(info, resolved, getQuantity(), null);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PositionInfo> info = DirectMetaProperty.ofImmutable(
        this, "info", BondFutureOptionPosition.class, PositionInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<BondFutureOption> product = DirectMetaProperty.ofImmutable(
        this, "product", BondFutureOptionPosition.class, BondFutureOption.class);
    /**
    ...
    private final MetaProperty<Double> longQuantity = DirectMetaProperty.ofImmutable(
        this, "longQuantity", BondFutureOptionPosition.class, Double.TYPE);
    /**
    ...
    private final MetaProperty<Double> shortQuantity = DirectMetaProperty.ofImmutable(
        this, "shortQuantity", BondFutureOptionPosition.class, Double.TYPE);
    /**
     * The meta-property for the {@code quantity} property.
     */
    private final MetaProperty<Double> quantity = DirectMetaProperty.ofDerived(
        this, "quantity", BondFutureOptionPosition.class, Double.TYPE);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BondFutureOptionPosition.Builder builder() {
      return new BondFutureOptionPosition.Builder();
    }

    @Override
    public Class<? extends BondFutureOptionPosition> beanType() {
      return BondFutureOptionPosition.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3237038:  // info
          return ((BondFutureOptionPosition) bean).getInfo();
        case -309474065:  // product
          return ((BondFutureOptionPosition) bean).getProduct();
        case 611668775:  // longQuantity
          return ((BondFutureOptionPosition) bean).getLongQuantity();
        case -2094395097:  // shortQuantity
          return ((BondFutureOptionPosition) bean).getShortQuantity();
        case -1285004149:  // quantity
          return ((BondFutureOptionPosition) bean).getQuantity();
      }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<BondFutureOptionPosition> {
     ...
     */
    private Builder(BondFutureOptionPosition beanToCopy) {
    ...
    public BondFutureOptionPosition build() {
      return new BondFutureOptionPosition(
          info,
          product,
          longQuantity,
          shortQuantity);
