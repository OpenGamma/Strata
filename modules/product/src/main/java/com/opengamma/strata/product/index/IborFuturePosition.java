 ...
 * <p>
 * A position in an underlying {@link IborFuture}.
 * <p>
...
public final class IborFuturePosition
   ...
   * @return the position
   */
  public static IborFuturePosition ofLongShort(
  ...
  public ResolvedIborFutureTrade resolve(ReferenceData refData) {
    ...
    return new ResolvedIborFutureTrade(info, resolved, getQuantity(), null);
  }
  ...
  @Override
  public IborFuturePosition.Meta metaBean() {
    return IborFuturePosition.Meta.INSTANCE;
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PositionInfo> info = DirectMetaProperty.ofImmutable(
        this, "info", IborFuturePosition.class, PositionInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<IborFuture> product = DirectMetaProperty.ofImmutable(
        this, "product", IborFuturePosition.class, IborFuture.class);
    /**
    ...
    private final MetaProperty<Double> longQuantity = DirectMetaProperty.ofImmutable(
        this, "longQuantity", IborFuturePosition.class, Double.TYPE);
    /**
    ...
    private final MetaProperty<Double> shortQuantity = DirectMetaProperty.ofImmutable(
        this, "shortQuantity", IborFuturePosition.class, Double.TYPE);
    /**
     * The meta-property for the {@code quantity} property.
     */
    private final MetaProperty<Double> quantity = DirectMetaProperty.ofDerived(
        this, "quantity", IborFuturePosition.class, Double.TYPE);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public IborFuturePosition.Builder builder() {
      return new IborFuturePosition.Builder();
    }

    @Override
    public Class<? extends IborFuturePosition> beanType() {
      return IborFuturePosition.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3237038:  // info
          return ((IborFuturePosition) bean).getInfo();
        case -309474065:  // product
          return ((IborFuturePosition) bean).getProduct();
        case 611668775:  // longQuantity
          return ((IborFuturePosition) bean).getLongQuantity();
        case -2094395097:  // shortQuantity
          return ((IborFuturePosition) bean).getShortQuantity();
        case -1285004149:  // quantity
          return ((IborFuturePosition) bean).getQuantity();
      }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<IborFuturePosition> {
     ...
     */
    private Builder(IborFuturePosition beanToCopy) {
