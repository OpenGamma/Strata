...
public final class InflationEndMonthRateObservation
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PriceIndex> index = DirectMetaProperty.ofImmutable(
        this, "index", InflationEndMonthRateObservation.class, PriceIndex.class);
    /**
    ...
    private final MetaProperty<YearMonth> referenceEndMonth = DirectMetaProperty.ofImmutable(
        this, "referenceEndMonth", InflationEndMonthRateObservation.class, YearMonth.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 100346066:  // index
          return ((InflationEndMonthRateObservation) bean).getIndex();
        case -1656407615:  // startIndexValue
          return ((InflationEndMonthRateObservation) bean).getStartIndexValue();
        case 1861034704:  // referenceEndMonth
          return ((InflationEndMonthRateObservation) bean).getReferenceEndMonth();
      }
