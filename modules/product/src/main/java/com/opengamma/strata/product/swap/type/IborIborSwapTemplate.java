...
public final class IborIborSwapTemplate
   ...
   * @return the trade
   */
  public SwapTrade toTrade(LocalDate tradeDate, BuySell buySell, double notional, double spread) {
    return convention.toTrade(tradeDate, periodToStart, tenor, buySell, notional, spread);
  }
