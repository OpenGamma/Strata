...
public final class EtdContractSpec
   ...
   */
  public EtdFutureSecurity createFuture(YearMonth expiryMonth, EtdStyle style) {
    return EtdFutureSecurity.of(this, expiryMonth, style);
  }
  ...
  public EtdOptionSecurity createOption(
    ...
    return EtdOptionSecurity.of(this, expiryMonth, style, version, putCall, strikePrice);
  }
