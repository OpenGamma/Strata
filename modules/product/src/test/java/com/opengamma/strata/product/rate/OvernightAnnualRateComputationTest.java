 ...
 */
@Test
public class OvernightAnnualRateComputationTest {
  
  private static final ReferenceData REF_DATA = ReferenceData.standard();
  
  public void test_of() {
    OvernightAnnualRateComputation test = OvernightAnnualRateComputation.of(
  ...
  public void test_of_badDateOrder() {
    assertThrowsIllegalArg(() -> OvernightAnnualRateComputation.of(
  ...
  public void test_calculate() {
    OvernightAnnualRateComputation test =
        OvernightAnnualRateComputation.of(BRL_CDI, date(2016, 2, 24), date(2016, 3, 24), REF_DATA);
    assertEquals(
  ...
  public void test_observeOn() {
    OvernightAnnualRateComputation test =
        OvernightAnnualRateComputation.of(USD_FED_FUND, date(2016, 2, 24), date(2016, 3, 24), REF_DATA);
  ...
  public void coverage() {
    ...
    OvernightAnnualRateComputation test2 =
        OvernightAnnualRateComputation.of(BRL_CDI, date(2014, 6, 3), date(2014, 7, 3), REF_DATA);
