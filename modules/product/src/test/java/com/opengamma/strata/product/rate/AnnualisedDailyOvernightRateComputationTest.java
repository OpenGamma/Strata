 ...
 */
@Test
public class AnnualisedDailyOvernightRateComputationTest {
  
  private static final ReferenceData REF_DATA = ReferenceData.standard();
  
  public void test_of() {
    AnnualisedDailyOvernightRateComputation test = AnnualisedDailyOvernightRateComputation.of(
  ...
  public void test_of_badDateOrder() {
    assertThrowsIllegalArg(() -> AnnualisedDailyOvernightRateComputation.of(
  ...
  public void test_calculate() {
    AnnualisedDailyOvernightRateComputation test =
        AnnualisedDailyOvernightRateComputation.of(BRL_CDI, date(2016, 2, 24), date(2016, 3, 24), REF_DATA);
    assertEquals(
  ...
  public void test_observeOn() {
    AnnualisedDailyOvernightRateComputation test =
        AnnualisedDailyOvernightRateComputation.of(USD_FED_FUND, date(2016, 2, 24), date(2016, 3, 24), REF_DATA);
  ...
  public void coverage() {
    ...
    AnnualisedDailyOvernightRateComputation test2 =
        AnnualisedDailyOvernightRateComputation.of(BRL_CDI, date(2014, 6, 3), date(2014, 7, 3), REF_DATA);
