...
public class CdsImmDateLogicTest {
  ...
  public void onImmDateTest() {
    ...
    LocalDate prevIMM = CdsImmDateLogic.getPrevIMMDate(today);
    assertEquals(prevIMM, LocalDate.of(2012, Month.DECEMBER, 20));

    today = LocalDate.of(2017, Month.JUNE, 20);
    prevIMM = CdsImmDateLogic.getPrevIMMDate(today);
  ...
  public void prevImmTest() {
    ...
    prevIMM = CdsImmDateLogic.getPrevIMMDate(CdsImmDateLogic.getPrevIMMDate(prevIMM));
