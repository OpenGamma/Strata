 ...
 */
@Test
public class CompoundedDailyOvernightRateComputationTest {
  
  private static final ReferenceData REF_DATA = ReferenceData.standard();
  
  public void test_of() {
    CompoundedDailyOvernightRateComputation test = CompoundedDailyOvernightRateComputation.of(
  ...
  public void test_of_badDateOrder() {
    assertThrowsIllegalArg(() -> CompoundedDailyOvernightRateComputation.of(
  ...
  public void test_calculate() {
    CompoundedDailyOvernightRateComputation test =
        CompoundedDailyOvernightRateComputation.of(BRL_CDI, date(2016, 2, 24), date(2016, 3, 24), REF_DATA);
    assertEquals(
  ...
  public void test_observeOn() {
    CompoundedDailyOvernightRateComputation test =
        CompoundedDailyOvernightRateComputation.of(USD_FED_FUND, date(2016, 2, 24), date(2016, 3, 24), REF_DATA);
  ...
  public void coverage() {
    ...
    CompoundedDailyOvernightRateComputation test2 =
        CompoundedDailyOvernightRateComputation.of(BRL_CDI, date(2014, 6, 3), date(2014, 7, 3), REF_DATA);
