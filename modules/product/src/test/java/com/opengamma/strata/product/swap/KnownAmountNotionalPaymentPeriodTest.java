...
/**
 * Test {@link KnownAmountNotionalPaymentPeriod}.
 */
@Test
public class KnownAmountNotionalPaymentPeriodTest {
  ...
  public void test_of() {
    ...
    KnownAmountNotionalPaymentPeriod test = KnownAmountNotionalPaymentPeriod.of(PAYMENT_2014_10_03, sched, GBP_P50000);
  ...
  public void test_of_fxReset() {
    SchedulePeriod sched = SchedulePeriod.of(DATE_2014_03_30, DATE_2014_09_30);
    KnownAmountNotionalPaymentPeriod test = KnownAmountNotionalPaymentPeriod.of(
  ...
  public void test_builder_defaultDates() {
    KnownAmountNotionalPaymentPeriod test = KnownAmountNotionalPaymentPeriod.builder()
  ...
  public void test_builder_invalid() {
    assertThrowsIllegalArg(() -> KnownAmountNotionalPaymentPeriod.builder()
        .payment(PAYMENT_2014_10_03)
        .endDate(DATE_2014_10_01)
  ...
  public void test_adjustPaymentDate() {
    KnownAmountNotionalPaymentPeriod test = KnownAmountNotionalPaymentPeriod.builder()
        ...
        .notionalAmount(GBP_P50000)
        .build();
    KnownAmountNotionalPaymentPeriod expected = KnownAmountNotionalPaymentPeriod.builder()
        .payment(PAYMENT_2014_10_03)
        .startDate(DATE_2014_03_30)
        .unadjustedStartDate(DATE_2014_03_30)
        .endDate(DATE_2014_10_01)
  ...
  public void coverage() {
    ...
    KnownAmountNotionalPaymentPeriod test2 = KnownAmountNotionalPaymentPeriod.builder()
