...
public class ResolvedFxBinaryOptionTest {
  ...
  private static final Payment FX_PAYMENT = Payment.of(USD_AMOUNT, PAYMENT_DATE);
  ...
  static ResolvedFxBinaryOption sut2() {
    ...
    return ResolvedFxBinaryOption.builder()
        ...
        .index(fxRate)
        .paymentCurrencyAmount(Payment.of(CurrencyAmount.of(GBP, NOTIONAL), PAYMENT_DATE))
        .putCall(PutCall.PUT)
        .strike(fxStrike)
        .build();
  }
