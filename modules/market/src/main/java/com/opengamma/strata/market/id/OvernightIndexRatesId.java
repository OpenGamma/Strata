...
public final class OvernightIndexRatesId
    implements MarketDataId<OvernightIndexRates>, ImmutableBean, Serializable {
   ...
   * @return an ID that identifies the Overnight rates for the specified index
   */
  public static OvernightIndexRatesId of(OvernightIndex index, CurveGroupName curveGroupName, MarketDataFeed marketDataFeed) {
    return new OvernightIndexRatesId(index, curveGroupName, marketDataFeed);
  }
  ...
  @Override
  public OvernightIndexRatesKey toMarketDataKey() {
    return OvernightIndexRatesKey.of(index);
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code OvernightIndexRatesId}.
   * @return the meta-bean, not null
   */
  public static OvernightIndexRatesId.Meta meta() {
    return OvernightIndexRatesId.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(OvernightIndexRatesId.Meta.INSTANCE);
  }
  ...
  @Override
  public OvernightIndexRatesId.Meta metaBean() {
    return OvernightIndexRatesId.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      OvernightIndexRatesId other = (OvernightIndexRatesId) obj;
  ...
  public String toString() {
    ...
    buf.append("OvernightIndexRatesId{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<OvernightIndex> index = DirectMetaProperty.ofImmutable(
        this, "index", OvernightIndexRatesId.class, OvernightIndex.class);
    /**
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", OvernightIndexRatesId.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<MarketDataFeed> marketDataFeed = DirectMetaProperty.ofImmutable(
        this, "marketDataFeed", OvernightIndexRatesId.class, MarketDataFeed.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends OvernightIndexRatesId> builder() {
      return new OvernightIndexRatesId.Builder();
    }

    @Override
    public Class<? extends OvernightIndexRatesId> beanType() {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 100346066:  // index
          return ((OvernightIndexRatesId) bean).getIndex();
        case -382645893:  // curveGroupName
          return ((OvernightIndexRatesId) bean).getCurveGroupName();
        case 842621124:  // marketDataFeed
          return ((OvernightIndexRatesId) bean).getMarketDataFeed();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code OvernightIndexRatesId}.
   */
  private static final class Builder extends DirectFieldsBeanBuilder<OvernightIndexRatesId> {
    ...
    @Override
    public OvernightIndexRatesId build() {
      return new OvernightIndexRatesId(
          index,
          curveGroupName,
          marketDataFeed);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("OvernightIndexRatesId.Builder{");
