 ...
 */
public interface DiscountFactorCurve {
   ...
   */
  DiscountFactorCurve shiftedBy(DoubleBinaryOperator operator);
   ...
   * @return the new curve
   */
  DiscountFactorCurve shiftedBy(List<ValueAdjustment> adjustments);
