...
public final class ParRatesId
  ...
  @Override
  public Class<ParRates> getMarketDataType() {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code ParRatesId}.
   * @return the meta-bean, not null
   */
  public static ParRatesId.Meta meta() {
    return ParRatesId.Meta.INSTANCE;
  }
  ...
  @Override
  public ParRatesId.Meta metaBean() {
    return ParRatesId.Meta.INSTANCE;
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<MarketDataFeed> marketDataFeed = DirectMetaProperty.ofImmutable(
        this, "marketDataFeed", ParRatesId.class, MarketDataFeed.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public Class<? extends ParRatesId> beanType() {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -382645893:  // curveGroupName
          return ((ParRatesId) bean).getCurveGroupName();
        case 771153946:  // curveName
          return ((ParRatesId) bean).getCurveName();
        case 842621124:  // marketDataFeed
          return ((ParRatesId) bean).getMarketDataFeed();
      }
  ...
  private static final class Builder extends DirectFieldsBeanBuilder<ParRatesId> {
    ...
    @Override
    public ParRatesId build() {
      return new ParRatesId(
          curveGroupName,
          curveName,
          marketDataFeed);
    }
