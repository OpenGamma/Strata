...
final class NaturalSplineCurveInterpolator
   ...
   */
  public static final String NAME = "NaturalSplineCurveInterpolator";
  /**
  ...
  static class Bound extends AbstractBoundCurveInterpolator {
    ...
    Bound(DoubleArray xValues, DoubleArray yValues) {
      ...
      this.poly = new NaturalSplineInterpolator().interpolateWithSensitivity(xValues.toArray(), yValues.toArray());
