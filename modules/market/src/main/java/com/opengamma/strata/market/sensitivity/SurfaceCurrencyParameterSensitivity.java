...
public final class SurfaceCurrencyParameterSensitivity
   ...
   */
  public static SurfaceCurrencyParameterSensitivity of(SurfaceMetadata metadata, Currency currency, double[] sensitivity) {
   ...
   */
  public SurfaceCurrencyParameterSensitivity withSensitivity(double[] sensitivity) {
    ...
    return new SurfaceCurrencyParameterSensitivity(metadata, currency, sensitivity.clone());
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<double[]> sensitivity = DirectMetaProperty.ofImmutable(
        this, "sensitivity", SurfaceCurrencyParameterSensitivity.class, double[].class);
    /**
     * The meta-properties.
     */
