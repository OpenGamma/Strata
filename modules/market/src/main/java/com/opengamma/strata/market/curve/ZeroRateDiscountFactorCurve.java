...
public final class ZeroRateDiscountFactorCurve
    implements DiscountFactorCurve, ImmutableBean, Serializable {
   ...
   * @return the curve
   */
  public static ZeroRateDiscountFactorCurve of(
      Currency currency,
      LocalDate valuationDate,
      DayCount dayCount,
      YieldCurve underlyingCurve) {

    return new ZeroRateDiscountFactorCurve(currency, valuationDate, dayCount, underlyingCurve);
  }
  ...
  @Override
  public ZeroRateDiscountFactorCurve shiftedBy(DoubleBinaryOperator operator) {
    ...
    return new ZeroRateDiscountFactorCurve(
        currency, valuationDate, dayCount, YieldCurve.from(shifted));
  }

  @Override
  public ZeroRateDiscountFactorCurve shiftedBy(List<ValueAdjustment> adjustments) {
    InterpolatedDoublesCurve underlying = (InterpolatedDoublesCurve) ((YieldCurve) curve).getCurve();
    double[] x = underlying.getXDataAsPrimitive();
    double[] y = underlying.getYDataAsPrimitive();
    double[] yShifted = new double[y.length];
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code ZeroRateDiscountFactorCurve}.
   * @return the meta-bean, not null
   */
  public static ZeroRateDiscountFactorCurve.Meta meta() {
    return ZeroRateDiscountFactorCurve.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(ZeroRateDiscountFactorCurve.Meta.INSTANCE);
  }
  ...
  private ZeroRateDiscountFactorCurve(
      Currency currency,
      LocalDate valuationDate,
      DayCount dayCount,
      YieldCurve curve) {
  ...
  @Override
  public ZeroRateDiscountFactorCurve.Meta metaBean() {
    return ZeroRateDiscountFactorCurve.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ZeroRateDiscountFactorCurve other = (ZeroRateDiscountFactorCurve) obj;
  ...
  public String toString() {
    ...
    buf.append("ZeroRateDiscountFactorCurve{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Currency> currency = DirectMetaProperty.ofImmutable(
        this, "currency", ZeroRateDiscountFactorCurve.class, Currency.class);
    /**
     * The meta-property for the {@code valuationDate} property.
     */
    private final MetaProperty<LocalDate> valuationDate = DirectMetaProperty.ofImmutable(
        this, "valuationDate", ZeroRateDiscountFactorCurve.class, LocalDate.class);
    /**
     * The meta-property for the {@code dayCount} property.
     */
    private final MetaProperty<DayCount> dayCount = DirectMetaProperty.ofImmutable(
        this, "dayCount", ZeroRateDiscountFactorCurve.class, DayCount.class);
    /**
     * The meta-property for the {@code curve} property.
     */
    private final MetaProperty<YieldCurve> curve = DirectMetaProperty.ofImmutable(
        this, "curve", ZeroRateDiscountFactorCurve.class, YieldCurve.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends ZeroRateDiscountFactorCurve> builder() {
      return new ZeroRateDiscountFactorCurve.Builder();
    }

    @Override
    public Class<? extends ZeroRateDiscountFactorCurve> beanType() {
      return ZeroRateDiscountFactorCurve.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 575402001:  // currency
          return ((ZeroRateDiscountFactorCurve) bean).getCurrency();
        case 113107279:  // valuationDate
          return ((ZeroRateDiscountFactorCurve) bean).getValuationDate();
        case 1905311443:  // dayCount
          return ((ZeroRateDiscountFactorCurve) bean).getDayCount();
        case 95027439:  // curve
          return ((ZeroRateDiscountFactorCurve) bean).getCurve();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code ZeroRateDiscountFactorCurve}.
   */
  private static final class Builder extends DirectFieldsBeanBuilder<ZeroRateDiscountFactorCurve> {
    ...
    @Override
    public ZeroRateDiscountFactorCurve build() {
      return new ZeroRateDiscountFactorCurve(
          currency,
          valuationDate,
          dayCount,
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(160);
      buf.append("ZeroRateDiscountFactorCurve.Builder{");
