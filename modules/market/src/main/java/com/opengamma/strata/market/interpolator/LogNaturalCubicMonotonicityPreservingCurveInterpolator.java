 ...
 */
final class LogNaturalCubicMonotonicityPreservingCurveInterpolator implements CurveInterpolator, Serializable {
    ...
    static class Bound extends AbstractBoundCurveInterpolator {
      ...
      Bound(DoubleArray xValues, DoubleArray yValues) {
        ...
        this.poly = new MonotonicityPreservingCubicSplineInterpolator(new LogNaturalSplineHelper()).interpolateWithSensitivity(xValues.toArray(), logYValues);
      ...
      //-------------------------------------------------------------------------
      private static DoubleArray evaluate(double xValue, DoubleArray knots, DoubleMatrix coefMatrix, int dimensions, int nKnots) {
      ...
      private static DoubleArray differentiate(double xValue, DoubleArray knots, DoubleMatrix coefMatrix, int dimensions, int nKnots, int nCoefs, int numberOfIntervals) {
      ...
      private static DoubleArray nodeSensitivity(double xValue, DoubleArray knots, DoubleMatrix coefMatrix, int dimensions, int nKnots, int interval, DoubleMatrix coefficientSensitivity ) {
