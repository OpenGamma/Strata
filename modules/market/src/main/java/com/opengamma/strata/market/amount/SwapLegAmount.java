...
public class SwapLegAmount
  ...
  private final PayReceive payReceieve;
  
  /** The type of the leg, such as Fixed or Ibor. */
  @PropertyDefinition(validate = "notNull")
  private final SwapLegType legType;
  
  /** The currency of the leg. This would not be affected by any currency conversion applied to the amount. */
  @PropertyDefinition(validate = "notNull")
   ...
   * @return the value of the property, not null
   */
  public PayReceive getPayReceieve() {
    return payReceieve;
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the currency of the leg. This would not be affected by any currency conversion applied to the amount.
   * @return the value of the property, not null
   */
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(getAmount(), other.getAmount()) &&
          JodaBeanUtils.equal(getPayReceieve(), other.getPayReceieve()) &&
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(getPayReceieve());
  ...
  protected void toString(StringBuilder buf) {
    ...
    buf.append("payReceieve").append('=').append(JodaBeanUtils.toString(getPayReceieve())).append(',').append(' ');
  ...
  public static class Meta extends DirectMetaBean {
    ...
    /**
     * The meta-property for the {@code payReceieve} property.
     */
    private final MetaProperty<PayReceive> payReceieve = DirectMetaProperty.ofImmutable(
        this, "payReceieve", SwapLegAmount.class, PayReceive.class);
    /**
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<PayReceive> payReceieve() {
      return payReceieve;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1679779608:  // payReceieve
          return ((SwapLegAmount) bean).getPayReceieve();
        case 55438952:  // legType
  ...
  public static class Builder extends DirectFieldsBeanBuilder<SwapLegAmount> {
    ...
    private PayReceive payReceieve;
    ...
    protected Builder(SwapLegAmount beanToCopy) {
      ...
      this.payReceieve = beanToCopy.getPayReceieve();
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case -1413853096:  // amount
          ...
          break;
        case -1679779608:  // payReceieve
          this.payReceieve = (PayReceive) newValue;
          break;
        case 55438952:  // legType
    ...
    /**
     * Sets the {@code payReceieve} property in the builder.
     * @param payReceieve  the new value, not null
     * @return this, for chaining, not null
     */
    public Builder payReceieve(PayReceive payReceieve) {
      JodaBeanUtils.notNull(payReceieve, "payReceieve");
      this.payReceieve = payReceieve;
      return this;
    }
    ...
    protected void toString(StringBuilder buf) {
      ...
      buf.append("payReceieve").append('=').append(JodaBeanUtils.toString(payReceieve)).append(',').append(' ');
