...
/**
 * A market data ID identifying the forward curve for an {@link OvernightIndex}.
 * <p>
 * Current and historical values for the index are identified with a {@link IndexRateId}.
 */
@BeanDefinition(builderScope = "private")
public final class OvernightIndexCurveId implements RateCurveId, IndexCurveId, ImmutableBean, Serializable {
   ...
   */
  public static OvernightIndexCurveId of(OvernightIndex index, CurveGroupName curveGroupName) {
    return new OvernightIndexCurveId(index, curveGroupName, MarketDataFeed.NONE);
  }
   ...
   * @return the ID used to obtain the forward curve for an Overnight index.
   */
  public static OvernightIndexCurveId of(OvernightIndex index, CurveGroupName curveGroupName, MarketDataFeed marketDataFeed) {
    return new OvernightIndexCurveId(index, curveGroupName, marketDataFeed);
  }
  ...
  @Override
  public OvernightIndexCurveKey toMarketDataKey() {
    return OvernightIndexCurveKey.of(index);
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code OvernightIndexCurveId}.
   * @return the meta-bean, not null
   */
  public static OvernightIndexCurveId.Meta meta() {
    return OvernightIndexCurveId.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(OvernightIndexCurveId.Meta.INSTANCE);
  }
  ...
  @Override
  public OvernightIndexCurveId.Meta metaBean() {
    return OvernightIndexCurveId.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      OvernightIndexCurveId other = (OvernightIndexCurveId) obj;
  ...
  public String toString() {
    ...
    buf.append("OvernightIndexCurveId{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<OvernightIndex> index = DirectMetaProperty.ofImmutable(
        this, "index", OvernightIndexCurveId.class, OvernightIndex.class);
    /**
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", OvernightIndexCurveId.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<MarketDataFeed> marketDataFeed = DirectMetaProperty.ofImmutable(
        this, "marketDataFeed", OvernightIndexCurveId.class, MarketDataFeed.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends OvernightIndexCurveId> builder() {
      return new OvernightIndexCurveId.Builder();
    }

    @Override
    public Class<? extends OvernightIndexCurveId> beanType() {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 100346066:  // index
          return ((OvernightIndexCurveId) bean).getIndex();
        case -382645893:  // curveGroupName
          return ((OvernightIndexCurveId) bean).getCurveGroupName();
        case 842621124:  // marketDataFeed
          return ((OvernightIndexCurveId) bean).getMarketDataFeed();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code OvernightIndexCurveId}.
   */
  private static final class Builder extends DirectFieldsBeanBuilder<OvernightIndexCurveId> {
    ...
    @Override
    public OvernightIndexCurveId build() {
      return new OvernightIndexCurveId(
          index,
          curveGroupName,
          marketDataFeed);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("OvernightIndexCurveId.Builder{");
