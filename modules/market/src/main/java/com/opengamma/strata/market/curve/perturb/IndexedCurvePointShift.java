...
/**
 * Perturbation which applies a shift to a single point on a curve.
 * <p>
 * This shifts a single node on a {@link Curve}, identifying the node by index.
...
public final class IndexedCurvePointShift
  ...
  public Curve applyTo(Curve curve) {
    ...
    double shiftedValue = shiftType.applyShift(curve.getParameter(nodeIndex), shiftAmount);
    return curve.withParameter(nodeIndex, shiftedValue);
  }
