...
public final class CreditCurveId
   ...
   * @return the identifier
   */
  public static CreditCurveId of(
   ...
   */
  private static final TypedMetaBean<CreditCurveId> META_BEAN =
      LightMetaBean.of(
          CreditCurveId.class,
   ...
   */
  public static TypedMetaBean<CreditCurveId> meta() {
    return META_BEAN;
  }
  ...
  @Override
  public TypedMetaBean<CreditCurveId> metaBean() {
    return META_BEAN;
  }
