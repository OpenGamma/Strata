...
/**
 * An identifier used to access a credit curve by name.
 * <p>
 * This is used when there is a need to obtain a credit curve as an instance of {@link Curve}.
 */
@BeanDefinition(builderScope = "private", cacheHashCode = true)
public final class CreditCurveId
  ...
  //-------------------------------------------------------------------------
  /**
   * Obtains an instance used to obtain a credit curve by name.
   *
   * @param groupName  the curve group name
   * @param curveName  the curve name
   * @return the identifier
   */
  public static CreditCurveId of(String groupName, String curveName) {
    return new CreditCurveId(CurveGroupName.of(groupName), CurveName.of(curveName), ObservableSource.NONE);
  }
   ...
   * @return the identifier
   */
  public static CreditCurveId of(CurveGroupName groupName, CurveName curveName) {
    return new CreditCurveId(groupName, curveName, ObservableSource.NONE);
  }
   ...
   * @return the identifier
   */
  public static CreditCurveId of(CurveGroupName groupName, CurveName curveName, ObservableSource obsSource) {
    return new CreditCurveId(groupName, curveName, obsSource);
  }
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code CreditCurveId}.
   * @return the meta-bean, not null
   */
  public static CreditCurveId.Meta meta() {
    return CreditCurveId.Meta.INSTANCE;
  }

  static {
    MetaBean.register(CreditCurveId.Meta.INSTANCE);
  }
  ...
  @Override
  public CreditCurveId.Meta metaBean() {
    return CreditCurveId.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      CreditCurveId other = (CreditCurveId) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", CreditCurveId.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<CurveName> curveName = DirectMetaProperty.ofImmutable(
        this, "curveName", CreditCurveId.class, CurveName.class);
    /**
    ...
    private final MetaProperty<ObservableSource> observableSource = DirectMetaProperty.ofImmutable(
        this, "observableSource", CreditCurveId.class, ObservableSource.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends CreditCurveId> builder() {
      return new CreditCurveId.Builder();
    }

    @Override
    public Class<? extends CreditCurveId> beanType() {
      return CreditCurveId.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -382645893:  // curveGroupName
          return ((CreditCurveId) bean).getCurveGroupName();
        case 771153946:  // curveName
          return ((CreditCurveId) bean).getCurveName();
        case 1793526590:  // observableSource
          return ((CreditCurveId) bean).getObservableSource();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code CreditCurveId}.
   */
  private static final class Builder extends DirectPrivateBeanBuilder<CreditCurveId> {
    ...
    @Override
    public CreditCurveId build() {
      return new CreditCurveId(
          curveGroupName,
          curveName,
          observableSource);
    }
    ...
    public String toString() {
      ...
      buf.append("CreditCurveId.Builder{");
