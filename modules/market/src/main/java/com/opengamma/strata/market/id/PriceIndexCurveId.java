...
/**
 * A market data ID identifying the forward curve for a {@link PriceIndex}.
 */
@BeanDefinition(builderScope = "private")
public final class PriceIndexCurveId implements IndexCurveId, ImmutableBean, Serializable {
   ...
   */
  public static PriceIndexCurveId of(PriceIndex index, CurveGroupName curveGroupName, MarketDataFeed marketDataFeed) {
    return new PriceIndexCurveId(index, curveGroupName, marketDataFeed);
  }
   ...
   * @return an ID for the curve for the specified index
   */
  public static PriceIndexCurveId of(PriceIndex index, CurveGroupName curveGroupName) {
    return new PriceIndexCurveId(index, curveGroupName, MarketDataFeed.NONE);
  }

  @Override
  public PriceIndexCurveKey toMarketDataKey() {
    return PriceIndexCurveKey.of(index);
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code PriceIndexCurveId}.
   * @return the meta-bean, not null
   */
  public static PriceIndexCurveId.Meta meta() {
    return PriceIndexCurveId.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(PriceIndexCurveId.Meta.INSTANCE);
  }
  ...
  @Override
  public PriceIndexCurveId.Meta metaBean() {
    return PriceIndexCurveId.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      PriceIndexCurveId other = (PriceIndexCurveId) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PriceIndex> index = DirectMetaProperty.ofImmutable(
        this, "index", PriceIndexCurveId.class, PriceIndex.class);
    /**
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", PriceIndexCurveId.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<MarketDataFeed> marketDataFeed = DirectMetaProperty.ofImmutable(
        this, "marketDataFeed", PriceIndexCurveId.class, MarketDataFeed.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends PriceIndexCurveId> builder() {
      return new PriceIndexCurveId.Builder();
    }

    @Override
    public Class<? extends PriceIndexCurveId> beanType() {
      return PriceIndexCurveId.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 100346066:  // index
          return ((PriceIndexCurveId) bean).getIndex();
        case -382645893:  // curveGroupName
          return ((PriceIndexCurveId) bean).getCurveGroupName();
        case 842621124:  // marketDataFeed
          return ((PriceIndexCurveId) bean).getMarketDataFeed();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code PriceIndexCurveId}.
   */
  private static final class Builder extends DirectFieldsBeanBuilder<PriceIndexCurveId> {
    ...
    @Override
    public PriceIndexCurveId build() {
      return new PriceIndexCurveId(
          index,
          curveGroupName,
          marketDataFeed);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("PriceIndexCurveId.Builder{");
