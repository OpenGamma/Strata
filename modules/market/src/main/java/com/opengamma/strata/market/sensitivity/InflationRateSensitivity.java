...
public final class InflationRateSensitivity
  ...
  public static InflationRateSensitivity of(PriceIndex index, YearMonth referenceMonth, double sensitivity) {
    return new InflationRateSensitivity(index, index.getCurrency(), referenceMonth, sensitivity);
  }

  /**
   * Obtains an {@code InflationRateSensitivity} from the index, currency, reference month and value.
   * 
   * @param index  the index of prices
  ...
  public InflationRateSensitivity mapSensitivity(DoubleUnaryOperator operator) {
    return new InflationRateSensitivity(index, currency, referenceMonth, operator.applyAsDouble(sensitivity));
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(getIndex(), other.getIndex()) &&
          ...
          JodaBeanUtils.equal(getReferenceMonth(), other.getReferenceMonth()) &&
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(getReferenceMonth());
  ...
  public String toString() {
    ...
    buf.append("referenceMonth").append('=').append(getReferenceMonth()).append(',').append(' ');
