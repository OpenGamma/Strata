...
public final class ParRates implements ImmutableBean {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code PaParRates}.
   * @return the meta-bean, not null
   */
  public static PaParRates.Meta meta() {
    return PaParRates.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(PaParRates.Meta.INSTANCE);
  }
   ...
   */
  public static PaParRates.Builder builder() {
    return new PaParRates.Builder();
  }
  ...
  @Override
  public PaParRates.Meta metaBean() {
    return PaParRates.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      PaParRates other = (PaParRates) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableMap<ObservableId, Double>> rates = DirectMetaProperty.ofImmutable(
        this, "rates", PaParRates.class, (Class) ImmutableMap.class);
    /**
    ...
    private final MetaProperty<CurveMetadata> curveMetadata = DirectMetaProperty.ofImmutable(
        this, "curveMetadata", PaParRates.class, CurveMetadata.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public PaParRates.Builder builder() {
      return new PaParRates.Builder();
    }

    @Override
    public Class<? extends PaParRates> beanType() {
      return PaParRates.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 108285843:  // rates
          return ((PaParRates) bean).getRates();
        case 278233406:  // curveMetadata
          return ((PaParRates) bean).getCurveMetadata();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code PaParRates}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<PaParRates> {
     ...
     */
    private Builder(PaParRates beanToCopy) {
    ...
    @Override
    public PaParRates build() {
      return new PaParRates(
          rates,
          curveMetadata);
    }
