...
public final class DiscountCurveId
  ...
  //-------------------------------------------------------------------------
  /**
   * Creates an ID used to obtain the discount factor curve associated with a currency.
   *
  ...
  /**
   * Returns an ID that identifies the discount factor curve for the specified currency.
   * <p>
  ...
  //-------------------------------------------------------------------------
  /**
   * Gets the ID of the underlying curve group.
   *
   * @return a curve group ID formed from this ID
   */
  public CurveGroupId toCurveGroupId() {
    return CurveGroupId.of(curveGroupName, marketDataFeed);
  }
