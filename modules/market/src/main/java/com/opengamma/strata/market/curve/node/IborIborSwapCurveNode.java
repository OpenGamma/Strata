...
public final class IborIborSwapCurveNode
  ...
  public static IborIborSwapCurveNode of(
    ...
    return new IborIborSwapCurveNode(template, rateKey, additionalSpread, label, NodeDateType.LAST_PAYMENT_DATE, null);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<NodeDateType> nodeDateType = DirectMetaProperty.ofImmutable(
        this, "nodeDateType", IborIborSwapCurveNode.class, NodeDateType.class);
    /**
    ...
    private final MetaProperty<LocalDate> nodeDate = DirectMetaProperty.ofImmutable(
        this, "nodeDate", IborIborSwapCurveNode.class, LocalDate.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case 937712682:  // nodeDateType
          return ((IborIborSwapCurveNode) bean).getNodeDateType();
        case 1122582736:  // nodeDate
          return ((IborIborSwapCurveNode) bean).nodeDate;
      }
