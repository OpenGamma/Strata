...
public final class IsdaIndexCreditCurveInputsKey
   ...
   * @return the key
   */
  public static IsdaIndexCreditCurveInputsKey of(IndexReferenceInformation referenceInformation) {
    return new IsdaIndexCreditCurveInputsKey(referenceInformation);
  }
  ...
  public MarketDataId<IsdaCreditCurveInputs> toMarketDataId(MarketDataFeed marketDataFeed) {
    return IsdaIndexCreditCurveInputsId.of(referenceInformation);
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code IsdaIndexCreditCurveInputsKey}.
   * @return the meta-bean, not null
   */
  public static IsdaIndexCreditCurveInputsKey.Meta meta() {
    return IsdaIndexCreditCurveInputsKey.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(IsdaIndexCreditCurveInputsKey.Meta.INSTANCE);
  }
  ...
  private IsdaIndexCreditCurveInputsKey(
  ...
  @Override
  public IsdaIndexCreditCurveInputsKey.Meta metaBean() {
    return IsdaIndexCreditCurveInputsKey.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      IsdaIndexCreditCurveInputsKey other = (IsdaIndexCreditCurveInputsKey) obj;
  ...
  public String toString() {
    ...
    buf.append("IsdaIndexCreditCurveInputsKey{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<IndexReferenceInformation> referenceInformation = DirectMetaProperty.ofImmutable(
        this, "referenceInformation", IsdaIndexCreditCurveInputsKey.class, IndexReferenceInformation.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends IsdaIndexCreditCurveInputsKey> builder() {
      return new IsdaIndexCreditCurveInputsKey.Builder();
    }

    @Override
    public Class<? extends IsdaIndexCreditCurveInputsKey> beanType() {
      return IsdaIndexCreditCurveInputsKey.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -2117930783:  // referenceInformation
          return ((IsdaIndexCreditCurveInputsKey) bean).getReferenceInformation();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code IsdaIndexCreditCurveInputsKey}.
   */
  private static final class Builder extends DirectFieldsBeanBuilder<IsdaIndexCreditCurveInputsKey> {
    ...
    @Override
    public IsdaIndexCreditCurveInputsKey build() {
      return new IsdaIndexCreditCurveInputsKey(
          referenceInformation);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(64);
      buf.append("IsdaIndexCreditCurveInputsKey.Builder{");
      buf.append("referenceInformation").append('=').append(JodaBeanUtils.toString(referenceInformation));
      buf.append('}');
      return buf.toString();
    }
