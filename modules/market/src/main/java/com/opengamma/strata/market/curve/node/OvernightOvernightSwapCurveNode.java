...
/**
 * A curve node whose instrument is an overnight-overnight interest rate swap.
 * <p>
 * The spread or market quote is on the first overnight leg.
 * <p>
...
public final class OvernightOvernightSwapCurveNode
  ...
  //-------------------------------------------------------------------------
  /**
   * Obtains a curve node for an overnight-overnight interest rate swap using the
  ...
  private LocalDate calculateLastFixingDate(LocalDate valuationDate) {
    throw new UnsupportedOperationException("Node date of 'LastFixing' is not supported for OvernightOvernightSwap");
  }
