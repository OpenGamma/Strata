...
/**
 * A curve node whose instrument is a Overnight-Overnight interest rate swap.
 * <p>
...
public final class OvernightOvernightSwapCurveNode
  ...
  //-------------------------------------------------------------------------
  /**
   * Returns a curve node for an Overnight-Overnight interest rate swap using the
  ...
  /**
   * Returns a curve node for a Overnight-Overnight interest rate swap using the
