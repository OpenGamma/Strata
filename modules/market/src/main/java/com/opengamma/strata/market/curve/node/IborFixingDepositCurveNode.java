...
public final class IborFixingDepositCurveNode
  ...
  public static IborFixingDepositCurveNode of(
    ...
    return new IborFixingDepositCurveNode(template, rateKey, additionalSpread, label, NodeDateType.LAST_PAYMENT_DATE, null);
  }
  ...
  public DatedCurveParameterMetadata metadata(LocalDate valuationDate) {
    ...
    if (nodeDateType.equals(NodeDateType.LAST_FIXING_DATE)) {
      return TenorCurveNodeMetadata.of(deposit.getFloatingRate().getFixingDate(), endTenor, label);
    }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the date associated to the node. Used only is the nodeDateType is FIXED_DATE. Null in other cases.
   * @return the value of the property
   */
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<NodeDateType> nodeDateType = DirectMetaProperty.ofImmutable(
        this, "nodeDateType", IborFixingDepositCurveNode.class, NodeDateType.class);
    /**
    ...
    private final MetaProperty<LocalDate> nodeDate = DirectMetaProperty.ofImmutable(
        this, "nodeDate", IborFixingDepositCurveNode.class, LocalDate.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case 937712682:  // nodeDateType
          return ((IborFixingDepositCurveNode) bean).getNodeDateType();
        case 1122582736:  // nodeDate
          return ((IborFixingDepositCurveNode) bean).getNodeDate();
      }
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<IborFixingDepositCurveNode> {
    ...
    private Builder(IborFixingDepositCurveNode beanToCopy) {
      ...
      this.nodeDate = beanToCopy.getNodeDate();
    }
