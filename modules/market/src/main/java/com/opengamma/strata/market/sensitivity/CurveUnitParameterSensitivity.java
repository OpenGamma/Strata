...
public final class CurveUnitParameterSensitivity
   ...
   * Otherwise, the size of the parameter metadata list will match the sensitivity values.
   */
   ...
   * @return the sensitivity object
   */
  public static CurveUnitParameterSensitivity of(CurveMetadata metadata, double[] sensitivity) {
   ...
   */
  public int compareExcludingSensitivity(CurveUnitParameterSensitivity other) {
  ...
  public CurveUnitParameterSensitivity withSensitivity(double[] sensitivity) {
    ...
    return new CurveUnitParameterSensitivity(metadata, sensitivity.clone());
  }
   ...
   */
  public double total() {
    return DoubleStream.of(sensitivity).sum();
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<double[]> sensitivity = DirectMetaProperty.ofImmutable(
        this, "sensitivity", CurveUnitParameterSensitivity.class, double[].class);
    /**
     * The meta-properties.
     */
