...
public final class QuoteId implements ObservableId, ImmutableBean, Serializable {
  ...
  /**
   * Returns a security identifier based on the standard identifier.
   * <p>
   * This convenience method allows a quote identifier to be converted to a security identifier.
   * Since not all quotes are for securities, there is no guarantee that a security exists
   * for the resulting identifier.
   * 
   * @return a security identifier formed by wrapping the standard identifier of this instance
   */
  public SecurityId toSecurityId() {
    return SecurityId.of(standardId);
  }
