...
/**
 * An identifier used to access a rates curve by name.
 * <p>
 * This is used when there is a need to obtain a rates curve as an instance of {@link Curve}.
 */
@BeanDefinition(builderScope = "private", cacheHashCode = true)
public final class RatesCurveId
  ...
  //-------------------------------------------------------------------------
  /**
   * Obtains an instance used to obtain a rates curve by name.
   *
   * @param groupName  the curve group name
   * @param curveName  the curve name
   * @return the identifier
   */
  public static RatesCurveId of(String groupName, String curveName) {
    return new RatesCurveId(CurveGroupName.of(groupName), CurveName.of(curveName), ObservableSource.NONE);
  }
   ...
   * @return the identifier
   */
  public static RatesCurveId of(CurveGroupName groupName, CurveName curveName) {
    return new RatesCurveId(groupName, curveName, ObservableSource.NONE);
  }
   ...
   * @return the identifier
   */
  public static RatesCurveId of(CurveGroupName groupName, CurveName curveName, ObservableSource obsSource) {
    return new RatesCurveId(groupName, curveName, obsSource);
  }
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code RatesCurveId}.
   * @return the meta-bean, not null
   */
  public static RatesCurveId.Meta meta() {
    return RatesCurveId.Meta.INSTANCE;
  }

  static {
    MetaBean.register(RatesCurveId.Meta.INSTANCE);
  }
  ...
  @Override
  public RatesCurveId.Meta metaBean() {
    return RatesCurveId.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      RatesCurveId other = (RatesCurveId) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", RatesCurveId.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<CurveName> curveName = DirectMetaProperty.ofImmutable(
        this, "curveName", RatesCurveId.class, CurveName.class);
    /**
    ...
    private final MetaProperty<ObservableSource> observableSource = DirectMetaProperty.ofImmutable(
        this, "observableSource", RatesCurveId.class, ObservableSource.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends RatesCurveId> builder() {
      return new RatesCurveId.Builder();
    }

    @Override
    public Class<? extends RatesCurveId> beanType() {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -382645893:  // curveGroupName
          return ((RatesCurveId) bean).getCurveGroupName();
        case 771153946:  // curveName
          return ((RatesCurveId) bean).getCurveName();
        case 1793526590:  // observableSource
          return ((RatesCurveId) bean).getObservableSource();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code RatesCurveId}.
   */
  private static final class Builder extends DirectPrivateBeanBuilder<RatesCurveId> {
    ...
    @Override
    public RatesCurveId build() {
      return new RatesCurveId(
          curveGroupName,
          curveName,
          observableSource);
    }
    ...
    public String toString() {
      ...
      buf.append("RatesCurveId.Builder{");
