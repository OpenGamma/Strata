...
public final class ZeroRateDiscountFactorsId
   ...
   */
  public static ZeroRateDiscountFactorsId of(Currency currency, CurveGroupName group, MarketDataFeed feed) {
    return new ZeroRateDiscountFactorsId(currency, group, feed);
  }
   ...
   *
   * @return a curve ID formed from this ID
   */
  public DiscountCurveId toCurveId() {
    return DiscountCurveId.of(currency, curveGroupName, marketDataFeed);
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code ZeroRateDiscountFactorsId}.
   * @return the meta-bean, not null
   */
  public static ZeroRateDiscountFactorsId.Meta meta() {
    return ZeroRateDiscountFactorsId.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(ZeroRateDiscountFactorsId.Meta.INSTANCE);
  }
  ...
  private ZeroRateDiscountFactorsId(
      Currency currency,
  ...
  @Override
  public ZeroRateDiscountFactorsId.Meta metaBean() {
    return ZeroRateDiscountFactorsId.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ZeroRateDiscountFactorsId other = (ZeroRateDiscountFactorsId) obj;
  ...
  public String toString() {
    ...
    buf.append("ZeroRateDiscountFactorsId{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Currency> currency = DirectMetaProperty.ofImmutable(
        this, "currency", ZeroRateDiscountFactorsId.class, Currency.class);
    /**
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", ZeroRateDiscountFactorsId.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<MarketDataFeed> marketDataFeed = DirectMetaProperty.ofImmutable(
        this, "marketDataFeed", ZeroRateDiscountFactorsId.class, MarketDataFeed.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends ZeroRateDiscountFactorsId> builder() {
      return new ZeroRateDiscountFactorsId.Builder();
    }

    @Override
    public Class<? extends ZeroRateDiscountFactorsId> beanType() {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 575402001:  // currency
          return ((ZeroRateDiscountFactorsId) bean).getCurrency();
        case -382645893:  // curveGroupName
          return ((ZeroRateDiscountFactorsId) bean).getCurveGroupName();
        case 842621124:  // marketDataFeed
          return ((ZeroRateDiscountFactorsId) bean).getMarketDataFeed();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code ZeroRateDiscountFactorsId}.
   */
  private static final class Builder extends DirectFieldsBeanBuilder<ZeroRateDiscountFactorsId> {
    ...
    @Override
    public ZeroRateDiscountFactorsId build() {
      return new ZeroRateDiscountFactorsId(
          currency,
          curveGroupName,
          marketDataFeed);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("ZeroRateDiscountFactorsId.Builder{");
