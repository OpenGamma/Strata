...
public final class DiscountIborIndexCurve
    implements IborIndexCurve, ImmutableBean, Serializable {
   ...
   * @return the curve
   */
  public static DiscountIborIndexCurve of(
      IborIndex index,
      LocalDateDoubleTimeSeries knownFixings,
      DiscountFactorCurve discountFactors) {

    return new DiscountIborIndexCurve(index, knownFixings, discountFactors);
  }
  ...
  //-------------------------------------------------------------------------
  @Override
  public DiscountIborIndexCurve shiftedBy(DoubleBinaryOperator operator) {
    return new DiscountIborIndexCurve(index, timeSeries, discountFactors.shiftedBy(operator));
  }

  @Override
  public DiscountIborIndexCurve shiftedBy(List<ValueAdjustment> adjustments) {
    return new DiscountIborIndexCurve(index, timeSeries, discountFactors.shiftedBy(adjustments));
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code DiscountIborIndexCurve}.
   * @return the meta-bean, not null
   */
  public static DiscountIborIndexCurve.Meta meta() {
    return DiscountIborIndexCurve.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(DiscountIborIndexCurve.Meta.INSTANCE);
  }
  ...
  private DiscountIborIndexCurve(
      IborIndex index,
  ...
  @Override
  public DiscountIborIndexCurve.Meta metaBean() {
    return DiscountIborIndexCurve.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      DiscountIborIndexCurve other = (DiscountIborIndexCurve) obj;
  ...
  public String toString() {
    ...
    buf.append("DiscountIborIndexCurve{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<IborIndex> index = DirectMetaProperty.ofImmutable(
        this, "index", DiscountIborIndexCurve.class, IborIndex.class);
    /**
     * The meta-property for the {@code timeSeries} property.
     */
    private final MetaProperty<LocalDateDoubleTimeSeries> timeSeries = DirectMetaProperty.ofImmutable(
        this, "timeSeries", DiscountIborIndexCurve.class, LocalDateDoubleTimeSeries.class);
    /**
    ...
    private final MetaProperty<DiscountFactorCurve> discountFactors = DirectMetaProperty.ofImmutable(
        this, "discountFactors", DiscountIborIndexCurve.class, DiscountFactorCurve.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends DiscountIborIndexCurve> builder() {
      return new DiscountIborIndexCurve.Builder();
    }

    @Override
    public Class<? extends DiscountIborIndexCurve> beanType() {
      return DiscountIborIndexCurve.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 100346066:  // index
          return ((DiscountIborIndexCurve) bean).getIndex();
        case 779431844:  // timeSeries
          return ((DiscountIborIndexCurve) bean).getTimeSeries();
        case -91613053:  // discountFactors
          return ((DiscountIborIndexCurve) bean).getDiscountFactors();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code DiscountIborIndexCurve}.
   */
  private static final class Builder extends DirectFieldsBeanBuilder<DiscountIborIndexCurve> {
    ...
    @Override
    public DiscountIborIndexCurve build() {
      return new DiscountIborIndexCurve(
          index,
          timeSeries,
          discountFactors);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("DiscountIborIndexCurve.Builder{");
