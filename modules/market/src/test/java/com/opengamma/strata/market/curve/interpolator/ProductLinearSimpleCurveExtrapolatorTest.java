...
/**
 * Test {@link ProductLinearSimpleCurveExtrapolator}.
 */
@Test
public class ProductLinearSimpleCurveExtrapolatorTest {

  private static final CurveExtrapolator EXTRAP = ProductLinearSimpleCurveExtrapolator.INSTANCE;
  ...
  public void test_basics() {
    assertEquals(EXTRAP.getName(), ProductLinearSimpleCurveExtrapolator.NAME);
    assertEquals(EXTRAP.toString(), ProductLinearSimpleCurveExtrapolator.NAME);
  }
  ...
  public void errorTest1() {
    ...
    BoundCurveInterpolator bind =
        CurveInterpolators.DOUBLE_QUADRATIC.bind(xValues, yValues, EXTRAP, EXTRAP);
    assertThrowsIllegalArg(() -> bind.interpolate(-1));
  }
  ...
  public void errorTest2() {
    ...
    BoundCurveInterpolator bind =
        CurveInterpolators.DOUBLE_QUADRATIC.bind(xValues, yValues, EXTRAP, EXTRAP);
    assertThrowsIllegalArg(() -> bind.firstDerivative(-1));
  }

  public void errorTest3() {
    DoubleArray xValues = DoubleArray.of(-3, -2, -1);
    DoubleArray yValues = DoubleArray.of(1, 2, 3);
    BoundCurveInterpolator bind =
        CurveInterpolators.DOUBLE_QUADRATIC.bind(xValues, yValues, EXTRAP, EXTRAP);
    assertThrowsIllegalArg(() -> bind.interpolate(1));
  ...
  public void sampleDataTest() {
    ...
    BoundCurveInterpolator bind = ProductNaturalSplineSimpleCurveInterpolator.INSTANCE
        .bind(xValues, yValues, CurveExtrapolators.FLAT, ProductLinearSimpleCurveExtrapolator.INSTANCE);
