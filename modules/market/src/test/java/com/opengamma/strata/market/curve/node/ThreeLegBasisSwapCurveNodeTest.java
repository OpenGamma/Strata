...
public class ThreeLegBasisSwapCurveNodeTest {
  ...
  assertThrowsIllegalArg(() -> ThreeLegBasisSwapCurveNode.builder()
      .label(LABEL)
      .template(TEMPLATE)
      .rateKey(QUOTE_KEY)
      .additionalSpread(SPREAD)
  ...
  public void test_metadata_fixed() {
    ...
    ThreeLegBasisSwapCurveNode node = ThreeLegBasisSwapCurveNode.builder().template(TEMPLATE).rateKey(QUOTE_KEY)
  ...
  public void test_metadata_last_fixing() {
    ThreeLegBasisSwapCurveNode node = ThreeLegBasisSwapCurveNode.builder()
        .label(LABEL)
        .template(TEMPLATE)
        .rateKey(QUOTE_KEY)
        .additionalSpread(SPREAD)
