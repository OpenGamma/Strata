...
/**
 * Test {@link ReciprocalCurveExtrapolator}.
 */
@Test
public class ReciprocalCurveExtrapolatorTest {

  private static final Random RANDOM = new Random(0L);
  private static final CurveExtrapolator RECIP_EXTRAPOLATOR = ReciprocalCurveExtrapolator.INSTANCE;
  ...
  public void test_basics() {
    assertEquals(RECIP_EXTRAPOLATOR.getName(), ReciprocalCurveExtrapolator.NAME);
    assertEquals(RECIP_EXTRAPOLATOR.toString(), ReciprocalCurveExtrapolator.NAME);
  }
  ...
  public void notClampedTest(PiecewisePolynomialInterpolator baseInterpolator) {
    ...
    for (int k = 0; k < xValuesSet.length; ++k) {
      ...
      StandardCurveInterpolator pp = new StandardCurveInterpolator("Reciprocal", interpolator1D);
      BoundCurveInterpolator bci = pp.bind(
          DoubleArray.copyOf(xValues), DoubleArray.copyOf(yValues), RECIP_EXTRAPOLATOR, RECIP_EXTRAPOLATOR);
      ...
      for (int j = 1; j < nKeys; ++j) {
        ...
        assertRelative("notClampedTest", ref / key, bci.interpolate(key), EPS);
        ...
        for (int l = 0; l < nData; ++l) {
          ...
          BoundCurveInterpolator bciUp = pp.bind(
              DoubleArray.copyOf(xValues), DoubleArray.copyOf(yValuesUp), RECIP_EXTRAPOLATOR, RECIP_EXTRAPOLATOR);
          BoundCurveInterpolator bciDw = pp.bind(
              DoubleArray.copyOf(xValues), DoubleArray.copyOf(yValuesDw), RECIP_EXTRAPOLATOR, RECIP_EXTRAPOLATOR);
  ...
  public void closeToZeroTest(PiecewisePolynomialInterpolator baseInterpolator) {
    ...
    StandardCurveInterpolator pp = new StandardCurveInterpolator("Reciprocal", interpolator1D);
    BoundCurveInterpolator bci = pp.bind(xValues, yValues, RECIP_EXTRAPOLATOR, RECIP_EXTRAPOLATOR);
    double eps = 1.0e-5;
  ...
  public void test_sameAsPrevious() {
    ...
    StandardCurveInterpolator pp = new StandardCurveInterpolator("Reciprocal", oldInterp);
    BoundCurveInterpolator bci = pp.bind(X_DATA, Y_DATA, RECIP_EXTRAPOLATOR, RECIP_EXTRAPOLATOR);
    Extrapolator1D oldExtrap = new ReciprocalExtrapolator1D();
  ...
  public void test_serialization() {
    assertSerialization(RECIP_EXTRAPOLATOR);
  }
