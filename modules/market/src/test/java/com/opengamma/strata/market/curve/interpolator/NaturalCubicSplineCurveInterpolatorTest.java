...
public class NaturalCubicSplineCurveInterpolatorTest {
  ...
  public void test_basics() {
    assertThat(NATURAL_CUBLIC_SPLINE_INTERPOLATOR.getName()).isEqualTo(NaturalCubicSplineCurveInterpolator.NAME);
    assertThat(NATURAL_CUBLIC_SPLINE_INTERPOLATOR.toString()).isEqualTo(NaturalCubicSplineCurveInterpolator.NAME);
  }
