...
public class IborFixingDepositCurveNodeTest {
  ...
  public void test_trade() {
    ...
    IborFixingDepositTrade trade = node.trade(valuationDate, 1d, marketData, REF_DATA);
  ...
  public void test_metadata_last_fixing() {
    ...
    IborFixingDepositTrade trade = (IborFixingDepositTrade) node.trade(valuationDate, marketData, REF_DATA);
