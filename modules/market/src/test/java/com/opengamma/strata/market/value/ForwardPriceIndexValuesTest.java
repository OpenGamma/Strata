...
public class ForwardPriceIndexValuesTest {
  ...
  private static final ForwardPriceIndexValues INSTANCE =
      ForwardPriceIndexValues.of(US_CPI_U, VAL_DATE, USCPI_TS, CURVE, SEASONALITY);
  ...
  public void test_of_noSeasonality() {
    ForwardPriceIndexValues test = ForwardPriceIndexValues.of(US_CPI_U, VAL_DATE, USCPI_TS, CURVE);
    assertEquals(test.getKey(), PriceIndexValuesKey.of(US_CPI_U));
  ...
  public void test_of_seasonality() {
    ForwardPriceIndexValues test = ForwardPriceIndexValues.of(US_CPI_U, VAL_DATE, USCPI_TS, CURVE, SEASONALITY);
    assertEquals(test.getKey(), PriceIndexValuesKey.of(US_CPI_U));
    assertEquals(test.getIndex(), US_CPI_U);
    assertEquals(test.getValuationDate(), VAL_DATE);
  ...
  public void test_of_wrongSeasonalityLength() {
    assertThrowsIllegalArg(() -> ForwardPriceIndexValues.of(
        US_CPI_U, VAL_DATE, USCPI_TS, CURVE, DoubleArray.EMPTY));
  }
  ...
  public void test_of_startDateBeforeFixing() {
    ...
    assertThrowsIllegalArg(() -> ForwardPriceIndexValues.of(US_CPI_U, VAL_DATE, USCPI_TS, interpolated, SEASONALITY));
  }
  ...
  public void test_withCurve() {
    ForwardPriceIndexValues test = ForwardPriceIndexValues.of(US_CPI_U, VAL_DATE, USCPI_TS, CURVE).withCurve(CURVE2);
