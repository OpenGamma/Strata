...
public class NaturalSplineCurveInterpolatorTest {
  ...
  public void test_basics() {
    assertThat(NATURAL_SPLINE_INTERPOLATOR.getName()).isEqualTo(NaturalSplineCurveInterpolator.NAME);
    assertThat(NATURAL_SPLINE_INTERPOLATOR.toString()).isEqualTo(NaturalSplineCurveInterpolator.NAME);
  }
