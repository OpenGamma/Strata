...
public class NaturalSplineNonnegativityCubicCurveInterpolatorTest {
  ...
  public void test_basics() {
    assertEquals(INTERPOLATOR.getName(), NaturalSplineNonnegativityCubicCurveInterpolator.NAME);
  ...
  public void test_sameAsPrevious() {
    BoundCurveInterpolator bci = INTERPOLATOR.bind(X_DATA, Y_DATA, FLAT_EXTRAPOLATOR, FLAT_EXTRAPOLATOR);
    NonnegativityPreservingCubicSplineInterpolator1D oldInterp = new NonnegativityPreservingCubicSplineInterpolator1D();
