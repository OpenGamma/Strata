...
public final class DiscountingCurveMapping
  ...
  /**
   * Returns a mapper that accepts a {@link DiscountCurveKey} and returns a {@link DiscountCurveId}
   * with the name of the curve group that is the source of the curve.
   *
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<MarketDataFeed> marketDataFeed = DirectMetaProperty.ofImmutable(
        this, "marketDataFeed", DiscountingCurveMapping.class, MarketDataFeed.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case 842621124:  // marketDataFeed
          return ((DiscountingCurveMapping) bean).getMarketDataFeed();
      }
