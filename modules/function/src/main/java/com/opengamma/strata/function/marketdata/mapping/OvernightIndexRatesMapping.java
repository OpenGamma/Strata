...
/**
 * Market data mapping that accepts a {@link OvernightIndexRatesKey} and returns
 * a {@link OvernightIndexRatesId}.
 * <p>
 * The additional information required is the curve group and market data feed
 * that is the source of the curve.
 */
@BeanDefinition
public final class OvernightIndexRatesMapping
    implements MarketDataMapping<OvernightIndexRates, OvernightIndexRatesKey>, ImmutableBean, Serializable {
   ...
   * <p>
   * The result will map a {@link OvernightIndexRatesKey} to a {@link OvernightIndexRatesId}
   ...
   */
  public static OvernightIndexRatesMapping of(CurveGroupName curveGroupName, MarketDataFeed marketDataFeed) {
    return new OvernightIndexRatesMapping(curveGroupName, marketDataFeed);
  }

  @Override
  public Class<OvernightIndexRatesKey> getMarketDataKeyType() {
    return OvernightIndexRatesKey.class;
  }

  @Override
  public OvernightIndexRatesId getIdForKey(OvernightIndexRatesKey key) {
    return OvernightIndexRatesId.of(key.getIndex(), curveGroupName, marketDataFeed);
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code OvernightIndexRatesMapping}.
   * @return the meta-bean, not null
   */
  public static OvernightIndexRatesMapping.Meta meta() {
    return OvernightIndexRatesMapping.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(OvernightIndexRatesMapping.Meta.INSTANCE);
  }
   ...
   */
  public static OvernightIndexRatesMapping.Builder builder() {
    return new OvernightIndexRatesMapping.Builder();
  }

  private OvernightIndexRatesMapping(
  ...
  @Override
  public OvernightIndexRatesMapping.Meta metaBean() {
    return OvernightIndexRatesMapping.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      OvernightIndexRatesMapping other = (OvernightIndexRatesMapping) obj;
  ...
  public String toString() {
    ...
    buf.append("OvernightIndexRatesMapping{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", OvernightIndexRatesMapping.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<MarketDataFeed> marketDataFeed = DirectMetaProperty.ofImmutable(
        this, "marketDataFeed", OvernightIndexRatesMapping.class, MarketDataFeed.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public OvernightIndexRatesMapping.Builder builder() {
      return new OvernightIndexRatesMapping.Builder();
    }

    @Override
    public Class<? extends OvernightIndexRatesMapping> beanType() {
      return OvernightIndexRatesMapping.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -382645893:  // curveGroupName
          return ((OvernightIndexRatesMapping) bean).getCurveGroupName();
        case 842621124:  // marketDataFeed
          return ((OvernightIndexRatesMapping) bean).getMarketDataFeed();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code OvernightIndexRatesMapping}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<OvernightIndexRatesMapping> {
     ...
     */
    private Builder(OvernightIndexRatesMapping beanToCopy) {
    ...
    @Override
    public OvernightIndexRatesMapping build() {
      return new OvernightIndexRatesMapping(
          curveGroupName,
          marketDataFeed);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(96);
      buf.append("OvernightIndexRatesMapping.Builder{");
