...
/**
 * Market data mapping that accepts a {@link OvernightIndexCurveKey} and returns a {@link OvernightIndexCurveId}
 * with the name of the curve group that is the source of the curve.
 */
@BeanDefinition(builderScope = "private")
public final class OvernightIndexCurveMapping
    implements MarketDataMapping<Curve, OvernightIndexCurveKey>, ImmutableBean, Serializable {
  ...
  //-------------------------------------------------------------------------
  /**
   * Returns a mapping that accepts a {@link OvernightIndexCurveKey} and returns a {@link OvernightIndexCurveId}
   * with the name of the curve group that is the source of the curve.
   *
   ...
   */
  public static OvernightIndexCurveMapping of(CurveGroupName curveGroupName, MarketDataFeed marketDataFeed) {
    return new OvernightIndexCurveMapping(curveGroupName, marketDataFeed);
  }

  //-------------------------------------------------------------------------
  @Override
  public Class<OvernightIndexCurveKey> getMarketDataKeyType() {
    return OvernightIndexCurveKey.class;
  }

  @Override
  public OvernightIndexCurveId getIdForKey(OvernightIndexCurveKey key) {
    return OvernightIndexCurveId.of(key.getIndex(), curveGroupName, marketDataFeed);
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code OvernightIndexCurveMapping}.
   * @return the meta-bean, not null
   */
  public static OvernightIndexCurveMapping.Meta meta() {
    return OvernightIndexCurveMapping.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(OvernightIndexCurveMapping.Meta.INSTANCE);
  }
  ...
  private OvernightIndexCurveMapping(
  ...
  @Override
  public OvernightIndexCurveMapping.Meta metaBean() {
    return OvernightIndexCurveMapping.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      OvernightIndexCurveMapping other = (OvernightIndexCurveMapping) obj;
  ...
  public String toString() {
    ...
    buf.append("OvernightIndexCurveMapping{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", OvernightIndexCurveMapping.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<MarketDataFeed> marketDataFeed = DirectMetaProperty.ofImmutable(
        this, "marketDataFeed", OvernightIndexCurveMapping.class, MarketDataFeed.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends OvernightIndexCurveMapping> builder() {
      return new OvernightIndexCurveMapping.Builder();
    }

    @Override
    public Class<? extends OvernightIndexCurveMapping> beanType() {
      return OvernightIndexCurveMapping.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -382645893:  // curveGroupName
          return ((OvernightIndexCurveMapping) bean).getCurveGroupName();
        case 842621124:  // marketDataFeed
          return ((OvernightIndexCurveMapping) bean).getMarketDataFeed();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code OvernightIndexCurveMapping}.
   */
  private static final class Builder extends DirectFieldsBeanBuilder<OvernightIndexCurveMapping> {
    ...
    @Override
    public OvernightIndexCurveMapping build() {
      return new OvernightIndexCurveMapping(
          curveGroupName,
          marketDataFeed);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(96);
      buf.append("OvernightIndexCurveMapping.Builder{");
