...
/**
 * Market data mapping that accepts a {@link PriceIndexCurveKey} and returns a {@link PriceIndexCurveId}
 * with the name of the curve group that is the source of the curve.
 */
@BeanDefinition(builderScope = "private")
public final class PriceIndexCurveMapping
    implements MarketDataMapping<Curve, PriceIndexCurveKey>, ImmutableBean, Serializable {
  ...
  //-------------------------------------------------------------------------
  /**
   * Returns a mapping that accepts a {@link PriceIndexCurveKey} and returns a {@link PriceIndexCurveId}
   * with the name of the curve group that is the source of the curve.
   *
   ...
   */
  public static PriceIndexCurveMapping of(CurveGroupName curveGroupName, MarketDataFeed marketDataFeed) {
    return new PriceIndexCurveMapping(curveGroupName, marketDataFeed);
  }

  //-------------------------------------------------------------------------
  @Override
  public Class<PriceIndexCurveKey> getMarketDataKeyType() {
    return PriceIndexCurveKey.class;
  }

  @Override
  public PriceIndexCurveId getIdForKey(PriceIndexCurveKey key) {
    return PriceIndexCurveId.of(key.getIndex(), curveGroupName, marketDataFeed);
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code PriceIndexCurveMapping}.
   * @return the meta-bean, not null
   */
  public static PriceIndexCurveMapping.Meta meta() {
    return PriceIndexCurveMapping.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(PriceIndexCurveMapping.Meta.INSTANCE);
  }
  ...
  private PriceIndexCurveMapping(
  ...
  @Override
  public PriceIndexCurveMapping.Meta metaBean() {
    return PriceIndexCurveMapping.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      PriceIndexCurveMapping other = (PriceIndexCurveMapping) obj;
  ...
  public String toString() {
    ...
    buf.append("PriceIndexCurveMapping{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", PriceIndexCurveMapping.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<MarketDataFeed> marketDataFeed = DirectMetaProperty.ofImmutable(
        this, "marketDataFeed", PriceIndexCurveMapping.class, MarketDataFeed.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends PriceIndexCurveMapping> builder() {
      return new PriceIndexCurveMapping.Builder();
    }

    @Override
    public Class<? extends PriceIndexCurveMapping> beanType() {
      return PriceIndexCurveMapping.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -382645893:  // curveGroupName
          return ((PriceIndexCurveMapping) bean).getCurveGroupName();
        case 842621124:  // marketDataFeed
          return ((PriceIndexCurveMapping) bean).getMarketDataFeed();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code PriceIndexCurveMapping}.
   */
  private static final class Builder extends DirectFieldsBeanBuilder<PriceIndexCurveMapping> {
    ...
    @Override
    public PriceIndexCurveMapping build() {
      return new PriceIndexCurveMapping(
          curveGroupName,
          marketDataFeed);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(96);
      buf.append("PriceIndexCurveMapping.Builder{");
