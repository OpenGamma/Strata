 ...
 * <p>
 * This uses a {@link SwaptionMarketLookup} to provide a view on {@link MarketData}.
 */
@BeanDefinition(style = "light")
final class DefaultSwaptionMarketView
    implements SwaptionMarketView, ImmutableBean {
   ...
   */
  public static DefaultSwaptionMarketView of(
      SwaptionMarketLookup lookup,
      MarketData marketData) {

    return new DefaultSwaptionMarketView(lookup, marketData);
  }

  @ImmutableConstructor
  private DefaultSwaptionMarketView(
      SwaptionMarketLookup lookup,
      MarketData marketData) {
  ...
  //-------------------------------------------------------------------------
  @Override
  public SwaptionMarketView withMarketData(MarketData marketData) {
    return DefaultSwaptionMarketView.of(lookup, marketData);
  }
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code DefaultSwaptionMarketView}.
   */
  private static MetaBean META_BEAN = LightMetaBean.of(DefaultSwaptionMarketView.class);
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      DefaultSwaptionMarketView other = (DefaultSwaptionMarketView) obj;
  ...
  public String toString() {
    ...
    buf.append("DefaultSwaptionMarketView{");
