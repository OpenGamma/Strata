...
public final class CurveParallelShifts
  ...
  public static CurveParallelShifts absolute(double... shiftAmounts) {
    return new CurveParallelShifts(ShiftType.ABSOLUTE, shiftAmounts);
  }
  ...
  private Curve applyShift(Curve curve, int scenarioIndex) {
    double shiftAmount = shiftAmounts[scenarioIndex];
  ...
  private CurveParallelShifts(
    ...
    this.shiftAmounts = shiftAmounts.clone();
  }
   ...
   * @return the value of the property, not null
   */
  public double[] getShiftAmounts() {
    return (shiftAmounts != null ? shiftAmounts.clone() : null);
  }
  ...
  public static final class Meta extends DirectMetaBean {
     ...
     */
    private final MetaProperty<double[]> shiftAmounts = DirectMetaProperty.ofImmutable(
        this, "shiftAmounts", CurveParallelShifts.class, double[].class);
    /**
     * The meta-properties.
     */
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<double[]> shiftAmounts() {
      return shiftAmounts;
    }
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case 893345500:  // shiftType
          ...
          break;
        case 2011836473:  // shiftAmounts
          this.shiftAmounts = (double[]) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
