...
public final class ZeroRateDiscountFactorsMapping
   ...
   * <p>
   * The result will map a {@link DiscountFactorsKey} to a {@link ZeroRateDiscountFactorsId}
   ...
   */
  public static ZeroRateDiscountFactorsMapping of(CurveGroupName curveGroupName, MarketDataFeed marketDataFeed) {
    return new ZeroRateDiscountFactorsMapping(curveGroupName, marketDataFeed);
  }
  ...
  public MarketDataId<DiscountFactors> getIdForKey(DiscountFactorsKey key) {
    return ZeroRateDiscountFactorsId.of(key.getCurrency(), curveGroupName, marketDataFeed);
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code ZeroRateDiscountFactorsMapping}.
   * @return the meta-bean, not null
   */
  public static ZeroRateDiscountFactorsMapping.Meta meta() {
    return ZeroRateDiscountFactorsMapping.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(ZeroRateDiscountFactorsMapping.Meta.INSTANCE);
  }
   ...
   */
  public static ZeroRateDiscountFactorsMapping.Builder builder() {
    return new ZeroRateDiscountFactorsMapping.Builder();
  }

  private ZeroRateDiscountFactorsMapping(
  ...
  @Override
  public ZeroRateDiscountFactorsMapping.Meta metaBean() {
    return ZeroRateDiscountFactorsMapping.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ZeroRateDiscountFactorsMapping other = (ZeroRateDiscountFactorsMapping) obj;
  ...
  public String toString() {
    ...
    buf.append("ZeroRateDiscountFactorsMapping{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", ZeroRateDiscountFactorsMapping.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<MarketDataFeed> marketDataFeed = DirectMetaProperty.ofImmutable(
        this, "marketDataFeed", ZeroRateDiscountFactorsMapping.class, MarketDataFeed.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public ZeroRateDiscountFactorsMapping.Builder builder() {
      return new ZeroRateDiscountFactorsMapping.Builder();
    }

    @Override
    public Class<? extends ZeroRateDiscountFactorsMapping> beanType() {
      return ZeroRateDiscountFactorsMapping.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -382645893:  // curveGroupName
          return ((ZeroRateDiscountFactorsMapping) bean).getCurveGroupName();
        case 842621124:  // marketDataFeed
          return ((ZeroRateDiscountFactorsMapping) bean).getMarketDataFeed();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code ZeroRateDiscountFactorsMapping}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<ZeroRateDiscountFactorsMapping> {
     ...
     */
    private Builder(ZeroRateDiscountFactorsMapping beanToCopy) {
    ...
    @Override
    public ZeroRateDiscountFactorsMapping build() {
      return new ZeroRateDiscountFactorsMapping(
          curveGroupName,
          marketDataFeed);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(96);
      buf.append("ZeroRateDiscountFactorsMapping.Builder{");
