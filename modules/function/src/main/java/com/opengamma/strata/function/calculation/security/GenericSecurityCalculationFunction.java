 ...
 * </ul>
 */
public class GenericSecurityCalculationFunction
  ...
  private static final ImmutableMap<Measure, SingleMeasureCalculation> CALCULATORS =
      ImmutableMap.<Measure, SingleMeasureCalculation>builder()
          .put(Measures.PRESENT_VALUE, GenericSecurityMeasureCalculations::presentValue)
          .build();
   ...
   * Creates an instance.
   */
  public GenericSecurityCalculationFunction() {
  }
