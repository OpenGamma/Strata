...
public class Interpolator1DDoubleQuadraticDataBundleTest {
  ...
  public void testGetters() {
    ...
    assertEquals(DATA.firstValue(), QUADRATIC.apply(0.), EPS);
    assertEquals(DATA.get(6.), QUADRATIC.apply(6.), EPS);
    ...
    assertEquals(DATA.higherValue(7.), QUADRATIC.apply(9.), EPS);
    assertEquals(DATA.lastKey(), 27., EPS);
    assertEquals(DATA.lastValue(), QUADRATIC.apply(27.), EPS);
    ...
    assertEquals(boundedValues.getLowerBoundValue(), QUADRATIC.apply(3.), EPS);
    assertEquals(boundedValues.getHigherBoundKey(), 6., EPS);
    assertEquals(boundedValues.getHigherBoundValue(), QUADRATIC.apply(6.), EPS);
  }
