...
public final class QuantileResult
   ...
   */
  public static QuantileResult.Builder builder() {
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    @Override
    public QuantileResult.Builder builder() {
      return new QuantileResult.Builder();
    }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<QuantileResult> {
     ...
     */
    private Builder(QuantileResult beanToCopy) {
      this.value = beanToCopy.getValue();
      this.indices = (beanToCopy.getIndices() != null ? beanToCopy.getIndices().clone() : null);
      this.weights = beanToCopy.getWeights();
    }
    ...
    /**
     * Sets the weights.
     * @param weights  the new value, not null
     * @return this, for chaining, not null
     */
    public Builder weights(DoubleArray weights) {
      JodaBeanUtils.notNull(weights, "weights");
      this.weights = weights;
      return this;
    }
