...
public class FxSwapTest {
  ...
  private static final Fx NEAR_LEG = Fx.of(GBP_P1000, USD_M1600, DATE_2011_11_21);
  private static final Fx FAR_LEG = Fx.of(GBP_M1000, USD_P1550, DATE_2011_12_21);
  ...
  public void test_of_wrongBaseCurrency() {
    Fx nearLeg = Fx.of(EUR_P1590, USD_M1600, DATE_2011_11_21);
    assertThrowsIllegalArg(() -> FxSwap.of(nearLeg, FAR_LEG));
  }

  public void test_of_wrongCounterCurrency() {
    Fx nearLeg = Fx.of(USD_P1550, EUR_P1590.negated(), DATE_2011_11_21);
    Fx farLeg = Fx.of(GBP_M1000, EUR_P1590, DATE_2011_12_21);
    assertThrowsIllegalArg(() -> FxSwap.of(nearLeg, farLeg));
  }

  public void test_of_sameSign() {
    Fx farLeg = Fx.of(GBP_M1000.negated(), USD_P1550.negated(), DATE_2011_12_21);
  ...
  public void test_ofForwardPoints() {
    ...
    Fx nearLegExp = Fx.of(GBP_P1000, CurrencyAmount.of(USD, -1000.0 * nearRate), DATE_2011_11_21);
    Fx farLegExp = Fx.of(GBP_M1000, CurrencyAmount.of(USD, 1000.0 * (nearRate + fwdPoint)), DATE_2011_12_21);
  ...
  public void converage() {
    ...
    Fx nearLeg = Fx.of(CurrencyAmount.of(GBP, 1_100), CurrencyAmount.of(USD, -1_650), DATE_2011_11_21);
    Fx farLeg = Fx.of(CurrencyAmount.of(GBP, -1_100), CurrencyAmount.of(USD, 1_750), DATE_2011_12_21);
