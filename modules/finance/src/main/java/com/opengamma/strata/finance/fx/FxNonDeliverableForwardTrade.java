 ...
 * <p>
 * An Over-The-Counter (OTC) trade in an {@link FxNonDeliverableForward}.
 * <p>
...
public final class FxNonDeliverableForwardTrade
  ...
  private final FxNonDeliverableForward product;
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code FxNonDeliverableForwardTrade}.
   * @return the meta-bean, not null
   */
  public static FxNonDeliverableForwardTrade.Meta meta() {
    return FxNonDeliverableForwardTrade.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(FxNonDeliverableForwardTrade.Meta.INSTANCE);
  }
   ...
   */
  public static FxNonDeliverableForwardTrade.Builder builder() {
    return new FxNonDeliverableForwardTrade.Builder();
  }
  ...
  @Override
  public FxNonDeliverableForwardTrade.Meta metaBean() {
    return FxNonDeliverableForwardTrade.Meta.INSTANCE;
  }
   ...
   */
  @Override
  public FxNonDeliverableForward getProduct() {
    return product;
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<TradeInfo> tradeInfo = DirectMetaProperty.ofImmutable(
        this, "tradeInfo", FxNonDeliverableForwardTrade.class, TradeInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<FxNonDeliverableForward> product = DirectMetaProperty.ofImmutable(
        this, "product", FxNonDeliverableForwardTrade.class, FxNonDeliverableForward.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public FxNonDeliverableForwardTrade.Builder builder() {
      return new FxNonDeliverableForwardTrade.Builder();
    }

    @Override
    public Class<? extends FxNonDeliverableForwardTrade> beanType() {
      return FxNonDeliverableForwardTrade.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<FxNonDeliverableForward> product() {
      return product;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -309474065:  // product
          return ((FxNonDeliverableForwardTrade) bean).getProduct();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code FxNonDeliverableForwardTrade}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<FxNonDeliverableForwardTrade> {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case 752580658:  // tradeInfo
          ...
          break;
        case -309474065:  // product
          this.product = (FxNonDeliverableForward) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
     ...
     * @return this, for chaining, not null
     */
    public Builder product(FxNonDeliverableForward product) {
      JodaBeanUtils.notNull(product, "product");
      this.product = product;
      return this;
    }
