 ...
 * <p>
 * Yield of a bond security is a conventional number representing the internal rate of return of standardised 
 * cash flows.
 * When calculating accrued interest from the yield, it is necessary to use a formula specific to each yield 
 * convention. Accordingly, the computation of price, convexity and duration from the yield should be based on this 
 * yield convention. 
 * <p>
