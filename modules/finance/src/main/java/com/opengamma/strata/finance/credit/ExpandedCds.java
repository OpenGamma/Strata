...
public class ExpandedCds implements CdsProduct, ImmutableBean, Serializable {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code ExpandedCds}.
   * @return the meta-bean, not null
   */
  public static ExpandedCds.Meta meta() {
    return ExpandedCds.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(ExpandedCds.Meta.INSTANCE);
  }
   ...
   */
  public static ExpandedCds.Builder builder() {
    return new ExpandedCds.Builder();
  }
  ...
  @Override
  public ExpandedCds.Meta metaBean() {
    return ExpandedCds.Meta.INSTANCE;
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<LocalDate> accStartDate = DirectMetaProperty.ofImmutable(
        this, "accStartDate", ExpandedCds.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<Boolean> payAccOnDefault = DirectMetaProperty.ofImmutable(
        this, "payAccOnDefault", ExpandedCds.class, Boolean.TYPE);
    /**
    ...
    private final MetaProperty<Period> paymentInterval = DirectMetaProperty.ofImmutable(
        this, "paymentInterval", ExpandedCds.class, Period.class);
    /**
    ...
    private final MetaProperty<BusinessDayConvention> businessdayAdjustmentConvention = DirectMetaProperty.ofImmutable(
        this, "businessdayAdjustmentConvention", ExpandedCds.class, BusinessDayConvention.class);
    /**
    ...
    private final MetaProperty<HolidayCalendar> calendar = DirectMetaProperty.ofImmutable(
        this, "calendar", ExpandedCds.class, HolidayCalendar.class);
    /**
    ...
    private final MetaProperty<Double> upfrontFeeAmount = DirectMetaProperty.ofImmutable(
        this, "upfrontFeeAmount", ExpandedCds.class, Double.TYPE);
    /**
    ...
    @Override
    public ExpandedCds.Builder builder() {
      return new ExpandedCds.Builder();
    }

    @Override
    public Class<? extends ExpandedCds> beanType() {
      return ExpandedCds.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -988493655:  // payAccOnDefault
          return ((ExpandedCds) bean).isPayAccOnDefault();
        case -230746901:  // paymentInterval
          return ((ExpandedCds) bean).getPaymentInterval();
        case -31408449:  // stubConvention
          return ((ExpandedCds) bean).getStubConvention();
        case -283944262:  // businessdayAdjustmentConvention
          return ((ExpandedCds) bean).getBusinessdayAdjustmentConvention();
        case -178324674:  // calendar
          return ((ExpandedCds) bean).getCalendar();
        case -1387075166:  // accrualDayCount
          return ((ExpandedCds) bean).getAccrualDayCount();
        case -405622799:  // buySellProtection
          return ((ExpandedCds) bean).getBuySellProtection();
        case 2020904624:  // upfrontFeeAmount
          return ((ExpandedCds) bean).getUpfrontFeeAmount();
        case 508500860:  // upfrontFeePaymentDate
          return ((ExpandedCds) bean).getUpfrontFeePaymentDate();
        case -1354573786:  // coupon
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code ExpandedCds}.
   */
  public static class Builder extends DirectFieldsBeanBuilder<ExpandedCds> {
    ...
    @Override
    public ExpandedCds build() {
      return new ExpandedCds(this);
    }
