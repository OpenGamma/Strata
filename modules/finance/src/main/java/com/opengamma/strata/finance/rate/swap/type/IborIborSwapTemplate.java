...
public final class IborIborSwapTemplate
   ...
   * @return the trade
   */
  public SwapTrade toTrade(StandardId id, LocalDate tradeDate, BuySell buySell, double notional, double spread) {
    return convention.toTrade(id, tradeDate, periodToStart, tenor, buySell, notional, spread);
  }
