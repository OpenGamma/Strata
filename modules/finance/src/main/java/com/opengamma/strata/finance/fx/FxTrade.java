...
public final class FxTrade
    implements ProductTrade<Fx>, ImmutableBean, Serializable {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code FxTrade}.
   * @return the meta-bean, not null
   */
  public static FxTrade.Meta meta() {
    return FxTrade.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(FxTrade.Meta.INSTANCE);
  }
   ...
   */
  public static FxTrade.Builder builder() {
    return new FxTrade.Builder();
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<TradeInfo> tradeInfo = DirectMetaProperty.ofImmutable(
        this, "tradeInfo", FxTrade.class, TradeInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<Fx> product = DirectMetaProperty.ofImmutable(
        this, "product", FxTrade.class, Fx.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public FxTrade.Builder builder() {
      return new FxTrade.Builder();
    }

    @Override
    public Class<? extends FxTrade> beanType() {
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<Fx> product() {
      return product;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 752580658:  // tradeInfo
          return ((FxTrade) bean).getTradeInfo();
        case -309474065:  // product
          return ((FxTrade) bean).getProduct();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code FxTrade}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<FxTrade> {
     ...
     */
    private Builder(FxTrade beanToCopy) {
     ...
     * @return this, for chaining, not null
     */
    public Builder product(Fx product) {
      JodaBeanUtils.notNull(product, "product");
      this.product = product;
      return this;
    }
