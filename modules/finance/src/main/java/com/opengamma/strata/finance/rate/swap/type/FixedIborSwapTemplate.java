...
public final class FixedIborSwapTemplate
   ...
   * @return the trade
   */
  public SwapTrade toTrade(StandardId id, LocalDate tradeDate, BuySell buySell, double notional, double fixedRate) {
    return convention.toTrade(id, tradeDate, periodToStart, tenor, buySell, notional, fixedRate);
  }
