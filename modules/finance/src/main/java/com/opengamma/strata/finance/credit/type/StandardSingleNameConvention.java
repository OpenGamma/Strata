...
//    ArgChecker.inOrderOrEqual(tradeDate, startDate, "tradeDate", "startDate");
  ...
  public String toString() {
    ...
    buf.append("settleLag").append('=').append(getSettleLag()).append(',').append(' ');
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Integer> settleLag = DirectMetaProperty.ofImmutable(
        this, "settleLag", StandardSingleNameConvention.class, Integer.TYPE);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case 1526370375:  // settleLag
          return ((StandardSingleNameConvention) bean).getSettleLag();
        case -31408449:  // stubConvention
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<StandardSingleNameConvention> {
    ...
    public String toString() {
      ...
      buf.append("settleLag").append('=').append(JodaBeanUtils.toString(settleLag)).append(',').append(' ');
      buf.append("stubConvention").append('=').append(JodaBeanUtils.toString(stubConvention));
      buf.append('}');
      return buf.toString();
    }
