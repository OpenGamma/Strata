...
public final class FraTemplate
   ...
   * @return the trade
   */
  public FraTrade toTrade(LocalDate tradeDate, BuySell buySell, double notional, double fixedRate) {
    return convention.toTrade(tradeDate, periodToStart, periodToEnd, buySell, notional, fixedRate);
  }
