...
public final class FraTemplate
   ...
   * @return the trade
   */
  public FraTrade toTrade(StandardId id, LocalDate tradeDate, BuySell buySell, double notional, double fixedRate) {
    return convention.toTrade(id, tradeDate, periodToStart, periodToEnd, buySell, notional, fixedRate);
  }
