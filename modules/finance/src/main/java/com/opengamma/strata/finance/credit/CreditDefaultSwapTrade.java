 ...
 * <p>
 * An Over-The-Counter (OTC) trade in a {@link CreditDefaultSwap}.
 * <p>
 */
@BeanDefinition
public final class CreditDefaultSwapTrade
    implements ProductTrade<CreditDefaultSwap>, ImmutableBean, Serializable {
   ...
   */
  @PropertyDefinition(validate = "notNull", overrideGet = true)
  private final CreditDefaultSwap product;
  ...
  public static CreditDefaultSwapTrade of(
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code CreditDefaultSwapTrade}.
   * @return the meta-bean, not null
   */
  public static CreditDefaultSwapTrade.Meta meta() {
    return CreditDefaultSwapTrade.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(CreditDefaultSwapTrade.Meta.INSTANCE);
  }
   ...
   */
  public static CreditDefaultSwapTrade.Builder builder() {
    return new CreditDefaultSwapTrade.Builder();
  }

  private CreditDefaultSwapTrade(
      StandardId standardId,
      TradeInfo tradeInfo,
      CreditDefaultSwap product) {
  ...
  @Override
  public CreditDefaultSwapTrade.Meta metaBean() {
    return CreditDefaultSwapTrade.Meta.INSTANCE;
  }
   ...
   */
  @Override
  public CreditDefaultSwap getProduct() {
    return product;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      CreditDefaultSwapTrade other = (CreditDefaultSwapTrade) obj;
  ...
  public String toString() {
    ...
    buf.append("CreditDefaultSwapTrade{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<StandardId> standardId = DirectMetaProperty.ofImmutable(
        this, "standardId", CreditDefaultSwapTrade.class, StandardId.class);
    /**
    ...
    private final MetaProperty<TradeInfo> tradeInfo = DirectMetaProperty.ofImmutable(
        this, "tradeInfo", CreditDefaultSwapTrade.class, TradeInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<CreditDefaultSwap> product = DirectMetaProperty.ofImmutable(
        this, "product", CreditDefaultSwapTrade.class, CreditDefaultSwap.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public CreditDefaultSwapTrade.Builder builder() {
      return new CreditDefaultSwapTrade.Builder();
    }

    @Override
    public Class<? extends CreditDefaultSwapTrade> beanType() {
      return CreditDefaultSwapTrade.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<CreditDefaultSwap> product() {
      return product;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -1284477768:  // standardId
          return ((CreditDefaultSwapTrade) bean).getStandardId();
        case 752580658:  // tradeInfo
          return ((CreditDefaultSwapTrade) bean).getTradeInfo();
        case -309474065:  // product
          return ((CreditDefaultSwapTrade) bean).getProduct();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code CreditDefaultSwapTrade}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<CreditDefaultSwapTrade> {

    private StandardId standardId;
    private TradeInfo tradeInfo;
    private CreditDefaultSwap product;
     ...
     */
    private Builder(CreditDefaultSwapTrade beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case 752580658:  // tradeInfo
          ...
          break;
        case -309474065:  // product
          this.product = (CreditDefaultSwap) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
    ...
    @Override
    public CreditDefaultSwapTrade build() {
      return new CreditDefaultSwapTrade(
          standardId,
          tradeInfo,
          product);
    }
     ...
     * @return this, for chaining, not null
     */
    public Builder product(CreditDefaultSwap product) {
      JodaBeanUtils.notNull(product, "product");
      this.product = product;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("CreditDefaultSwapTrade.Builder{");
