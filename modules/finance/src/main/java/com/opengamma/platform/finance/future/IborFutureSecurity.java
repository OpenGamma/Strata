...
/**
 * A security representing an exchange-traded IBOR future.
 * <p>
 * A listed security based on an {@link IborFuture}.
 * For example, the fungible security of the exchange-traded CME Eurodollar 3 month future.
 */
@BeanDefinition
public final class IborFutureSecurity
   ...
   */
  public static final SecurityType TYPE = SecurityType.of("IborFuture");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<StandardId> standardId = DirectMetaProperty.ofImmutable(
        this, "standardId", IborFutureSecurity.class, StandardId.class);
    /**
     * The meta-property for the {@code attributes} property.
     */
    @SuppressWarnings({"unchecked", "rawtypes" })
    private final MetaProperty<ImmutableMap<String, String>> attributes = DirectMetaProperty.ofImmutable(
        this, "attributes", IborFutureSecurity.class, (Class) ImmutableMap.class);
    /**
    ...
    private final MetaProperty<SecurityType> securityType = DirectMetaProperty.ofDerived(
        this, "securityType", IborFutureSecurity.class, SecurityType.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -1284477768:  // standardId
          return ((IborFutureSecurity) bean).getStandardId();
        case 405645655:  // attributes
          return ((IborFutureSecurity) bean).getAttributes();
        case -309474065:  // product
          return ((IborFutureSecurity) bean).getProduct();
        case 808245914:  // securityType
          return ((IborFutureSecurity) bean).getSecurityType();
      }
