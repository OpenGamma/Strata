...
public final class ResetSchedule
   ...
   */
  @PropertyDefinition(validate = "notNull")
  private final IborRateAveragingMethod rateAveragingMethod;

  //-------------------------------------------------------------------------
  @ImmutableDefaults
  private static void applyDefaults(Builder builder) {
    builder.rateAveragingMethod(IborRateAveragingMethod.UNWEIGHTED);
  }
  ...
  private ResetSchedule(
      ...
      IborRateAveragingMethod rateAveragingMethod) {
   ...
   * @return the value of the property, not null
   */
  public IborRateAveragingMethod getRateAveragingMethod() {
  ...
  public static final class Meta extends DirectMetaBean {
     ...
     */
    private final MetaProperty<IborRateAveragingMethod> rateAveragingMethod = DirectMetaProperty.ofImmutable(
        this, "rateAveragingMethod", ResetSchedule.class, IborRateAveragingMethod.class);
    /**
     * The meta-properties.
     */
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<IborRateAveragingMethod> rateAveragingMethod() {
      return rateAveragingMethod;
    }
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<ResetSchedule> {
    ...
    private IborRateAveragingMethod rateAveragingMethod;
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case -1777046470:  // resetBusinessDayAdjustment
          ...
          break;
        case 154998811:  // rateAveragingMethod
          this.rateAveragingMethod = (IborRateAveragingMethod) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
     ...
     * @return this, for chaining, not null
     */
    public Builder rateAveragingMethod(IborRateAveragingMethod rateAveragingMethod) {
      JodaBeanUtils.notNull(rateAveragingMethod, "rateAveragingMethod");
      this.rateAveragingMethod = rateAveragingMethod;
      return this;
    }
