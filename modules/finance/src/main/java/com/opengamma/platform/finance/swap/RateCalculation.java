 ...
 * <p>
 * An interest rate swap leg is defined by {@link RateSwapLeg}.
...
public interface RateCalculation
  ...
  /**
   * Expands this accrual definition to accrual periods based on the specified schedule.
   * <p>
   ...
   */
  public abstract ImmutableList<RateAccrualPeriod> toExpanded(Schedule schedule);
