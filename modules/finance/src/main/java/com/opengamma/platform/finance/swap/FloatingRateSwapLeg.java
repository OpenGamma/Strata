...
/**
 * A floating interest rate swap leg.
 * <p>
 * This defines a single swap leg paying a floating interest rate.
 * <p>
 ...
 * defined in {@link FloatingRateCalculation}.
 * <p>
 ...
 * <li>FX reset notionals that change at a payment period boundary
 * <li>One floating rate index, optional linear interpolation in stubs
 * <li>Gearing and spread that change at an accrual period boundary
 * </ul>
 */
@BeanDefinition
public final class FloatingRateSwapLeg
  ...
  /**
   * The definition of the calculation for the floating rate.
   * <p>
   ...
   */
  @PropertyDefinition(validate = "notNull")
  private final FloatingRateCalculation calculation;
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code FloatingRateSwapLeg}.
   * @return the meta-bean, not null
   */
  public static FloatingRateSwapLeg.Meta meta() {
    return FloatingRateSwapLeg.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(FloatingRateSwapLeg.Meta.INSTANCE);
  }
   ...
   */
  public static FloatingRateSwapLeg.Builder builder() {
    return new FloatingRateSwapLeg.Builder();
  }

  private FloatingRateSwapLeg(
      PeriodicSchedule accrualPeriods,
      PaymentSchedule paymentPeriods,
      FloatingRateCalculation calculation) {
  ...
  @Override
  public FloatingRateSwapLeg.Meta metaBean() {
    return FloatingRateSwapLeg.Meta.INSTANCE;
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the definition of the calculation for the floating rate.
   * <p>
   * The floating rate is calculated by observing a market value at specific dates.
   * The schedule of observation is known as the reset frequency and is smaller than
   * or equal to the accrual frequency. The actual dates of observation are known as
   ...
   * @return the value of the property, not null
   */
  public FloatingRateCalculation getCalculation() {
    return calculation;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      FloatingRateSwapLeg other = (FloatingRateSwapLeg) obj;
  ...
  public String toString() {
    ...
    buf.append("FloatingRateSwapLeg{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PeriodicSchedule> accrualPeriods = DirectMetaProperty.ofImmutable(
        this, "accrualPeriods", FloatingRateSwapLeg.class, PeriodicSchedule.class);
    /**
    ...
    private final MetaProperty<PaymentSchedule> paymentPeriods = DirectMetaProperty.ofImmutable(
        this, "paymentPeriods", FloatingRateSwapLeg.class, PaymentSchedule.class);
    /**
     * The meta-property for the {@code calculation} property.
     */
    private final MetaProperty<FloatingRateCalculation> calculation = DirectMetaProperty.ofImmutable(
        this, "calculation", FloatingRateSwapLeg.class, FloatingRateCalculation.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public FloatingRateSwapLeg.Builder builder() {
      return new FloatingRateSwapLeg.Builder();
    }

    @Override
    public Class<? extends FloatingRateSwapLeg> beanType() {
      return FloatingRateSwapLeg.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<FloatingRateCalculation> calculation() {
      return calculation;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -92208605:  // accrualPeriods
          return ((FloatingRateSwapLeg) bean).getAccrualPeriods();
        case -1674414612:  // paymentPeriods
          return ((FloatingRateSwapLeg) bean).getPaymentPeriods();
        case -934682935:  // calculation
          return ((FloatingRateSwapLeg) bean).getCalculation();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code FloatingRateSwapLeg}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<FloatingRateSwapLeg> {

    private PeriodicSchedule accrualPeriods;
    private PaymentSchedule paymentPeriods;
    private FloatingRateCalculation calculation;
     ...
     */
    private Builder(FloatingRateSwapLeg beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case -1674414612:  // paymentPeriods
          ...
          break;
        case -934682935:  // calculation
          this.calculation = (FloatingRateCalculation) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
    ...
    @Override
    public FloatingRateSwapLeg build() {
      return new FloatingRateSwapLeg(
          accrualPeriods,
          paymentPeriods,
          calculation);
    }
     ...
     * @return this, for chaining, not null
     */
    public Builder calculation(FloatingRateCalculation calculation) {
      JodaBeanUtils.notNull(calculation, "calculation");
      this.calculation = calculation;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("FloatingRateSwapLeg.Builder{");
