...
/**
 * Defines the calculation of a rate from a single Overnight index that is averaged daily.
 * <p>
...
public final class OvernightAveragedRate
   ...
   */
  public static OvernightAveragedRate of(OvernightIndex index, LocalDate startDate, LocalDate endDate) {
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<LocalDate> startDate = DirectMetaProperty.ofImmutable(
        this, "startDate", OvernightAveragedRate.class, LocalDate.class);
    /**
