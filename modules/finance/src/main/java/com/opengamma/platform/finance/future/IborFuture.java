...
public final class IborFuture
  ...
  public ExpandedIborFuture expand() {
    return ExpandedIborFuture.builder()
        .currency(currency)
        .notional(notional)
        .accrualFactor(accrualFactor)
        .rate(IborRateObservation.of(index, lastTradeDate))
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Integer> roundingDecimalPlaces = DirectMetaProperty.ofImmutable(
        this, "roundingDecimalPlaces", IborFuture.class, Integer.TYPE);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1942514743:  // roundingDecimalPlaces
          return ((IborFuture) bean).getRoundingDecimalPlaces();
      }
