...
public final class DefaultMarketDataMappings implements MarketDataMappings, ImmutableBean, Serializable {
   ...
   */
  public static DefaultMarketDataMappings of(MarketDataFeed marketDataFeed, List<? extends MarketDataMapping<?, ?>> mappings) {
   ...
   * @return a set of mappings containing the specified feed and mapping instances
   */
  public static DefaultMarketDataMappings of(MarketDataFeed marketDataFeed, MarketDataMapping<?, ?>... mappings) {
  ...
  public <T> MarketDataBox<T> getValue(MarketDataKey<T> key, CalculationEnvironment marketData) {
    MarketDataId<T> id = getIdForKey(key);
  ...
  public LocalDateDoubleTimeSeries getTimeSeries(ObservableKey key, CalculationEnvironment marketData) {
    ObservableId id = getIdForObservableKey(key);
