...
/**
 * Pricing rules that combine multiple underlying rule sets.
 * <p>
...
final class CompositePricingRules implements PricingRules, ImmutableBean {
  ...
  @Override
  public PricingRules composedWith(PricingRules otherRules) {
    List<PricingRules> newRules = ImmutableList.<PricingRules>builder().addAll(rules).add(otherRules).build();
