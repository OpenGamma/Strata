...
/**
 * Pricing rules that provide no matches.
 * <p>
 * These rules always returns an empty optional from {@link #functionGroup}.
 */
...
final class EmptyPricingRules implements PricingRules, ImmutableBean {
  ...
  public PricingRules composedWith(PricingRules rules) {
    // no point including this rule as it never returns any valid configuration
