...
public final class CalculationTasksConfig implements ImmutableBean, Serializable {
  ...
  //-------------------------------------------------------------------------
  /**
   * Creates the calculation tasks configuration from individual configurations.
   * <p>
   * One task will be created for each task configuration.
   * 
   * @param taskConfigurations  the configurations, one per task
   * @param columns  the columns to be calculated
   * @return the configurations
   */
  public static CalculationTasksConfig of(List<CalculationTaskConfig> taskConfigurations, List<Column> columns) {
    return new CalculationTasksConfig(taskConfigurations, columns);
  }

  //-------------------------------------------------------------------------
  /**
   * Creates the tasks instance that defines the calculation.
   * <p>
   * One task will be created for each task configuration.
   * 
   * @return the the tasks that defines the calculation
   */
  public CalculationTasks createTasks() {
    List<CalculationTask> tasks = taskConfigurations.stream()
        .map(CalculationTaskConfig::createTask)
        .collect(toImmutableList());
    return CalculationTasks.of(tasks, columns);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    @Override
    public BeanBuilder<? extends CalculationTasksConfig> builder() {
   ...
   */
  private static final class Builder extends DirectFieldsBeanBuilder<CalculationTasksConfig> {
