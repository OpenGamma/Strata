 ...
 */
public final class Measure<T, U extends ScenarioValuesList<T>>
    extends TypedString<Measure<T, U>> {

  private final Class<T> type;

  private final Class<U> scenarioType;
   ...
   */
  public static <T, U extends ScenarioValuesList<T>> Measure<T, U> of(
      String name,
      Class<T> singleType,
      Class<U> scenarioType) {

    return new Measure<>(name, singleType, scenarioType);
  }
   ...
   * @param scenarioType
   */
  private Measure(String name, Class<T> type, Class<U> scenarioType) {
