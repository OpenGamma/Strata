...
public final class ScenarioResults implements ImmutableBean {
   ...
   */
  public static ScenarioResults of(int rowCount, int columnCount, List<? extends Result<?>> values) {
    return new ScenarioResults(rowCount, columnCount, values);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Integer> rowCount = DirectMetaProperty.ofImmutable(
        this, "rowCount", ScenarioResults.class, Integer.TYPE);
    /**
    ...
    private final MetaProperty<Integer> columnCount = DirectMetaProperty.ofImmutable(
        this, "columnCount", ScenarioResults.class, Integer.TYPE);
    /**
    ...
    private final MetaProperty<ImmutableList<Result<?>>> items = DirectMetaProperty.ofImmutable(
        this, "items", ScenarioResults.class, (Class) ImmutableList.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 17743701:  // rowCount
          return ((ScenarioResults) bean).getRowCount();
        case -860736679:  // columnCount
          return ((ScenarioResults) bean).getColumnCount();
        case 100526016:  // items
          return ((ScenarioResults) bean).getItems();
      }
