 ...
 */
@BeanDefinition
public final class CashDepositTrade
    implements ProductTrade<CashDeposit>, ImmutableBean, Serializable {
   ...
   */
  @PropertyDefinition(validate = "notNull", overrideGet = true)
  private final CashDeposit product;
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code CashDepositTrade}.
   * @return the meta-bean, not null
   */
  public static CashDepositTrade.Meta meta() {
    return CashDepositTrade.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(CashDepositTrade.Meta.INSTANCE);
  }
   ...
   */
  public static CashDepositTrade.Builder builder() {
    return new CashDepositTrade.Builder();
  }

  private CashDepositTrade(
  ...
  @Override
  public CashDepositTrade.Meta metaBean() {
    return CashDepositTrade.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      CashDepositTrade other = (CashDepositTrade) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<StandardId> standardId = DirectMetaProperty.ofImmutable(
        this, "standardId", CashDepositTrade.class, StandardId.class);
    /**
    ...
    private final MetaProperty<TradeInfo> tradeInfo = DirectMetaProperty.ofImmutable(
        this, "tradeInfo", CashDepositTrade.class, TradeInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<CashDeposit> product = DirectMetaProperty.ofImmutable(
        this, "product", CashDepositTrade.class, CashDeposit.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public CashDepositTrade.Builder builder() {
      return new CashDepositTrade.Builder();
    }

    @Override
    public Class<? extends CashDepositTrade> beanType() {
      return CashDepositTrade.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<CashDeposit> product() {
      return product;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -1284477768:  // standardId
          return ((CashDepositTrade) bean).getStandardId();
        case 752580658:  // tradeInfo
          return ((CashDepositTrade) bean).getTradeInfo();
        case -309474065:  // product
          return ((CashDepositTrade) bean).getProduct();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code CashDepositTrade}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<CashDepositTrade> {

    private StandardId standardId;
    private TradeInfo tradeInfo;
    private CashDeposit product;
     ...
     */
    private Builder(CashDepositTrade beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case 752580658:  // tradeInfo
          ...
          break;
        case -309474065:  // product
          this.product = (CashDeposit) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
    ...
    @Override
    public CashDepositTrade build() {
      return new CashDepositTrade(
          standardId,
          tradeInfo,
          product);
    }
     ...
     * @return this, for chaining, not null
     */
    public Builder product(CashDeposit product) {
      JodaBeanUtils.notNull(product, "product");
      this.product = product;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("CashDepositTrade.Builder{");
