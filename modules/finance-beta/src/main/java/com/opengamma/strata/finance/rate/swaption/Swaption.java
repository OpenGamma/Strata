...
public class Swaption
  ...
  // TODO: cash/physical could be better
  // TODO: are expiration time/zone needed
   ...
   * The underlying swap.
   * <p>
   * At expiry, if the option is in the money, this swap will be activated.
   */
  @PropertyDefinition(validate = "notNull")
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<LocalDate> expirationDate = DirectMetaProperty.ofImmutable(
        this, "expirationDate", Swaption.class, LocalDate.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -668811523:  // expirationDate
          return ((Swaption) bean).getExpirationDate();
        case -1770633379:  // underlying
