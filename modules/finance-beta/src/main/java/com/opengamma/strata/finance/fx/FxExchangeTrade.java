 ...
 * <p>
 * An Over-The-Counter (OTC) trade in an {@link FxExchange}.
 * <p>
 ...
 * <p>
 * An FX forward and an FX spot can be represented using this trade.
 */
@BeanDefinition
public final class FxExchangeTrade
    implements ProductTrade<FxExchange>, ImmutableBean, Serializable {
  ...
  /**
   * The foreign exchange product that was agreed when the trade occurred.
   * <p>
   * The product captures the contracted financial details of the trade.
   */
  @PropertyDefinition(validate = "notNull", overrideGet = true)
  private final FxExchange product;
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code FxExchangeTrade}.
   * @return the meta-bean, not null
   */
  public static FxExchangeTrade.Meta meta() {
    return FxExchangeTrade.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(FxExchangeTrade.Meta.INSTANCE);
  }
   ...
   */
  public static FxExchangeTrade.Builder builder() {
    return new FxExchangeTrade.Builder();
  }

  private FxExchangeTrade(
  ...
  @Override
  public FxExchangeTrade.Meta metaBean() {
    return FxExchangeTrade.Meta.INSTANCE;
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the foreign exchange product that was agreed when the trade occurred.
   * <p>
   * The product captures the contracted financial details of the trade.
   * @return the value of the property, not null
   */
  @Override
  public FxExchange getProduct() {
    return product;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      FxExchangeTrade other = (FxExchangeTrade) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<StandardId> standardId = DirectMetaProperty.ofImmutable(
        this, "standardId", FxExchangeTrade.class, StandardId.class);
    /**
    ...
    private final MetaProperty<TradeInfo> tradeInfo = DirectMetaProperty.ofImmutable(
        this, "tradeInfo", FxExchangeTrade.class, TradeInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<FxExchange> product = DirectMetaProperty.ofImmutable(
        this, "product", FxExchangeTrade.class, FxExchange.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public FxExchangeTrade.Builder builder() {
      return new FxExchangeTrade.Builder();
    }

    @Override
    public Class<? extends FxExchangeTrade> beanType() {
      return FxExchangeTrade.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<FxExchange> product() {
      return product;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -1284477768:  // standardId
          return ((FxExchangeTrade) bean).getStandardId();
        case 752580658:  // tradeInfo
          return ((FxExchangeTrade) bean).getTradeInfo();
        case -309474065:  // product
          return ((FxExchangeTrade) bean).getProduct();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code FxExchangeTrade}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<FxExchangeTrade> {

    private StandardId standardId;
    private TradeInfo tradeInfo;
    private FxExchange product;
     ...
     */
    private Builder(FxExchangeTrade beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case 752580658:  // tradeInfo
          ...
          break;
        case -309474065:  // product
          this.product = (FxExchange) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
    ...
    @Override
    public FxExchangeTrade build() {
      return new FxExchangeTrade(
          standardId,
          tradeInfo,
          product);
    }
     ...
     * @return this, for chaining, not null
     */
    public Builder product(FxExchange product) {
      JodaBeanUtils.notNull(product, "product");
      this.product = product;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("FxExchangeTrade.Builder{");
