...
public class BlackFxDigitalOptionProductPricer {
   ...
   */
  // discounted Currency value of option Y
   ...
   */
  // currencyexposure of the option position Y
  ...
  //-------------------------------------------------------------------------
  // signed notional amount to computed present value and value Greeks Y
