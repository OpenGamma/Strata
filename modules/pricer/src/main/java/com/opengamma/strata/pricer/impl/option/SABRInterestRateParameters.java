...
public final class SABRInterestRateParameters
  ...
  public static SABRInterestRateParameters of(
    ...
    NodalSurface shift = ConstantNodalSurface.of("zero shift", 0d);
    return new SABRInterestRateParameters(alphaSurface, betaSurface, rhoSurface, nuSurface, sabrFunctionProvider, shift);
  }
  ...
  public double getVolatility(double expiryTime, double tenor, double strike, double forward) {
    ...
    return sabrFunctionProvider.getVolatility(option, forward, data);
  }
