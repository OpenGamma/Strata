...
public class VolatilityIborCapletFloorletPeriodPricer {
  ...
  public CurrencyAmount presentValue(
    ...
    double indexRate = ratesProvider.iborIndexRates(period.getIndex()).rate(period.getRateObservation());
  ...
  public double impliedVolatility(
    ...
    double forward = ratesProvider.iborIndexRates(period.getIndex()).rate(period.getRateObservation());
    double strike = period.getStrike();
  ...
  public PointSensitivityBuilder presentValueSensitivity(
    ...
    PointSensitivityBuilder indexRateSensiSensi =
        ratesProvider.iborIndexRates(period.getIndex()).ratePointSensitivity(period.getRateObservation());
    double volatility = volatilities.volatility(expiry, strike, indexRate);
    double df = ratesProvider.discountFactor(currency, period.getPaymentDate());
