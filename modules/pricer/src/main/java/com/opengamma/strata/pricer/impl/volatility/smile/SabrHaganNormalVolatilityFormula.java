...
public final class SabrHaganNormalVolatilityFormula
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code SabrHaganNormalVolatilityFormula}.
   */
  private static final TypedMetaBean<SabrHaganNormalVolatilityFormula> META_BEAN =
      LightMetaBean.of(SabrHaganNormalVolatilityFormula.class, MethodHandles.lookup());

  /**
   * The meta-bean for {@code SabrHaganNormalVolatilityFormula}.
   * @return the meta-bean, not null
   */
  public static TypedMetaBean<SabrHaganNormalVolatilityFormula> meta() {
    return META_BEAN;
  }
  ...
  @Override
  public TypedMetaBean<SabrHaganNormalVolatilityFormula> metaBean() {
    return META_BEAN;
  }
  ...
  public String toString() {
    ...
    buf.append("SabrHaganNormalVolatilityFormula{");
    buf.append('}');
    return buf.toString();
  }
