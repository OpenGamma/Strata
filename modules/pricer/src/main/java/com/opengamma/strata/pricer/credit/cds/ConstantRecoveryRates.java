...
public final class ConstantRecoveryRates
  ...
  public RecoveryRateSensitivity recoveryRatePointSensitivity(LocalDate date) {
    throw new UnsupportedOperationException("Unable to point sensitivity for constant recovery rates.");
  }

  @Override
  public CurrencyParameterSensitivities parameterSensitivity(RecoveryRateSensitivity pointSensitivity) {
    throw new UnsupportedOperationException("Unable to compute parameter sensitivity for constant recovery rates.");
  }
