 ...
 * Rates that are in the future are computed as a unique forward rate in the full future period.
 */
public class ForwardOvernightCompoundedAnnualRateComputationFn
  ...
  public double rate(
    ...
    ForwardOvernightCompoundedAnnualRateComputationFn.ObservationDetails details = new ForwardOvernightCompoundedAnnualRateComputationFn.ObservationDetails(computation, rates);
  ...
  private static final class ObservationDetails {
    ...
    private double calculateRate() {
      return (pastCompositionFactor() * valuationCompositionFactor() * futureCompositionFactor() - 1.0d) / accrualFactorTotal;
    }
