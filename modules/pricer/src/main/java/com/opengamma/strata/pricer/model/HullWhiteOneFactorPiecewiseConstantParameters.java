...
public final class HullWhiteOneFactorPiecewiseConstantParameters
   ...
   */
  private static final TypedMetaBean<HullWhiteOneFactorPiecewiseConstantParameters> META_BEAN =
      LightMetaBean.of(HullWhiteOneFactorPiecewiseConstantParameters.class, MethodHandles.lookup());
