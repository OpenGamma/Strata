...
public class NormalSwaptionPhysicalTradePricer {
   ...
   */
  private final NormalSwaptionPhysicalProductPricer productPricer;
  /**
   ...
   */
  public NormalSwaptionPhysicalTradePricer(
      NormalSwaptionPhysicalProductPricer productPricer,
