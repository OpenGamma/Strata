...
public final class DiscountFxIndexRates
  ...
  @Override
  public DiscountFxIndexRates withParameter(int parameterIndex, double newValue) {
    return withFxForwardRates(fxForwardRates.withParameter(parameterIndex, newValue));
  }

  @Override
  public DiscountFxIndexRates withPerturbation(ParameterPerturbation perturbation) {
   ...
   */
  public DiscountFxIndexRates withFxForwardRates(FxForwardRates fxForwardRates) {
    return new DiscountFxIndexRates(index, fxForwardRates, fixings);
  }
