...
public final class ZeroRateSensitivity
  ...
  public int compareExcludingSensitivity(CurveSensitivity other) {
    ...
    return ComparisonChain.start()
        .compare(currency.toString(), other.getCurveKey().toString())
        .result();
  }
   ...
   */
  public static ZeroRateSensitivity.Builder builder() {
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    @Override
    public ZeroRateSensitivity.Builder builder() {
      return new ZeroRateSensitivity.Builder();
    }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<ZeroRateSensitivity> {
     ...
     */
    private Builder(ZeroRateSensitivity beanToCopy) {
