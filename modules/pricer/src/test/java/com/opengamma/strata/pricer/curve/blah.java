...
import com.opengamma.strata.market.curve.node.BrlFixedOvernightSwapCurveNode;
...
import com.opengamma.strata.product.swap.BrlFixedOvernightSwapTemplate;
import com.opengamma.strata.product.swap.OvernightAccrualMethod;
import com.opengamma.strata.product.swap.ResolvedSwap;
import com.opengamma.strata.product.swap.ResolvedSwapTrade;
import com.opengamma.strata.product.swap.SwapTrade;
import com.opengamma.strata.product.swap.type.BrlFixedOvernightSwapConvention;
import com.opengamma.strata.product.swap.type.BrlFixedRateSwapLegConvention;
import com.opengamma.strata.product.swap.type.ImmutableBrlFixedOvernightSwapConvention;
...
public class CalibrationDiscountingBrlTest {
  ...
  public static final OvernightRateSwapLegConvention BRL_FLOATING_CONVENTION =
      OvernightRateSwapLegConvention.builder()
          ...
          .accrualMethod(OvernightAccrualMethod.BRL_COMPOUNDED)
          .accrualBusinessDayAdjustment(BDA_MF)
          .paymentDateOffset(DaysAdjustment.ofBusinessDays(0, BRL_CDI.getFixingCalendar()))
          .build();
  
  public static final BrlFixedRateSwapLegConvention BRL_FIXED_CONV =
      BrlFixedRateSwapLegConvention.builder()
          .currency(BRL)
          .dayCount(CURVE_DC)
          .accrualBusinessDayAdjustment(BDA_MF)
          .paymentDateOffset(DaysAdjustment.ofBusinessDays(0, BRL_CDI.getFixingCalendar()))
  ...
  public static final BrlFixedOvernightSwapConvention BRL_OIS_CONVENTION = ImmutableBrlFixedOvernightSwapConvention.of(
  ...
  static {
    for (int i = 0; i < DSC_NB_OIS_NODES; i++) {
      BrlFixedOvernightSwapTemplate template = BrlFixedOvernightSwapTemplate.of(Tenor.of(OIS_TENORS[i]), BRL_OIS_CONVENTION);
      ALL_NODES[i] = BrlFixedOvernightSwapCurveNode.of(template, QuoteId.of(StandardId.of(SCHEME, OIS_ID_VALUE[i])));
    }
  }
