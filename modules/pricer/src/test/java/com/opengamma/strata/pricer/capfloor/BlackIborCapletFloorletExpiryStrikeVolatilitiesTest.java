...
public class BlackIborCapletFloorletExpiryStrikeVolatilitiesTest {
  ...
  private static final BlackIborCapletFloorletExpiryStrikeVolatilities VOLS =
      BlackIborCapletFloorletExpiryStrikeVolatilities.of(GBP_LIBOR_3M, VAL_DATE_TIME, SURFACE);
      ...
      for (int k = 0; k < NB_TEST; k++) {
        ...
        for (int j = 0; j < nData; j++) {
          ...
          BlackIborCapletFloorletExpiryStrikeVolatilities provUp =
              BlackIborCapletFloorletExpiryStrikeVolatilities.of(GBP_LIBOR_3M, VAL_DATE_TIME, paramUp);
          BlackIborCapletFloorletExpiryStrikeVolatilities provDw =
              BlackIborCapletFloorletExpiryStrikeVolatilities.of(GBP_LIBOR_3M, VAL_DATE_TIME, paramDw);
