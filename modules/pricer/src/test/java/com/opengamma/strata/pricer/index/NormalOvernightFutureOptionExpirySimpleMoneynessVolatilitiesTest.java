...
/**
 * Tests {@link NormalOvernightFutureOptionExpirySimpleMoneynessVolatilities}
 */
public class NormalOvernightFutureOptionExpirySimpleMoneynessVolatilitiesTest {
  ...
  private static final NormalOvernightFutureOptionExpirySimpleMoneynessVolatilities VOL_SIMPLE_MONEY_PRICE =
      NormalOvernightFutureOptionExpirySimpleMoneynessVolatilities.of(EUR_ESTR, VAL_DATE_TIME, PARAMETERS_PRICE);

  private static final NormalOvernightFutureOptionExpirySimpleMoneynessVolatilities VOL_SIMPLE_MONEY_RATE =
      NormalOvernightFutureOptionExpirySimpleMoneynessVolatilities.of(EUR_ESTR, VAL_DATE_TIME, PARAMETERS_RATE);
  ...
  public void test_basics() {
    ...
    assertThat(VOL_SIMPLE_MONEY_PRICE.getIndex()).isEqualTo(EUR_ESTR);
    assertThat(VOL_SIMPLE_MONEY_PRICE.getName()).isEqualTo(OvernightFutureOptionVolatilitiesName.of("Price"));
  }
  ...
  public void test_parameterSensitivity() {
    ...
    OvernightFutureOptionSensitivity point = OvernightFutureOptionSensitivity.of(
    ...
    for (int i = 0; i < NORMAL_VOL_RATES.size(); i++) {
      ...
      InterpolatedNodalSurface param = InterpolatedNodalSurface.of(
          ...
          v,
          INTERPOLATOR_2D);
      NormalOvernightFutureOptionExpirySimpleMoneynessVolatilities vol =
          NormalOvernightFutureOptionExpirySimpleMoneynessVolatilities.of(EUR_ESTR, VAL_DATE_TIME, param);
  ...
  public void coverage() {
    NormalOvernightFutureOptionExpirySimpleMoneynessVolatilities test =
        NormalOvernightFutureOptionExpirySimpleMoneynessVolatilities.of(EUR_ESTR, VAL_DATE_TIME, PARAMETERS_RATE);
    coverImmutableBean(test);
    NormalOvernightFutureOptionExpirySimpleMoneynessVolatilities test2 =
        NormalOvernightFutureOptionExpirySimpleMoneynessVolatilities.of(
            EUR_EONIA, VAL_DATE_TIME.plusDays(1), PARAMETERS_PRICE);
