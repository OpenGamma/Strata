...
/**
 * Test for {@link NormalSabrParametersIborCapletFloorletVolatilities}.
 */
public class NormalSabrParametersIborCapletFloorletVolatilitiesTest {
  ...
  @Test
  public void test_of() {
    NormalSabrParametersIborCapletFloorletVolatilities test =
    ...
    for (int i = 0; i < nParams; ++i) {
      ...
      NormalSabrParametersIborCapletFloorletVolatilities actualWithParameter = test.withParameter(i, newValue);
      SabrParameters paramWithParameter = PARAM.withParameter(i, newValue);
      SabrParameters expectedWithParameter = SabrParameters.of(
          paramWithParameter.getAlphaCurve(),
          paramWithParameter.getBetaCurve(),
          paramWithParameter.getRhoCurve(),
          paramWithParameter.getNuCurve(),
          paramWithParameter.getSabrVolatilityFormula());

      assertThat(actualWithParameter).isEqualTo(NormalSabrParametersIborCapletFloorletVolatilities.of(
          NAME, EUR_EURIBOR_3M, DATE_TIME, expectedWithParameter));

      NormalSabrParametersIborCapletFloorletVolatilities actualPerturbed = test.withPerturbation((n, v, m) -> 2d * v + 2);
      SabrParameters paramPerturbed = PARAM.withPerturbation((n, v, m) -> 2d * v + 2);
      SabrParameters expectedPerturbed = SabrParameters.of(
          paramPerturbed.getAlphaCurve(),
          paramPerturbed.getBetaCurve(),
          paramPerturbed.getRhoCurve(),
          paramPerturbed.getNuCurve(),
          paramPerturbed.getSabrVolatilityFormula());

      assertThat(actualPerturbed).isEqualTo(NormalSabrParametersIborCapletFloorletVolatilities.of(
          NAME, EUR_EURIBOR_3M, DATE_TIME, expectedPerturbed));
    }
  }
  ...
  public void test_findData() {
    ...
    assertThat(test.findData(PARAM.getShiftCurve().getName())).isEqualTo(Optional.empty());
  ...
  public void test_relativeTime() {
    NormalSabrParametersIborCapletFloorletVolatilities prov =
        NormalSabrParametersIborCapletFloorletVolatilities.of(NAME, EUR_EURIBOR_3M, DATE_TIME, PARAM);
  ...
  public void coverage() {
    NormalSabrParametersIborCapletFloorletVolatilities test1 =
        NormalSabrParametersIborCapletFloorletVolatilities.of(NAME, EUR_EURIBOR_3M, DATE_TIME, PARAM);
