...
public class DiscountingFxSwapProductPricerTest {
  ...
  private static final LocalDate PAYMENT_DATE_NEAR = LocalDate.of(2011, 11, 21);
  private static final LocalDate PAYMENT_DATE_FAR = LocalDate.of(2011, 12, 21);
  ...
  public void test_presentValue_started() {
    FxSwap product = FxSwap.ofForwardPoints(CurrencyAmount.of(
        USD, NOMINAL_USD), KRW, FX_RATE, FX_FWD_POINTS, LocalDate.of(2011, 10, 21), PAYMENT_DATE_NEAR);
  ...
  public void test_presentValue_ended() {
    FxSwap product = FxSwap.ofForwardPoints(CurrencyAmount.of(
        USD, NOMINAL_USD), KRW, FX_RATE, FX_FWD_POINTS, LocalDate.of(2011, 9, 21), LocalDate.of(2011, 10, 21));
    MultiCurrencyAmount computed = PRICER.presentValue(product, PROVIDER);
  ...
  public void test_parSpread_beforeStart() {
    ...
    FxSwap product = FxSwap.ofForwardPoints(CurrencyAmount.of(USD, NOMINAL_USD),
        KRW, FX_RATE, FX_FWD_POINTS + parSpread, PAYMENT_DATE_NEAR, PAYMENT_DATE_FAR);
  ...
  public void test_parSpread_started() {
    ...
    FxSwap productPar = FxSwap.ofForwardPoints(CurrencyAmount.of(USD, NOMINAL_USD),
        KRW, FX_RATE, FX_FWD_POINTS + parSpread, LocalDate.of(2011, 10, 21), PAYMENT_DATE_NEAR);
