...
public class DiscountingBondFutureProductPricerTest {
  ...
  public void regression() {
    ...
    assertThat(price).isCloseTo(1.2106928633440506, offset(TOL));
    PointSensitivities point = FUTURE_PRICER.priceSensitivity(FUTURE_PRODUCT, PROVIDER);
    ...
    assertThat(actualIssuer.equalWithTolerance(expectedIssuer, TOL)).isTrue();
    ...
    assertThat(actualRepo.equalWithTolerance(expectedRepo, TOL)).isTrue();
  }
  ...
  public void regression_withZSpread_continuous() {
    ...
    assertThat(price).isCloseTo(1.1718691843665354, offset(TOL));
  ...
  public void regression_withZSpread_periodic() {
    ...
    assertThat(price).isCloseTo(1.1720190529653407, offset(TOL));
