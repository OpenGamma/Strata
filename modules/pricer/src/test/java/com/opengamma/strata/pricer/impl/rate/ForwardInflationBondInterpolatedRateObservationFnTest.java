...
/**
 * Test {@link ForwardInflationBondInterpolatedRateObservationFn}.
 */
@Test
public class ForwardInflationBondInterpolatedRateObservationFnTest {
  ...
  public void test_rate() {
    ...
    InflationBondInterpolatedRateObservation ro =
        InflationBondInterpolatedRateObservation.of(GB_RPIX, START_INDEX_VALUE, REF_END_MONTH, WEIGHT);
    ForwardInflationBondInterpolatedRateObservationFn obsFn = ForwardInflationBondInterpolatedRateObservationFn.DEFAULT;
    // rate
    double rateExpected = (WEIGHT * RATE_END + (1.0 - WEIGHT) * RATE_END_INTERP) / START_INDEX_VALUE;
