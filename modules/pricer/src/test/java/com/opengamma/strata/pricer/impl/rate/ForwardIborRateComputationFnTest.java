...
public class ForwardIborRateComputationFnTest {
  ...
  public void test_rate() {
    ...
    assertEquals(built.get(ExplainKey.OBSERVATIONS).get().get(0).get(ExplainKey.FORWARD_RATE_START_DATE), Optional.of(FORWARD_START_DATE));
    assertEquals(built.get(ExplainKey.OBSERVATIONS).get().get(0).get(ExplainKey.FORWARD_RATE_END_DATE), Optional.of(FORWARD_END_DATE));
