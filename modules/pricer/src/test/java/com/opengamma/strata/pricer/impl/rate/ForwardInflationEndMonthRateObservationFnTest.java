...
/**
 * Test {@link ForwardInflationEndMonthRateObservationFn}.
 */
@Test
public class ForwardInflationEndMonthRateObservationFnTest {
  ...
  public void test_rate() {
    ...
    InflationEndMonthRateObservation ro =
        InflationEndMonthRateObservation.of(GB_RPIX, START_INDEX_VALUE, REFERENCE_END_MONTH);
