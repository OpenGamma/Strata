...
public class CapitalIndexedBondCurveDataSet {
  ...
  /**
<<<<<<< HEAD:modules/pricer/src/main/java/com/opengamma/strata/pricer/bond/CapitalIndexedBondCurveDataSet.java
<<<<<<< HEAD
=======
>>>>>>> topic/inflation-bonds-jpy:modules/pricer/src/test/java/com/opengamma/strata/pricer/bond/CapitalIndexedBondCurveDataSet.java
   * Obtains an immutable rates providers with valuation date and time series. 
   * <p>
   * The time series must contain historical data for the price index. 
   * 
