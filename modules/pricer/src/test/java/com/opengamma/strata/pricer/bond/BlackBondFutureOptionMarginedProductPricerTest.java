...
public class BlackBondFutureOptionMarginedProductPricerTest {
  ...
  public void test_getFuturePricer() {
    assertThat(OPTION_PRICER.getFuturePricer()).isSameAs(FUTURE_PRICER);
  }
  ...
  public void test_priceSensitivity() {
    ...
    assertThat(computed.equalWithTolerance(expected, 30d * EPS)).isTrue();
  }
  ...
  private void testPriceSensitivityBlackVolatility(
    ...
    for (int i = 0; i < nVol; ++i) {
      ...
      assertThat(computed.getSensitivities().get(0).getSensitivity().get(index)).isCloseTo(expected, offset(EPS));
    }
  }
  ...
  public void test_marginIndex() {
    ...
    assertThat(computed).isEqualTo(price * FUTURE_OPTION_PRODUCT.getUnderlyingFuture().getNotional());
  }
  ...
  public void test_marginIndexSensitivity() {
    ...
    assertThat(computed).isEqualTo(point.multipliedBy(FUTURE_OPTION_PRODUCT.getUnderlyingFuture().getNotional()));
  }
  ...
  public void regression_price() {
    ...
    assertThat(price).isCloseTo(0.08916005173932573, offset(TOL)); // 2.x
  }
}
