 ...
 * <p>
 * This can be used with {@link Pair} to create an object that handles partial success/failure,
 ...
 * The pair would contain both the successful rows and failures for each failed row.
 */
...
public final class FailureItems
   ...
   */
  private static final class Builder extends DirectFieldsBeanBuilder<FailureItems> {
