...
/**
 * A link where the link target is directly embedded inside.
 * <p>
 * This type of link is especially useful for avoiding dependencies on other parts of the system.
 * For example, a {@link LinkResolver} might need to be backed by a database, but when using
 * a resolved link, no database is needed.
 * One use case is for testing, but there are many others.
 * <p>
 * It is intended that applications refer to the {@link Link} interface and
 * not to this implementation, see {@link Link#resolved(IdentifiableBean)}.
 *
...
public final class ResolvedLink<T extends IdentifiableBean>
  ...
  //-------------------------------------------------------------------------
  /**
   * Resolves the link, returning the embedded object.
   * <p>
   * The resolver is not used by this link implementation.
   *
