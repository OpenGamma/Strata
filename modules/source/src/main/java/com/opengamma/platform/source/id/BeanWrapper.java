...
public final class BeanWrapper implements ImmutableBean, Serializable {
   ...
   */
  @PropertyDefinition(validate = "notNull")
  private final ImmutableSet<StandardId> additionalIdentifier;
  ...
  private BeanWrapper(
      ...
      Set<StandardId> additionalIdentifier) {
    JodaBeanUtils.notNull(bean, "bean");
    JodaBeanUtils.notNull(additionalIdentifier, "additionalIdentifier");
    this.bean = bean;
    this.additionalIdentifier = ImmutableSet.copyOf(additionalIdentifier);
  }
   ...
   * @return the value of the property, not null
   */
  public ImmutableSet<StandardId> getAdditionalIdentifier() {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(getBean(), other.getBean()) &&
          JodaBeanUtils.equal(getAdditionalIdentifier(), other.getAdditionalIdentifier());
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(getAdditionalIdentifier());
    return hash;
  }
  ...
  public String toString() {
    ...
    buf.append("additionalIdentifier").append('=').append(JodaBeanUtils.toString(getAdditionalIdentifier()));
    buf.append('}');
    return buf.toString();
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    /**
     * The meta-property for the {@code additionalIdentifier} property.
     */
    @SuppressWarnings({"unchecked", "rawtypes" })
    private final MetaProperty<ImmutableSet<StandardId>> additionalIdentifier = DirectMetaProperty.ofImmutable(
        this, "additionalIdentifier", BeanWrapper.class, (Class) ImmutableSet.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case 1195162672:  // additionalIdentifier
          return ((BeanWrapper) bean).getAdditionalIdentifier();
      }
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<BeanWrapper> {
    ...
    private Builder(BeanWrapper beanToCopy) {
      ...
      this.additionalIdentifier = new HashSet<StandardId>(beanToCopy.getAdditionalIdentifier());
    }
    ...
    /**
     * Sets the {@code additionalIdentifier} property in the builder.
    ...
    public String toString() {
      ...
      buf.append("additionalIdentifier").append('=').append(JodaBeanUtils.toString(additionalIdentifier));
      buf.append('}');
      return buf.toString();
    }
