...
public class LogNaturalCubicMonotonicityPreserving implements
	...
	public PP_t assembler(double[] x, double[] y) {
		com.opengamma.analytics.math.interpolation.MonotonicityPreservingCubicSplineInterpolator impl = new com.opengamma.analytics.math.interpolation.MonotonicityPreservingCubicSplineInterpolator(
